...
#ifndef __INCLUDE_ESI_RISC_INTERNAL_H__
#define __INCLUDE_ESI_RISC_INTERNAL_H__
...
{
    if (EE_esi_risc_are_IRQs_enabled(f))
...
#ifdef __MULTI__
extern EE_UREG EE_esi_std_active_tos;
#define EE_hal_active_tos EE_std_active_tos
#endif
...
#endif /* __INCLUDE_ESI_RISC_INTERNAL_H__ */
