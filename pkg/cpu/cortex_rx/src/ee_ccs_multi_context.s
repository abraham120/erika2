...
;	Implementation of EE_cortex_rx_change_context as described in
...
;*******************************************************************************
	...
	.global	EE_cortex_rx_change_context	; void EE_cortex_rx_change_context(EE_TID tid);
...
;*******************************************************************************
	...
	.global	EE_cortex_rx_active_tos
	.global	EE_cortex_rx_system_tos
...
EE_cortex_rx_active_tos_addr	.word	EE_cortex_rx_active_tos
EE_cortex_rx_system_tos_addr	.word	EE_cortex_rx_system_tos

;
;Pseudo code for EE_cortex_rx_change_context():
;     begin:
...
EE_cortex_rx_change_context:
	...
	;* if is_not_the_current_stack(tos_index) { 
	;*
	LDR	R2, EE_cortex_rx_active_tos_addr	;R2 = & EE_cortex_rx_active_tos;
	LDR	R3, [R2]		; R3 = EE_cortex_rx_active_tos;
	CMP	R1, R3
	...
	; switch_stacks(tos_index);
	LDR	R4, EE_cortex_rx_system_tos_addr	; R4 = & cortex_rx_system_tos[0];
	...
	; EE_cortex_rx_system_tos[R3] = MSP;
	LSLS	R3, R3, #2
	ADD	R3, R4, R3
	;CK
	MRS	R5, MSP
	...
	; EE_cortex_rx_active_tos = tos_index;
	STR	R1, [R2]
	; MSP= EE_cortex_rx_system_tos[R1];
	LSLS	R1, R1, #2
	ADD	R1, R4, R1
	LDR	R1, [R1]
	;CK
