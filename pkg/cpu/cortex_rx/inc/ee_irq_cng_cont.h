...
#ifndef __INCLUDE_CORTEX_RX_IRQ_CNG_CONTEXT_H__
#define __INCLUDE_CORTEX_RX_IRQ_CNG_CONTEXT_H__
...
__INLINE__ void EE_cortex_rx_IRQ_active_change_context(void)
{
	EE_switch_context();
}

#endif /* __INCLUDE_CORTEX_RX_IRQ_CNG_CONTEXT_H__ */
