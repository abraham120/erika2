...
EE_SRCS += pkg/cpu/x86/src/ee_startup.c
EE_SRCS += pkg/cpu/x86/src/ee_irqstub.c
EE_SRCS += pkg/cpu/x86/src/startup.S
EE_SRCS += pkg/cpu/x86/src/ee_idt_handlers.S
...
ifeq ($(CPU_OO), YES)
EE_SRCS += pkg/cpu/x86/src/ee_oo.c
endif

ifeq ($(call iseeopt, __MULTI__), yes)
EE_SRCS += pkg/cpu/x86/src/ee_context_x86.S
endif # multi
