...
#define WATCHDOG0_LOAD_R        EE_HWREG(0x40000000)
#define WATCHDOG0_VALUE_R       EE_HWREG(0x40000004)
#define WATCHDOG0_CTL_R         EE_HWREG(0x40000008)
#define WATCHDOG0_ICR_R         EE_HWREG(0x4000000C)
#define WATCHDOG0_RIS_R         EE_HWREG(0x40000010)
#define WATCHDOG0_MIS_R         EE_HWREG(0x40000014)
#define WATCHDOG0_TEST_R        EE_HWREG(0x40000418)
#define WATCHDOG0_LOCK_R        EE_HWREG(0x40000C00)

/* Watchdog Timer registers (WATCHDOG1) */
#define WATCHDOG1_LOAD_R        EE_HWREG(0x40001000)
#define WATCHDOG1_VALUE_R       EE_HWREG(0x40001004)
#define WATCHDOG1_CTL_R         EE_HWREG(0x40001008)
#define WATCHDOG1_ICR_R         EE_HWREG(0x4000100C)
#define WATCHDOG1_RIS_R         EE_HWREG(0x40001010)
#define WATCHDOG1_MIS_R         EE_HWREG(0x40001014)
#define WATCHDOG1_TEST_R        EE_HWREG(0x40001418)
#define WATCHDOG1_LOCK_R        EE_HWREG(0x40001C00)

/* GPIO registers (PORTA) */
#define GPIO_PORTA_DATA_BITS_R  EE_HWREG_ADDR(0x40004000)
#define GPIO_PORTA_DATA_R       EE_HWREG(0x400043FC)
#define GPIO_PORTA_DIR_R        EE_HWREG(0x40004400)
#define GPIO_PORTA_IS_R         EE_HWREG(0x40004404)
#define GPIO_PORTA_IBE_R        EE_HWREG(0x40004408)
#define GPIO_PORTA_IEV_R        EE_HWREG(0x4000440C)
#define GPIO_PORTA_IM_R         EE_HWREG(0x40004410)
#define GPIO_PORTA_RIS_R        EE_HWREG(0x40004414)
#define GPIO_PORTA_MIS_R        EE_HWREG(0x40004418)
#define GPIO_PORTA_ICR_R        EE_HWREG(0x4000441C)
#define GPIO_PORTA_AFSEL_R      EE_HWREG(0x40004420)
#define GPIO_PORTA_DR2R_R       EE_HWREG(0x40004500)
#define GPIO_PORTA_DR4R_R       EE_HWREG(0x40004504)
#define GPIO_PORTA_DR8R_R       EE_HWREG(0x40004508)
#define GPIO_PORTA_ODR_R        EE_HWREG(0x4000450C)
#define GPIO_PORTA_PUR_R        EE_HWREG(0x40004510)
#define GPIO_PORTA_PDR_R        EE_HWREG(0x40004514)
#define GPIO_PORTA_SLR_R        EE_HWREG(0x40004518)
#define GPIO_PORTA_DEN_R        EE_HWREG(0x4000451C)
#define GPIO_PORTA_LOCK_R       EE_HWREG(0x40004520)
#define GPIO_PORTA_CR_R         EE_HWREG(0x40004524)
#define GPIO_PORTA_AMSEL_R      EE_HWREG(0x40004528)
#define GPIO_PORTA_PCTL_R       EE_HWREG(0x4000452C)
#define GPIO_PORTA_ADCCTL_R     EE_HWREG(0x40004530)
#define GPIO_PORTA_DMACTL_R     EE_HWREG(0x40004534)
#define GPIO_PORTA_SI_R         EE_HWREG(0x40004538)

/* GPIO registers (PORTB) */
#define GPIO_PORTB_DATA_BITS_R  EE_HWREG_ADDR(0x40005000)
#define GPIO_PORTB_DATA_R       EE_HWREG(0x400053FC)
#define GPIO_PORTB_DIR_R        EE_HWREG(0x40005400)
#define GPIO_PORTB_IS_R         EE_HWREG(0x40005404)
#define GPIO_PORTB_IBE_R        EE_HWREG(0x40005408)
#define GPIO_PORTB_IEV_R        EE_HWREG(0x4000540C)
#define GPIO_PORTB_IM_R         EE_HWREG(0x40005410)
#define GPIO_PORTB_RIS_R        EE_HWREG(0x40005414)
#define GPIO_PORTB_MIS_R        EE_HWREG(0x40005418)
#define GPIO_PORTB_ICR_R        EE_HWREG(0x4000541C)
#define GPIO_PORTB_AFSEL_R      EE_HWREG(0x40005420)
#define GPIO_PORTB_DR2R_R       EE_HWREG(0x40005500)
#define GPIO_PORTB_DR4R_R       EE_HWREG(0x40005504)
#define GPIO_PORTB_DR8R_R       EE_HWREG(0x40005508)
#define GPIO_PORTB_ODR_R        EE_HWREG(0x4000550C)
#define GPIO_PORTB_PUR_R        EE_HWREG(0x40005510)
#define GPIO_PORTB_PDR_R        EE_HWREG(0x40005514)
#define GPIO_PORTB_SLR_R        EE_HWREG(0x40005518)
#define GPIO_PORTB_DEN_R        EE_HWREG(0x4000551C)
#define GPIO_PORTB_LOCK_R       EE_HWREG(0x40005520)
#define GPIO_PORTB_CR_R         EE_HWREG(0x40005524)
#define GPIO_PORTB_AMSEL_R      EE_HWREG(0x40005528)
#define GPIO_PORTB_PCTL_R       EE_HWREG(0x4000552C)
#define GPIO_PORTB_ADCCTL_R     EE_HWREG(0x40005530)
#define GPIO_PORTB_DMACTL_R     EE_HWREG(0x40005534)
#define GPIO_PORTB_SI_R         EE_HWREG(0x40005538)

/* GPIO registers (PORTC) */
#define GPIO_PORTC_DATA_BITS_R  EE_HWREG_ADDR(0x40006000)
#define GPIO_PORTC_DATA_R       EE_HWREG(0x400063FC)
#define GPIO_PORTC_DIR_R        EE_HWREG(0x40006400)
#define GPIO_PORTC_IS_R         EE_HWREG(0x40006404)
#define GPIO_PORTC_IBE_R        EE_HWREG(0x40006408)
#define GPIO_PORTC_IEV_R        EE_HWREG(0x4000640C)
#define GPIO_PORTC_IM_R         EE_HWREG(0x40006410)
#define GPIO_PORTC_RIS_R        EE_HWREG(0x40006414)
#define GPIO_PORTC_MIS_R        EE_HWREG(0x40006418)
#define GPIO_PORTC_ICR_R        EE_HWREG(0x4000641C)
#define GPIO_PORTC_AFSEL_R      EE_HWREG(0x40006420)
#define GPIO_PORTC_DR2R_R       EE_HWREG(0x40006500)
#define GPIO_PORTC_DR4R_R       EE_HWREG(0x40006504)
#define GPIO_PORTC_DR8R_R       EE_HWREG(0x40006508)
#define GPIO_PORTC_ODR_R        EE_HWREG(0x4000650C)
#define GPIO_PORTC_PUR_R        EE_HWREG(0x40006510)
#define GPIO_PORTC_PDR_R        EE_HWREG(0x40006514)
#define GPIO_PORTC_SLR_R        EE_HWREG(0x40006518)
#define GPIO_PORTC_DEN_R        EE_HWREG(0x4000651C)
#define GPIO_PORTC_LOCK_R       EE_HWREG(0x40006520)
#define GPIO_PORTC_CR_R         EE_HWREG(0x40006524)
#define GPIO_PORTC_AMSEL_R      EE_HWREG(0x40006528)
#define GPIO_PORTC_PCTL_R       EE_HWREG(0x4000652C)
#define GPIO_PORTC_ADCCTL_R     EE_HWREG(0x40006530)
#define GPIO_PORTC_DMACTL_R     EE_HWREG(0x40006534)
#define GPIO_PORTC_SI_R         EE_HWREG(0x40006538)

/* GPIO registers (PORTD) */
#define GPIO_PORTD_DATA_BITS_R  EE_HWREG_ADDR(0x40007000)
#define GPIO_PORTD_DATA_R       EE_HWREG(0x400073FC)
#define GPIO_PORTD_DIR_R        EE_HWREG(0x40007400)
#define GPIO_PORTD_IS_R         EE_HWREG(0x40007404)
#define GPIO_PORTD_IBE_R        EE_HWREG(0x40007408)
#define GPIO_PORTD_IEV_R        EE_HWREG(0x4000740C)
#define GPIO_PORTD_IM_R         EE_HWREG(0x40007410)
#define GPIO_PORTD_RIS_R        EE_HWREG(0x40007414)
#define GPIO_PORTD_MIS_R        EE_HWREG(0x40007418)
#define GPIO_PORTD_ICR_R        EE_HWREG(0x4000741C)
#define GPIO_PORTD_AFSEL_R      EE_HWREG(0x40007420)
#define GPIO_PORTD_DR2R_R       EE_HWREG(0x40007500)
#define GPIO_PORTD_DR4R_R       EE_HWREG(0x40007504)
#define GPIO_PORTD_DR8R_R       EE_HWREG(0x40007508)
#define GPIO_PORTD_ODR_R        EE_HWREG(0x4000750C)
#define GPIO_PORTD_PUR_R        EE_HWREG(0x40007510)
#define GPIO_PORTD_PDR_R        EE_HWREG(0x40007514)
#define GPIO_PORTD_SLR_R        EE_HWREG(0x40007518)
#define GPIO_PORTD_DEN_R        EE_HWREG(0x4000751C)
#define GPIO_PORTD_LOCK_R       EE_HWREG(0x40007520)
#define GPIO_PORTD_CR_R         EE_HWREG(0x40007524)
#define GPIO_PORTD_AMSEL_R      EE_HWREG(0x40007528)
#define GPIO_PORTD_PCTL_R       EE_HWREG(0x4000752C)
#define GPIO_PORTD_ADCCTL_R     EE_HWREG(0x40007530)
#define GPIO_PORTD_DMACTL_R     EE_HWREG(0x40007534)
#define GPIO_PORTD_SI_R         EE_HWREG(0x40007538)

/* SSI registers (SSI0) */
#define SSI0_CR0_R              EE_HWREG(0x40008000)
#define SSI0_CR1_R              EE_HWREG(0x40008004)
#define SSI0_DR_R               EE_HWREG(0x40008008)
#define SSI0_SR_R               EE_HWREG(0x4000800C)
#define SSI0_CPSR_R             EE_HWREG(0x40008010)
#define SSI0_IM_R               EE_HWREG(0x40008014)
#define SSI0_RIS_R              EE_HWREG(0x40008018)
#define SSI0_MIS_R              EE_HWREG(0x4000801C)
#define SSI0_ICR_R              EE_HWREG(0x40008020)
#define SSI0_DMACTL_R           EE_HWREG(0x40008024)
#define SSI0_CC_R               EE_HWREG(0x40008FC8)

/* SSI registers (SSI1) */
#define SSI1_CR0_R              EE_HWREG(0x40009000)
#define SSI1_CR1_R              EE_HWREG(0x40009004)
#define SSI1_DR_R               EE_HWREG(0x40009008)
#define SSI1_SR_R               EE_HWREG(0x4000900C)
#define SSI1_CPSR_R             EE_HWREG(0x40009010)
#define SSI1_IM_R               EE_HWREG(0x40009014)
#define SSI1_RIS_R              EE_HWREG(0x40009018)
#define SSI1_MIS_R              EE_HWREG(0x4000901C)
#define SSI1_ICR_R              EE_HWREG(0x40009020)
#define SSI1_DMACTL_R           EE_HWREG(0x40009024)
#define SSI1_CC_R               EE_HWREG(0x40009FC8)

/* SSI registers (SSI2) */
#define SSI2_CR0_R              EE_HWREG(0x4000A000)
#define SSI2_CR1_R              EE_HWREG(0x4000A004)
#define SSI2_DR_R               EE_HWREG(0x4000A008)
#define SSI2_SR_R               EE_HWREG(0x4000A00C)
#define SSI2_CPSR_R             EE_HWREG(0x4000A010)
#define SSI2_IM_R               EE_HWREG(0x4000A014)
#define SSI2_RIS_R              EE_HWREG(0x4000A018)
#define SSI2_MIS_R              EE_HWREG(0x4000A01C)
#define SSI2_ICR_R              EE_HWREG(0x4000A020)
#define SSI2_DMACTL_R           EE_HWREG(0x4000A024)
#define SSI2_CC_R               EE_HWREG(0x4000AFC8)

/* SSI registers (SSI3) */
#define SSI3_CR0_R              EE_HWREG(0x4000B000)
#define SSI3_CR1_R              EE_HWREG(0x4000B004)
#define SSI3_DR_R               EE_HWREG(0x4000B008)
#define SSI3_SR_R               EE_HWREG(0x4000B00C)
#define SSI3_CPSR_R             EE_HWREG(0x4000B010)
#define SSI3_IM_R               EE_HWREG(0x4000B014)
#define SSI3_RIS_R              EE_HWREG(0x4000B018)
#define SSI3_MIS_R              EE_HWREG(0x4000B01C)
#define SSI3_ICR_R              EE_HWREG(0x4000B020)
#define SSI3_DMACTL_R           EE_HWREG(0x4000B024)
#define SSI3_CC_R               EE_HWREG(0x4000BFC8)

/* UART registers (UART0) */
#define UART0_DR_R              EE_HWREG(0x4000C000)
#define UART0_RSR_R             EE_HWREG(0x4000C004)
#define UART0_ECR_R             EE_HWREG(0x4000C004)
#define UART0_FR_R              EE_HWREG(0x4000C018)
#define UART0_ILPR_R            EE_HWREG(0x4000C020)
#define UART0_IBRD_R            EE_HWREG(0x4000C024)
#define UART0_FBRD_R            EE_HWREG(0x4000C028)
#define UART0_LCRH_R            EE_HWREG(0x4000C02C)
#define UART0_CTL_R             EE_HWREG(0x4000C030)
#define UART0_IFLS_R            EE_HWREG(0x4000C034)
#define UART0_IM_R              EE_HWREG(0x4000C038)
#define UART0_RIS_R             EE_HWREG(0x4000C03C)
#define UART0_MIS_R             EE_HWREG(0x4000C040)
#define UART0_ICR_R             EE_HWREG(0x4000C044)
#define UART0_DMACTL_R          EE_HWREG(0x4000C048)
#define UART0_LCTL_R            EE_HWREG(0x4000C090)
#define UART0_LSS_R             EE_HWREG(0x4000C094)
#define UART0_LTIM_R            EE_HWREG(0x4000C098)
#define UART0_9BITADDR_R        EE_HWREG(0x4000C0A4)
#define UART0_9BITAMASK_R       EE_HWREG(0x4000C0A8)
#define UART0_PP_R              EE_HWREG(0x4000CFC0)
#define UART0_CC_R              EE_HWREG(0x4000CFC8)

/* UART registers (UART1) */
#define UART1_DR_R              EE_HWREG(0x4000D000)
#define UART1_RSR_R             EE_HWREG(0x4000D004)
#define UART1_ECR_R             EE_HWREG(0x4000D004)
#define UART1_FR_R              EE_HWREG(0x4000D018)
#define UART1_ILPR_R            EE_HWREG(0x4000D020)
#define UART1_IBRD_R            EE_HWREG(0x4000D024)
#define UART1_FBRD_R            EE_HWREG(0x4000D028)
#define UART1_LCRH_R            EE_HWREG(0x4000D02C)
#define UART1_CTL_R             EE_HWREG(0x4000D030)
#define UART1_IFLS_R            EE_HWREG(0x4000D034)
#define UART1_IM_R              EE_HWREG(0x4000D038)
#define UART1_RIS_R             EE_HWREG(0x4000D03C)
#define UART1_MIS_R             EE_HWREG(0x4000D040)
#define UART1_ICR_R             EE_HWREG(0x4000D044)
#define UART1_DMACTL_R          EE_HWREG(0x4000D048)
#define UART1_LCTL_R            EE_HWREG(0x4000D090)
#define UART1_LSS_R             EE_HWREG(0x4000D094)
#define UART1_LTIM_R            EE_HWREG(0x4000D098)
#define UART1_9BITADDR_R        EE_HWREG(0x4000D0A4)
#define UART1_9BITAMASK_R       EE_HWREG(0x4000D0A8)
#define UART1_PP_R              EE_HWREG(0x4000DFC0)
#define UART1_CC_R              EE_HWREG(0x4000DFC8)

/* UART registers (UART2) */
#define UART2_DR_R              EE_HWREG(0x4000E000)
#define UART2_RSR_R             EE_HWREG(0x4000E004)
#define UART2_ECR_R             EE_HWREG(0x4000E004)
#define UART2_FR_R              EE_HWREG(0x4000E018)
#define UART2_ILPR_R            EE_HWREG(0x4000E020)
#define UART2_IBRD_R            EE_HWREG(0x4000E024)
#define UART2_FBRD_R            EE_HWREG(0x4000E028)
#define UART2_LCRH_R            EE_HWREG(0x4000E02C)
#define UART2_CTL_R             EE_HWREG(0x4000E030)
#define UART2_IFLS_R            EE_HWREG(0x4000E034)
#define UART2_IM_R              EE_HWREG(0x4000E038)
#define UART2_RIS_R             EE_HWREG(0x4000E03C)
#define UART2_MIS_R             EE_HWREG(0x4000E040)
#define UART2_ICR_R             EE_HWREG(0x4000E044)
#define UART2_DMACTL_R          EE_HWREG(0x4000E048)
#define UART2_LCTL_R            EE_HWREG(0x4000E090)
#define UART2_LSS_R             EE_HWREG(0x4000E094)
#define UART2_LTIM_R            EE_HWREG(0x4000E098)
#define UART2_9BITADDR_R        EE_HWREG(0x4000E0A4)
#define UART2_9BITAMASK_R       EE_HWREG(0x4000E0A8)
#define UART2_PP_R              EE_HWREG(0x4000EFC0)
#define UART2_CC_R              EE_HWREG(0x4000EFC8)

/* UART registers (UART3) */
#define UART3_DR_R              EE_HWREG(0x4000F000)
#define UART3_RSR_R             EE_HWREG(0x4000F004)
#define UART3_ECR_R             EE_HWREG(0x4000F004)
#define UART3_FR_R              EE_HWREG(0x4000F018)
#define UART3_ILPR_R            EE_HWREG(0x4000F020)
#define UART3_IBRD_R            EE_HWREG(0x4000F024)
#define UART3_FBRD_R            EE_HWREG(0x4000F028)
#define UART3_LCRH_R            EE_HWREG(0x4000F02C)
#define UART3_CTL_R             EE_HWREG(0x4000F030)
#define UART3_IFLS_R            EE_HWREG(0x4000F034)
#define UART3_IM_R              EE_HWREG(0x4000F038)
#define UART3_RIS_R             EE_HWREG(0x4000F03C)
#define UART3_MIS_R             EE_HWREG(0x4000F040)
#define UART3_ICR_R             EE_HWREG(0x4000F044)
#define UART3_DMACTL_R          EE_HWREG(0x4000F048)
#define UART3_LCTL_R            EE_HWREG(0x4000F090)
#define UART3_LSS_R             EE_HWREG(0x4000F094)
#define UART3_LTIM_R            EE_HWREG(0x4000F098)
#define UART3_9BITADDR_R        EE_HWREG(0x4000F0A4)
#define UART3_9BITAMASK_R       EE_HWREG(0x4000F0A8)
#define UART3_PP_R              EE_HWREG(0x4000FFC0)
#define UART3_CC_R              EE_HWREG(0x4000FFC8)

/* UART registers (UART4) */
#define UART4_DR_R              EE_HWREG(0x40010000)
#define UART4_RSR_R             EE_HWREG(0x40010004)
#define UART4_ECR_R             EE_HWREG(0x40010004)
#define UART4_FR_R              EE_HWREG(0x40010018)
#define UART4_ILPR_R            EE_HWREG(0x40010020)
#define UART4_IBRD_R            EE_HWREG(0x40010024)
#define UART4_FBRD_R            EE_HWREG(0x40010028)
#define UART4_LCRH_R            EE_HWREG(0x4001002C)
#define UART4_CTL_R             EE_HWREG(0x40010030)
#define UART4_IFLS_R            EE_HWREG(0x40010034)
#define UART4_IM_R              EE_HWREG(0x40010038)
#define UART4_RIS_R             EE_HWREG(0x4001003C)
#define UART4_MIS_R             EE_HWREG(0x40010040)
#define UART4_ICR_R             EE_HWREG(0x40010044)
#define UART4_DMACTL_R          EE_HWREG(0x40010048)
#define UART4_LCTL_R            EE_HWREG(0x40010090)
#define UART4_LSS_R             EE_HWREG(0x40010094)
#define UART4_LTIM_R            EE_HWREG(0x40010098)
#define UART4_9BITADDR_R        EE_HWREG(0x400100A4)
#define UART4_9BITAMASK_R       EE_HWREG(0x400100A8)
#define UART4_PP_R              EE_HWREG(0x40010FC0)
#define UART4_CC_R              EE_HWREG(0x40010FC8)

/* UART registers (UART5) */
#define UART5_DR_R              EE_HWREG(0x40011000)
#define UART5_RSR_R             EE_HWREG(0x40011004)
#define UART5_ECR_R             EE_HWREG(0x40011004)
#define UART5_FR_R              EE_HWREG(0x40011018)
#define UART5_ILPR_R            EE_HWREG(0x40011020)
#define UART5_IBRD_R            EE_HWREG(0x40011024)
#define UART5_FBRD_R            EE_HWREG(0x40011028)
#define UART5_LCRH_R            EE_HWREG(0x4001102C)
#define UART5_CTL_R             EE_HWREG(0x40011030)
#define UART5_IFLS_R            EE_HWREG(0x40011034)
#define UART5_IM_R              EE_HWREG(0x40011038)
#define UART5_RIS_R             EE_HWREG(0x4001103C)
#define UART5_MIS_R             EE_HWREG(0x40011040)
#define UART5_ICR_R             EE_HWREG(0x40011044)
#define UART5_DMACTL_R          EE_HWREG(0x40011048)
#define UART5_LCTL_R            EE_HWREG(0x40011090)
#define UART5_LSS_R             EE_HWREG(0x40011094)
#define UART5_LTIM_R            EE_HWREG(0x40011098)
#define UART5_9BITADDR_R        EE_HWREG(0x400110A4)
#define UART5_9BITAMASK_R       EE_HWREG(0x400110A8)
#define UART5_PP_R              EE_HWREG(0x40011FC0)
#define UART5_CC_R              EE_HWREG(0x40011FC8)

/* UART registers (UART6) */
#define UART6_DR_R              EE_HWREG(0x40012000)
#define UART6_RSR_R             EE_HWREG(0x40012004)
#define UART6_ECR_R             EE_HWREG(0x40012004)
#define UART6_FR_R              EE_HWREG(0x40012018)
#define UART6_ILPR_R            EE_HWREG(0x40012020)
#define UART6_IBRD_R            EE_HWREG(0x40012024)
#define UART6_FBRD_R            EE_HWREG(0x40012028)
#define UART6_LCRH_R            EE_HWREG(0x4001202C)
#define UART6_CTL_R             EE_HWREG(0x40012030)
#define UART6_IFLS_R            EE_HWREG(0x40012034)
#define UART6_IM_R              EE_HWREG(0x40012038)
#define UART6_RIS_R             EE_HWREG(0x4001203C)
#define UART6_MIS_R             EE_HWREG(0x40012040)
#define UART6_ICR_R             EE_HWREG(0x40012044)
#define UART6_DMACTL_R          EE_HWREG(0x40012048)
#define UART6_LCTL_R            EE_HWREG(0x40012090)
#define UART6_LSS_R             EE_HWREG(0x40012094)
#define UART6_LTIM_R            EE_HWREG(0x40012098)
#define UART6_9BITADDR_R        EE_HWREG(0x400120A4)
#define UART6_9BITAMASK_R       EE_HWREG(0x400120A8)
#define UART6_PP_R              EE_HWREG(0x40012FC0)
#define UART6_CC_R              EE_HWREG(0x40012FC8)

/* UART registers (UART7) */
#define UART7_DR_R              EE_HWREG(0x40013000)
#define UART7_RSR_R             EE_HWREG(0x40013004)
#define UART7_ECR_R             EE_HWREG(0x40013004)
#define UART7_FR_R              EE_HWREG(0x40013018)
#define UART7_ILPR_R            EE_HWREG(0x40013020)
#define UART7_IBRD_R            EE_HWREG(0x40013024)
#define UART7_FBRD_R            EE_HWREG(0x40013028)
#define UART7_LCRH_R            EE_HWREG(0x4001302C)
#define UART7_CTL_R             EE_HWREG(0x40013030)
#define UART7_IFLS_R            EE_HWREG(0x40013034)
#define UART7_IM_R              EE_HWREG(0x40013038)
#define UART7_RIS_R             EE_HWREG(0x4001303C)
#define UART7_MIS_R             EE_HWREG(0x40013040)
#define UART7_ICR_R             EE_HWREG(0x40013044)
#define UART7_DMACTL_R          EE_HWREG(0x40013048)
#define UART7_LCTL_R            EE_HWREG(0x40013090)
#define UART7_LSS_R             EE_HWREG(0x40013094)
#define UART7_LTIM_R            EE_HWREG(0x40013098)
#define UART7_9BITADDR_R        EE_HWREG(0x400130A4)
#define UART7_9BITAMASK_R       EE_HWREG(0x400130A8)
#define UART7_PP_R              EE_HWREG(0x40013FC0)
#define UART7_CC_R              EE_HWREG(0x40013FC8)

/* I2C registers (I2C0 MASTER) */
#define I2C0_MASTER_MSA_R       EE_HWREG(0x40020000)
#define I2C0_MASTER_MCS_R       EE_HWREG(0x40020004)
#define I2C0_MASTER_MDR_R       EE_HWREG(0x40020008)
#define I2C0_MASTER_MTPR_R      EE_HWREG(0x4002000C)
#define I2C0_MASTER_MIMR_R      EE_HWREG(0x40020010)
#define I2C0_MASTER_MRIS_R      EE_HWREG(0x40020014)
#define I2C0_MASTER_MMIS_R      EE_HWREG(0x40020018)
#define I2C0_MASTER_MICR_R      EE_HWREG(0x4002001C)
#define I2C0_MASTER_MCR_R       EE_HWREG(0x40020020)
#define I2C0_MASTER_MCLKOCNT_R  EE_HWREG(0x40020024)
#define I2C0_MASTER_MBMON_R     EE_HWREG(0x4002002C)

/* I2C registers (I2C0 SLAVE) */
#define I2C0_SLAVE_SOAR_R       EE_HWREG(0x40020800)
#define I2C0_SLAVE_SCSR_R       EE_HWREG(0x40020804)
#define I2C0_SLAVE_SDR_R        EE_HWREG(0x40020808)
#define I2C0_SLAVE_SIMR_R       EE_HWREG(0x4002080C)
#define I2C0_SLAVE_SRIS_R       EE_HWREG(0x40020810)
#define I2C0_SLAVE_SMIS_R       EE_HWREG(0x40020814)
#define I2C0_SLAVE_SICR_R       EE_HWREG(0x40020818)
#define I2C0_SLAVE_SOAR2_R      EE_HWREG(0x4002081C)
#define I2C0_SLAVE_SACKCTL_R    EE_HWREG(0x40020820)

/* I2C registers (I2C1 MASTER) */
#define I2C1_MASTER_MSA_R       EE_HWREG(0x40021000)
#define I2C1_MASTER_MCS_R       EE_HWREG(0x40021004)
#define I2C1_MASTER_MDR_R       EE_HWREG(0x40021008)
#define I2C1_MASTER_MTPR_R      EE_HWREG(0x4002100C)
#define I2C1_MASTER_MIMR_R      EE_HWREG(0x40021010)
#define I2C1_MASTER_MRIS_R      EE_HWREG(0x40021014)
#define I2C1_MASTER_MMIS_R      EE_HWREG(0x40021018)
#define I2C1_MASTER_MICR_R      EE_HWREG(0x4002101C)
#define I2C1_MASTER_MCR_R       EE_HWREG(0x40021020)
#define I2C1_MASTER_MCLKOCNT_R  EE_HWREG(0x40021024)
#define I2C1_MASTER_MBMON_R     EE_HWREG(0x4002102C)

/* I2C registers (I2C1 SLAVE) */
#define I2C1_SLAVE_SOAR_R       EE_HWREG(0x40021800)
#define I2C1_SLAVE_SCSR_R       EE_HWREG(0x40021804)
#define I2C1_SLAVE_SDR_R        EE_HWREG(0x40021808)
#define I2C1_SLAVE_SIMR_R       EE_HWREG(0x4002180C)
#define I2C1_SLAVE_SRIS_R       EE_HWREG(0x40021810)
#define I2C1_SLAVE_SMIS_R       EE_HWREG(0x40021814)
#define I2C1_SLAVE_SICR_R       EE_HWREG(0x40021818)
#define I2C1_SLAVE_SOAR2_R      EE_HWREG(0x4002181C)
#define I2C1_SLAVE_SACKCTL_R    EE_HWREG(0x40021820)

/* I2C registers (I2C2 MASTER) */
#define I2C2_MASTER_MSA_R       EE_HWREG(0x40022000)
#define I2C2_MASTER_MCS_R       EE_HWREG(0x40022004)
#define I2C2_MASTER_MDR_R       EE_HWREG(0x40022008)
#define I2C2_MASTER_MTPR_R      EE_HWREG(0x4002200C)
#define I2C2_MASTER_MIMR_R      EE_HWREG(0x40022010)
#define I2C2_MASTER_MRIS_R      EE_HWREG(0x40022014)
#define I2C2_MASTER_MMIS_R      EE_HWREG(0x40022018)
#define I2C2_MASTER_MICR_R      EE_HWREG(0x4002201C)
#define I2C2_MASTER_MCR_R       EE_HWREG(0x40022020)
#define I2C2_MASTER_MCLKOCNT_R  EE_HWREG(0x40022024)
#define I2C2_MASTER_MBMON_R     EE_HWREG(0x4002202C)

/* I2C registers (I2C2 SLAVE) */
#define I2C2_SLAVE_SOAR_R       EE_HWREG(0x40022800)
#define I2C2_SLAVE_SCSR_R       EE_HWREG(0x40022804)
#define I2C2_SLAVE_SDR_R        EE_HWREG(0x40022808)
#define I2C2_SLAVE_SIMR_R       EE_HWREG(0x4002280C)
#define I2C2_SLAVE_SRIS_R       EE_HWREG(0x40022810)
#define I2C2_SLAVE_SMIS_R       EE_HWREG(0x40022814)
#define I2C2_SLAVE_SICR_R       EE_HWREG(0x40022818)
#define I2C2_SLAVE_SOAR2_R      EE_HWREG(0x4002281C)
#define I2C2_SLAVE_SACKCTL_R    EE_HWREG(0x40022820)

/* I2C registers (I2C3 MASTER) */
#define I2C3_MASTER_MSA_R       EE_HWREG(0x40023000)
#define I2C3_MASTER_MCS_R       EE_HWREG(0x40023004)
#define I2C3_MASTER_MDR_R       EE_HWREG(0x40023008)
#define I2C3_MASTER_MTPR_R      EE_HWREG(0x4002300C)
#define I2C3_MASTER_MIMR_R      EE_HWREG(0x40023010)
#define I2C3_MASTER_MRIS_R      EE_HWREG(0x40023014)
#define I2C3_MASTER_MMIS_R      EE_HWREG(0x40023018)
#define I2C3_MASTER_MICR_R      EE_HWREG(0x4002301C)
#define I2C3_MASTER_MCR_R       EE_HWREG(0x40023020)
#define I2C3_MASTER_MCLKOCNT_R  EE_HWREG(0x40023024)
#define I2C3_MASTER_MBMON_R     EE_HWREG(0x4002302C)

/* I2C registers (I2C3 SLAVE) */
#define I2C3_SLAVE_SOAR_R       EE_HWREG(0x40023800)
#define I2C3_SLAVE_SCSR_R       EE_HWREG(0x40023804)
#define I2C3_SLAVE_SDR_R        EE_HWREG(0x40023808)
#define I2C3_SLAVE_SIMR_R       EE_HWREG(0x4002380C)
#define I2C3_SLAVE_SRIS_R       EE_HWREG(0x40023810)
#define I2C3_SLAVE_SMIS_R       EE_HWREG(0x40023814)
#define I2C3_SLAVE_SICR_R       EE_HWREG(0x40023818)
#define I2C3_SLAVE_SOAR2_R      EE_HWREG(0x4002381C)
#define I2C3_SLAVE_SACKCTL_R    EE_HWREG(0x40023820)

/* GPIO registers (PORTE) */
#define GPIO_PORTE_DATA_BITS_R  EE_HWREG_ADDR(0x40024000)
#define GPIO_PORTE_DATA_R       EE_HWREG(0x400243FC)
#define GPIO_PORTE_DIR_R        EE_HWREG(0x40024400)
#define GPIO_PORTE_IS_R         EE_HWREG(0x40024404)
#define GPIO_PORTE_IBE_R        EE_HWREG(0x40024408)
#define GPIO_PORTE_IEV_R        EE_HWREG(0x4002440C)
#define GPIO_PORTE_IM_R         EE_HWREG(0x40024410)
#define GPIO_PORTE_RIS_R        EE_HWREG(0x40024414)
#define GPIO_PORTE_MIS_R        EE_HWREG(0x40024418)
#define GPIO_PORTE_ICR_R        EE_HWREG(0x4002441C)
#define GPIO_PORTE_AFSEL_R      EE_HWREG(0x40024420)
#define GPIO_PORTE_DR2R_R       EE_HWREG(0x40024500)
#define GPIO_PORTE_DR4R_R       EE_HWREG(0x40024504)
#define GPIO_PORTE_DR8R_R       EE_HWREG(0x40024508)
#define GPIO_PORTE_ODR_R        EE_HWREG(0x4002450C)
#define GPIO_PORTE_PUR_R        EE_HWREG(0x40024510)
#define GPIO_PORTE_PDR_R        EE_HWREG(0x40024514)
#define GPIO_PORTE_SLR_R        EE_HWREG(0x40024518)
#define GPIO_PORTE_DEN_R        EE_HWREG(0x4002451C)
#define GPIO_PORTE_LOCK_R       EE_HWREG(0x40024520)
#define GPIO_PORTE_CR_R         EE_HWREG(0x40024524)
#define GPIO_PORTE_AMSEL_R      EE_HWREG(0x40024528)
#define GPIO_PORTE_PCTL_R       EE_HWREG(0x4002452C)
#define GPIO_PORTE_ADCCTL_R     EE_HWREG(0x40024530)
#define GPIO_PORTE_DMACTL_R     EE_HWREG(0x40024534)
#define GPIO_PORTE_SI_R         EE_HWREG(0x40024538)

/* GPIO registers (PORTF) */
#define GPIO_PORTF_DATA_BITS_R  EE_HWREG_ADDR(0x40025000)
#define GPIO_PORTF_DATA_R       EE_HWREG(0x400253FC)
#define GPIO_PORTF_DIR_R        EE_HWREG(0x40025400)
#define GPIO_PORTF_IS_R         EE_HWREG(0x40025404)
#define GPIO_PORTF_IBE_R        EE_HWREG(0x40025408)
#define GPIO_PORTF_IEV_R        EE_HWREG(0x4002540C)
#define GPIO_PORTF_IM_R         EE_HWREG(0x40025410)
#define GPIO_PORTF_RIS_R        EE_HWREG(0x40025414)
#define GPIO_PORTF_MIS_R        EE_HWREG(0x40025418)
#define GPIO_PORTF_ICR_R        EE_HWREG(0x4002541C)
#define GPIO_PORTF_AFSEL_R      EE_HWREG(0x40025420)
#define GPIO_PORTF_DR2R_R       EE_HWREG(0x40025500)
#define GPIO_PORTF_DR4R_R       EE_HWREG(0x40025504)
#define GPIO_PORTF_DR8R_R       EE_HWREG(0x40025508)
#define GPIO_PORTF_ODR_R        EE_HWREG(0x4002550C)
#define GPIO_PORTF_PUR_R        EE_HWREG(0x40025510)
#define GPIO_PORTF_PDR_R        EE_HWREG(0x40025514)
#define GPIO_PORTF_SLR_R        EE_HWREG(0x40025518)
#define GPIO_PORTF_DEN_R        EE_HWREG(0x4002551C)
#define GPIO_PORTF_LOCK_R       EE_HWREG(0x40025520)
#define GPIO_PORTF_CR_R         EE_HWREG(0x40025524)
#define GPIO_PORTF_AMSEL_R      EE_HWREG(0x40025528)
#define GPIO_PORTF_PCTL_R       EE_HWREG(0x4002552C)
#define GPIO_PORTF_ADCCTL_R     EE_HWREG(0x40025530)
#define GPIO_PORTF_DMACTL_R     EE_HWREG(0x40025534)
#define GPIO_PORTF_SI_R         EE_HWREG(0x40025538)

/* GPIO registers (PORTG) */
#define GPIO_PORTG_DATA_BITS_R  EE_HWREG_ADDR(0x40026000)
#define GPIO_PORTG_DATA_R       EE_HWREG(0x400263FC)
#define GPIO_PORTG_DIR_R        EE_HWREG(0x40026400)
#define GPIO_PORTG_IS_R         EE_HWREG(0x40026404)
#define GPIO_PORTG_IBE_R        EE_HWREG(0x40026408)
#define GPIO_PORTG_IEV_R        EE_HWREG(0x4002640C)
#define GPIO_PORTG_IM_R         EE_HWREG(0x40026410)
#define GPIO_PORTG_RIS_R        EE_HWREG(0x40026414)
#define GPIO_PORTG_MIS_R        EE_HWREG(0x40026418)
#define GPIO_PORTG_ICR_R        EE_HWREG(0x4002641C)
#define GPIO_PORTG_AFSEL_R      EE_HWREG(0x40026420)
#define GPIO_PORTG_DR2R_R       EE_HWREG(0x40026500)
#define GPIO_PORTG_DR4R_R       EE_HWREG(0x40026504)
#define GPIO_PORTG_DR8R_R       EE_HWREG(0x40026508)
#define GPIO_PORTG_ODR_R        EE_HWREG(0x4002650C)
#define GPIO_PORTG_PUR_R        EE_HWREG(0x40026510)
#define GPIO_PORTG_PDR_R        EE_HWREG(0x40026514)
#define GPIO_PORTG_SLR_R        EE_HWREG(0x40026518)
#define GPIO_PORTG_DEN_R        EE_HWREG(0x4002651C)
#define GPIO_PORTG_LOCK_R       EE_HWREG(0x40026520)
#define GPIO_PORTG_CR_R         EE_HWREG(0x40026524)
#define GPIO_PORTG_AMSEL_R      EE_HWREG(0x40026528)
#define GPIO_PORTG_PCTL_R       EE_HWREG(0x4002652C)
#define GPIO_PORTG_ADCCTL_R     EE_HWREG(0x40026530)
#define GPIO_PORTG_DMACTL_R     EE_HWREG(0x40026534)
#define GPIO_PORTG_SI_R         EE_HWREG(0x40026538)

/* GPIO registers (PORTH) */
#define GPIO_PORTH_DATA_BITS_R  EE_HWREG_ADDR(0x40027000)
#define GPIO_PORTH_DATA_R       EE_HWREG(0x400273FC)
#define GPIO_PORTH_DIR_R        EE_HWREG(0x40027400)
#define GPIO_PORTH_IS_R         EE_HWREG(0x40027404)
#define GPIO_PORTH_IBE_R        EE_HWREG(0x40027408)
#define GPIO_PORTH_IEV_R        EE_HWREG(0x4002740C)
#define GPIO_PORTH_IM_R         EE_HWREG(0x40027410)
#define GPIO_PORTH_RIS_R        EE_HWREG(0x40027414)
#define GPIO_PORTH_MIS_R        EE_HWREG(0x40027418)
#define GPIO_PORTH_ICR_R        EE_HWREG(0x4002741C)
#define GPIO_PORTH_AFSEL_R      EE_HWREG(0x40027420)
#define GPIO_PORTH_DR2R_R       EE_HWREG(0x40027500)
#define GPIO_PORTH_DR4R_R       EE_HWREG(0x40027504)
#define GPIO_PORTH_DR8R_R       EE_HWREG(0x40027508)
#define GPIO_PORTH_ODR_R        EE_HWREG(0x4002750C)
#define GPIO_PORTH_PUR_R        EE_HWREG(0x40027510)
#define GPIO_PORTH_PDR_R        EE_HWREG(0x40027514)
#define GPIO_PORTH_SLR_R        EE_HWREG(0x40027518)
#define GPIO_PORTH_DEN_R        EE_HWREG(0x4002751C)
#define GPIO_PORTH_LOCK_R       EE_HWREG(0x40027520)
#define GPIO_PORTH_CR_R         EE_HWREG(0x40027524)
#define GPIO_PORTH_AMSEL_R      EE_HWREG(0x40027528)
#define GPIO_PORTH_PCTL_R       EE_HWREG(0x4002752C)
#define GPIO_PORTH_ADCCTL_R     EE_HWREG(0x40027530)
#define GPIO_PORTH_DMACTL_R     EE_HWREG(0x40027534)
#define GPIO_PORTH_SI_R         EE_HWREG(0x40027538)

/* PWM registers (PWM0) */
#define PWM0_CTL_R              EE_HWREG(0x40028000)
#define PWM0_SYNC_R             EE_HWREG(0x40028004)
#define PWM0_ENABLE_R           EE_HWREG(0x40028008)
#define PWM0_INVERT_R           EE_HWREG(0x4002800C)
#define PWM0_FAULT_R            EE_HWREG(0x40028010)
#define PWM0_INTEN_R            EE_HWREG(0x40028014)
#define PWM0_RIS_R              EE_HWREG(0x40028018)
#define PWM0_ISC_R              EE_HWREG(0x4002801C)
#define PWM0_STATUS_R           EE_HWREG(0x40028020)
#define PWM0_FAULTVAL_R         EE_HWREG(0x40028024)
#define PWM0_ENUPD_R            EE_HWREG(0x40028028)
#define PWM0_0_CTL_R            EE_HWREG(0x40028040)
#define PWM0_0_INTEN_R          EE_HWREG(0x40028044)
#define PWM0_0_RIS_R            EE_HWREG(0x40028048)
#define PWM0_0_ISC_R            EE_HWREG(0x4002804C)
#define PWM0_0_LOAD_R           EE_HWREG(0x40028050)
#define PWM0_0_COUNT_R          EE_HWREG(0x40028054)
#define PWM0_0_CMPA_R           EE_HWREG(0x40028058)
#define PWM0_0_CMPB_R           EE_HWREG(0x4002805C)
#define PWM0_0_GENA_R           EE_HWREG(0x40028060)
#define PWM0_0_GENB_R           EE_HWREG(0x40028064)
#define PWM0_0_DBCTL_R          EE_HWREG(0x40028068)
#define PWM0_0_DBRISE_R         EE_HWREG(0x4002806C)
#define PWM0_0_DBFALL_R         EE_HWREG(0x40028070)
#define PWM0_0_FLTSRC0_R        EE_HWREG(0x40028074)
#define PWM0_0_FLTSRC1_R        EE_HWREG(0x40028078)
#define PWM0_0_MINFLTPER_R      EE_HWREG(0x4002807C)
#define PWM0_1_CTL_R            EE_HWREG(0x40028080)
#define PWM0_1_INTEN_R          EE_HWREG(0x40028084)
#define PWM0_1_RIS_R            EE_HWREG(0x40028088)
#define PWM0_1_ISC_R            EE_HWREG(0x4002808C)
#define PWM0_1_LOAD_R           EE_HWREG(0x40028090)
#define PWM0_1_COUNT_R          EE_HWREG(0x40028094)
#define PWM0_1_CMPA_R           EE_HWREG(0x40028098)
#define PWM0_1_CMPB_R           EE_HWREG(0x4002809C)
#define PWM0_1_GENA_R           EE_HWREG(0x400280A0)
#define PWM0_1_GENB_R           EE_HWREG(0x400280A4)
#define PWM0_1_DBCTL_R          EE_HWREG(0x400280A8)
#define PWM0_1_DBRISE_R         EE_HWREG(0x400280AC)
#define PWM0_1_DBFALL_R         EE_HWREG(0x400280B0)
#define PWM0_1_FLTSRC0_R        EE_HWREG(0x400280B4)
#define PWM0_1_FLTSRC1_R        EE_HWREG(0x400280B8)
#define PWM0_1_MINFLTPER_R      EE_HWREG(0x400280BC)
#define PWM0_2_CTL_R            EE_HWREG(0x400280C0)
#define PWM0_2_INTEN_R          EE_HWREG(0x400280C4)
#define PWM0_2_RIS_R            EE_HWREG(0x400280C8)
#define PWM0_2_ISC_R            EE_HWREG(0x400280CC)
#define PWM0_2_LOAD_R           EE_HWREG(0x400280D0)
#define PWM0_2_COUNT_R          EE_HWREG(0x400280D4)
#define PWM0_2_CMPA_R           EE_HWREG(0x400280D8)
#define PWM0_2_CMPB_R           EE_HWREG(0x400280DC)
#define PWM0_2_GENA_R           EE_HWREG(0x400280E0)
#define PWM0_2_GENB_R           EE_HWREG(0x400280E4)
#define PWM0_2_DBCTL_R          EE_HWREG(0x400280E8)
#define PWM0_2_DBRISE_R         EE_HWREG(0x400280EC)
#define PWM0_2_DBFALL_R         EE_HWREG(0x400280F0)
#define PWM0_2_FLTSRC0_R        EE_HWREG(0x400280F4)
#define PWM0_2_FLTSRC1_R        EE_HWREG(0x400280F8)
#define PWM0_2_MINFLTPER_R      EE_HWREG(0x400280FC)
#define PWM0_3_CTL_R            EE_HWREG(0x40028100)
#define PWM0_3_INTEN_R          EE_HWREG(0x40028104)
#define PWM0_3_RIS_R            EE_HWREG(0x40028108)
#define PWM0_3_ISC_R            EE_HWREG(0x4002810C)
#define PWM0_3_LOAD_R           EE_HWREG(0x40028110)
#define PWM0_3_COUNT_R          EE_HWREG(0x40028114)
#define PWM0_3_CMPA_R           EE_HWREG(0x40028118)
#define PWM0_3_CMPB_R           EE_HWREG(0x4002811C)
#define PWM0_3_GENA_R           EE_HWREG(0x40028120)
#define PWM0_3_GENB_R           EE_HWREG(0x40028124)
#define PWM0_3_DBCTL_R          EE_HWREG(0x40028128)
#define PWM0_3_DBRISE_R         EE_HWREG(0x4002812C)
#define PWM0_3_DBFALL_R         EE_HWREG(0x40028130)
#define PWM0_3_FLTSRC0_R        EE_HWREG(0x40028134)
#define PWM0_3_FLTSRC1_R        EE_HWREG(0x40028138)
#define PWM0_3_MINFLTPER_R      EE_HWREG(0x4002813C)
#define PWM0_0_FLTSEN_R         EE_HWREG(0x40028800)
#define PWM0_0_FLTSTAT0_R       EE_HWREG(0x40028804)
#define PWM0_0_FLTSTAT1_R       EE_HWREG(0x40028808)
#define PWM0_1_FLTSEN_R         EE_HWREG(0x40028880)
#define PWM0_1_FLTSTAT0_R       EE_HWREG(0x40028884)
#define PWM0_1_FLTSTAT1_R       EE_HWREG(0x40028888)
#define PWM0_2_FLTSEN_R         EE_HWREG(0x40028900)
#define PWM0_2_FLTSTAT0_R       EE_HWREG(0x40028904)
#define PWM0_2_FLTSTAT1_R       EE_HWREG(0x40028908)
#define PWM0_3_FLTSEN_R         EE_HWREG(0x40028980)
#define PWM0_3_FLTSTAT0_R       EE_HWREG(0x40028984)
#define PWM0_3_FLTSTAT1_R       EE_HWREG(0x40028988)
#define PWM0_PP_R               EE_HWREG(0x40028FC0)
#define PWM0_PC_R               EE_HWREG(0x40028FC4)

/* PWM registers (PWM1) */
#define PWM1_CTL_R              EE_HWREG(0x40029000)
#define PWM1_SYNC_R             EE_HWREG(0x40029004)
#define PWM1_ENABLE_R           EE_HWREG(0x40029008)
#define PWM1_INVERT_R           EE_HWREG(0x4002900C)
#define PWM1_FAULT_R            EE_HWREG(0x40029010)
#define PWM1_INTEN_R            EE_HWREG(0x40029014)
#define PWM1_RIS_R              EE_HWREG(0x40029018)
#define PWM1_ISC_R              EE_HWREG(0x4002901C)
#define PWM1_STATUS_R           EE_HWREG(0x40029020)
#define PWM1_FAULTVAL_R         EE_HWREG(0x40029024)
#define PWM1_ENUPD_R            EE_HWREG(0x40029028)
#define PWM1_0_CTL_R            EE_HWREG(0x40029040)
#define PWM1_0_INTEN_R          EE_HWREG(0x40029044)
#define PWM1_0_RIS_R            EE_HWREG(0x40029048)
#define PWM1_0_ISC_R            EE_HWREG(0x4002904C)
#define PWM1_0_LOAD_R           EE_HWREG(0x40029050)
#define PWM1_0_COUNT_R          EE_HWREG(0x40029054)
#define PWM1_0_CMPA_R           EE_HWREG(0x40029058)
#define PWM1_0_CMPB_R           EE_HWREG(0x4002905C)
#define PWM1_0_GENA_R           EE_HWREG(0x40029060)
#define PWM1_0_GENB_R           EE_HWREG(0x40029064)
#define PWM1_0_DBCTL_R          EE_HWREG(0x40029068)
#define PWM1_0_DBRISE_R         EE_HWREG(0x4002906C)
#define PWM1_0_DBFALL_R         EE_HWREG(0x40029070)
#define PWM1_0_FLTSRC0_R        EE_HWREG(0x40029074)
#define PWM1_0_FLTSRC1_R        EE_HWREG(0x40029078)
#define PWM1_0_MINFLTPER_R      EE_HWREG(0x4002907C)
#define PWM1_1_CTL_R            EE_HWREG(0x40029080)
#define PWM1_1_INTEN_R          EE_HWREG(0x40029084)
#define PWM1_1_RIS_R            EE_HWREG(0x40029088)
#define PWM1_1_ISC_R            EE_HWREG(0x4002908C)
#define PWM1_1_LOAD_R           EE_HWREG(0x40029090)
#define PWM1_1_COUNT_R          EE_HWREG(0x40029094)
#define PWM1_1_CMPA_R           EE_HWREG(0x40029098)
#define PWM1_1_CMPB_R           EE_HWREG(0x4002909C)
#define PWM1_1_GENA_R           EE_HWREG(0x400290A0)
#define PWM1_1_GENB_R           EE_HWREG(0x400290A4)
#define PWM1_1_DBCTL_R          EE_HWREG(0x400290A8)
#define PWM1_1_DBRISE_R         EE_HWREG(0x400290AC)
#define PWM1_1_DBFALL_R         EE_HWREG(0x400290B0)
#define PWM1_1_FLTSRC0_R        EE_HWREG(0x400290B4)
#define PWM1_1_FLTSRC1_R        EE_HWREG(0x400290B8)
#define PWM1_1_MINFLTPER_R      EE_HWREG(0x400290BC)
#define PWM1_2_CTL_R            EE_HWREG(0x400290C0)
#define PWM1_2_INTEN_R          EE_HWREG(0x400290C4)
#define PWM1_2_RIS_R            EE_HWREG(0x400290C8)
#define PWM1_2_ISC_R            EE_HWREG(0x400290CC)
#define PWM1_2_LOAD_R           EE_HWREG(0x400290D0)
#define PWM1_2_COUNT_R          EE_HWREG(0x400290D4)
#define PWM1_2_CMPA_R           EE_HWREG(0x400290D8)
#define PWM1_2_CMPB_R           EE_HWREG(0x400290DC)
#define PWM1_2_GENA_R           EE_HWREG(0x400290E0)
#define PWM1_2_GENB_R           EE_HWREG(0x400290E4)
#define PWM1_2_DBCTL_R          EE_HWREG(0x400290E8)
#define PWM1_2_DBRISE_R         EE_HWREG(0x400290EC)
#define PWM1_2_DBFALL_R         EE_HWREG(0x400290F0)
#define PWM1_2_FLTSRC0_R        EE_HWREG(0x400290F4)
#define PWM1_2_FLTSRC1_R        EE_HWREG(0x400290F8)
#define PWM1_2_MINFLTPER_R      EE_HWREG(0x400290FC)
#define PWM1_3_CTL_R            EE_HWREG(0x40029100)
#define PWM1_3_INTEN_R          EE_HWREG(0x40029104)
#define PWM1_3_RIS_R            EE_HWREG(0x40029108)
#define PWM1_3_ISC_R            EE_HWREG(0x4002910C)
#define PWM1_3_LOAD_R           EE_HWREG(0x40029110)
#define PWM1_3_COUNT_R          EE_HWREG(0x40029114)
#define PWM1_3_CMPA_R           EE_HWREG(0x40029118)
#define PWM1_3_CMPB_R           EE_HWREG(0x4002911C)
#define PWM1_3_GENA_R           EE_HWREG(0x40029120)
#define PWM1_3_GENB_R           EE_HWREG(0x40029124)
#define PWM1_3_DBCTL_R          EE_HWREG(0x40029128)
#define PWM1_3_DBRISE_R         EE_HWREG(0x4002912C)
#define PWM1_3_DBFALL_R         EE_HWREG(0x40029130)
#define PWM1_3_FLTSRC0_R        EE_HWREG(0x40029134)
#define PWM1_3_FLTSRC1_R        EE_HWREG(0x40029138)
#define PWM1_3_MINFLTPER_R      EE_HWREG(0x4002913C)
#define PWM1_0_FLTSEN_R         EE_HWREG(0x40029800)
#define PWM1_0_FLTSTAT0_R       EE_HWREG(0x40029804)
#define PWM1_0_FLTSTAT1_R       EE_HWREG(0x40029808)
#define PWM1_1_FLTSEN_R         EE_HWREG(0x40029880)
#define PWM1_1_FLTSTAT0_R       EE_HWREG(0x40029884)
#define PWM1_1_FLTSTAT1_R       EE_HWREG(0x40029888)
#define PWM1_2_FLTSEN_R         EE_HWREG(0x40029900)
#define PWM1_2_FLTSTAT0_R       EE_HWREG(0x40029904)
#define PWM1_2_FLTSTAT1_R       EE_HWREG(0x40029908)
#define PWM1_3_FLTSEN_R         EE_HWREG(0x40029980)
#define PWM1_3_FLTSTAT0_R       EE_HWREG(0x40029984)
#define PWM1_3_FLTSTAT1_R       EE_HWREG(0x40029988)
#define PWM1_PP_R               EE_HWREG(0x40029FC0)
#define PWM1_PC_R               EE_HWREG(0x40029FC4)

/* QEI registers (QEI0) */
#define QEI0_CTL_R              EE_HWREG(0x4002C000)
#define QEI0_STAT_R             EE_HWREG(0x4002C004)
#define QEI0_POS_R              EE_HWREG(0x4002C008)
#define QEI0_MAXPOS_R           EE_HWREG(0x4002C00C)
#define QEI0_LOAD_R             EE_HWREG(0x4002C010)
#define QEI0_TIME_R             EE_HWREG(0x4002C014)
#define QEI0_COUNT_R            EE_HWREG(0x4002C018)
#define QEI0_SPEED_R            EE_HWREG(0x4002C01C)
#define QEI0_INTEN_R            EE_HWREG(0x4002C020)
#define QEI0_RIS_R              EE_HWREG(0x4002C024)
#define QEI0_ISC_R              EE_HWREG(0x4002C028)

/* QEI registers (QEI1) */
#define QEI1_CTL_R              EE_HWREG(0x4002D000)
#define QEI1_STAT_R             EE_HWREG(0x4002D004)
#define QEI1_POS_R              EE_HWREG(0x4002D008)
#define QEI1_MAXPOS_R           EE_HWREG(0x4002D00C)
#define QEI1_LOAD_R             EE_HWREG(0x4002D010)
#define QEI1_TIME_R             EE_HWREG(0x4002D014)
#define QEI1_COUNT_R            EE_HWREG(0x4002D018)
#define QEI1_SPEED_R            EE_HWREG(0x4002D01C)
#define QEI1_INTEN_R            EE_HWREG(0x4002D020)
#define QEI1_RIS_R              EE_HWREG(0x4002D024)
#define QEI1_ISC_R              EE_HWREG(0x4002D028)

/* Timer registers (TIMER0) */
#define TIMER0_CFG_R            EE_HWREG(0x40030000)
#define TIMER0_TAMR_R           EE_HWREG(0x40030004)
#define TIMER0_TBMR_R           EE_HWREG(0x40030008)
#define TIMER0_CTL_R            EE_HWREG(0x4003000C)
#define TIMER0_SYNC_R           EE_HWREG(0x40030010)
#define TIMER0_IMR_R            EE_HWREG(0x40030018)
#define TIMER0_RIS_R            EE_HWREG(0x4003001C)
#define TIMER0_MIS_R            EE_HWREG(0x40030020)
#define TIMER0_ICR_R            EE_HWREG(0x40030024)
#define TIMER0_TAILR_R          EE_HWREG(0x40030028)
#define TIMER0_TBILR_R          EE_HWREG(0x4003002C)
#define TIMER0_TAMATCHR_R       EE_HWREG(0x40030030)
#define TIMER0_TBMATCHR_R       EE_HWREG(0x40030034)
#define TIMER0_TAPR_R           EE_HWREG(0x40030038)
#define TIMER0_TBPR_R           EE_HWREG(0x4003003C)
#define TIMER0_TAPMR_R          EE_HWREG(0x40030040)
#define TIMER0_TBPMR_R          EE_HWREG(0x40030044)
#define TIMER0_TAR_R            EE_HWREG(0x40030048)
#define TIMER0_TBR_R            EE_HWREG(0x4003004C)
#define TIMER0_TAV_R            EE_HWREG(0x40030050)
#define TIMER0_TBV_R            EE_HWREG(0x40030054)
#define TIMER0_RTCPD_R          EE_HWREG(0x40030058)
#define TIMER0_TAPS_R           EE_HWREG(0x4003005C)
#define TIMER0_TBPS_R           EE_HWREG(0x40030060)
#define TIMER0_TAPV_R           EE_HWREG(0x40030064)
#define TIMER0_TBPV_R           EE_HWREG(0x40030068)
#define TIMER0_PP_R             EE_HWREG(0x40030FC0)

/* Timer registers (TIMER1) */
#define TIMER1_CFG_R            EE_HWREG(0x40031000)
#define TIMER1_TAMR_R           EE_HWREG(0x40031004)
#define TIMER1_TBMR_R           EE_HWREG(0x40031008)
#define TIMER1_CTL_R            EE_HWREG(0x4003100C)
#define TIMER1_SYNC_R           EE_HWREG(0x40031010)
#define TIMER1_IMR_R            EE_HWREG(0x40031018)
#define TIMER1_RIS_R            EE_HWREG(0x4003101C)
#define TIMER1_MIS_R            EE_HWREG(0x40031020)
#define TIMER1_ICR_R            EE_HWREG(0x40031024)
#define TIMER1_TAILR_R          EE_HWREG(0x40031028)
#define TIMER1_TBILR_R          EE_HWREG(0x4003102C)
#define TIMER1_TAMATCHR_R       EE_HWREG(0x40031030)
#define TIMER1_TBMATCHR_R       EE_HWREG(0x40031034)
#define TIMER1_TAPR_R           EE_HWREG(0x40031038)
#define TIMER1_TBPR_R           EE_HWREG(0x4003103C)
#define TIMER1_TAPMR_R          EE_HWREG(0x40031040)
#define TIMER1_TBPMR_R          EE_HWREG(0x40031044)
#define TIMER1_TAR_R            EE_HWREG(0x40031048)
#define TIMER1_TBR_R            EE_HWREG(0x4003104C)
#define TIMER1_TAV_R            EE_HWREG(0x40031050)
#define TIMER1_TBV_R            EE_HWREG(0x40031054)
#define TIMER1_RTCPD_R          EE_HWREG(0x40031058)
#define TIMER1_TAPS_R           EE_HWREG(0x4003105C)
#define TIMER1_TBPS_R           EE_HWREG(0x40031060)
#define TIMER1_TAPV_R           EE_HWREG(0x40031064)
#define TIMER1_TBPV_R           EE_HWREG(0x40031068)
#define TIMER1_PP_R             EE_HWREG(0x40031FC0)

/* Timer registers (TIMER2) */
#define TIMER2_CFG_R            EE_HWREG(0x40032000)
#define TIMER2_TAMR_R           EE_HWREG(0x40032004)
#define TIMER2_TBMR_R           EE_HWREG(0x40032008)
#define TIMER2_CTL_R            EE_HWREG(0x4003200C)
#define TIMER2_SYNC_R           EE_HWREG(0x40032010)
#define TIMER2_IMR_R            EE_HWREG(0x40032018)
#define TIMER2_RIS_R            EE_HWREG(0x4003201C)
#define TIMER2_MIS_R            EE_HWREG(0x40032020)
#define TIMER2_ICR_R            EE_HWREG(0x40032024)
#define TIMER2_TAILR_R          EE_HWREG(0x40032028)
#define TIMER2_TBILR_R          EE_HWREG(0x4003202C)
#define TIMER2_TAMATCHR_R       EE_HWREG(0x40032030)
#define TIMER2_TBMATCHR_R       EE_HWREG(0x40032034)
#define TIMER2_TAPR_R           EE_HWREG(0x40032038)
#define TIMER2_TBPR_R           EE_HWREG(0x4003203C)
#define TIMER2_TAPMR_R          EE_HWREG(0x40032040)
#define TIMER2_TBPMR_R          EE_HWREG(0x40032044)
#define TIMER2_TAR_R            EE_HWREG(0x40032048)
#define TIMER2_TBR_R            EE_HWREG(0x4003204C)
#define TIMER2_TAV_R            EE_HWREG(0x40032050)
#define TIMER2_TBV_R            EE_HWREG(0x40032054)
#define TIMER2_RTCPD_R          EE_HWREG(0x40032058)
#define TIMER2_TAPS_R           EE_HWREG(0x4003205C)
#define TIMER2_TBPS_R           EE_HWREG(0x40032060)
#define TIMER2_TAPV_R           EE_HWREG(0x40032064)
#define TIMER2_TBPV_R           EE_HWREG(0x40032068)
#define TIMER2_PP_R             EE_HWREG(0x40032FC0)

/* Timer registers (TIMER3) */
#define TIMER3_CFG_R            EE_HWREG(0x40033000)
#define TIMER3_TAMR_R           EE_HWREG(0x40033004)
#define TIMER3_TBMR_R           EE_HWREG(0x40033008)
#define TIMER3_CTL_R            EE_HWREG(0x4003300C)
#define TIMER3_SYNC_R           EE_HWREG(0x40033010)
#define TIMER3_IMR_R            EE_HWREG(0x40033018)
#define TIMER3_RIS_R            EE_HWREG(0x4003301C)
#define TIMER3_MIS_R            EE_HWREG(0x40033020)
#define TIMER3_ICR_R            EE_HWREG(0x40033024)
#define TIMER3_TAILR_R          EE_HWREG(0x40033028)
#define TIMER3_TBILR_R          EE_HWREG(0x4003302C)
#define TIMER3_TAMATCHR_R       EE_HWREG(0x40033030)
#define TIMER3_TBMATCHR_R       EE_HWREG(0x40033034)
#define TIMER3_TAPR_R           EE_HWREG(0x40033038)
#define TIMER3_TBPR_R           EE_HWREG(0x4003303C)
#define TIMER3_TAPMR_R          EE_HWREG(0x40033040)
#define TIMER3_TBPMR_R          EE_HWREG(0x40033044)
#define TIMER3_TAR_R            EE_HWREG(0x40033048)
#define TIMER3_TBR_R            EE_HWREG(0x4003304C)
#define TIMER3_TAV_R            EE_HWREG(0x40033050)
#define TIMER3_TBV_R            EE_HWREG(0x40033054)
#define TIMER3_RTCPD_R          EE_HWREG(0x40033058)
#define TIMER3_TAPS_R           EE_HWREG(0x4003305C)
#define TIMER3_TBPS_R           EE_HWREG(0x40033060)
#define TIMER3_TAPV_R           EE_HWREG(0x40033064)
#define TIMER3_TBPV_R           EE_HWREG(0x40033068)
#define TIMER3_PP_R             EE_HWREG(0x40033FC0)

/* Timer registers (TIMER4) */
#define TIMER4_CFG_R            EE_HWREG(0x40034000)
#define TIMER4_TAMR_R           EE_HWREG(0x40034004)
#define TIMER4_TBMR_R           EE_HWREG(0x40034008)
#define TIMER4_CTL_R            EE_HWREG(0x4003400C)
#define TIMER4_SYNC_R           EE_HWREG(0x40034010)
#define TIMER4_IMR_R            EE_HWREG(0x40034018)
#define TIMER4_RIS_R            EE_HWREG(0x4003401C)
#define TIMER4_MIS_R            EE_HWREG(0x40034020)
#define TIMER4_ICR_R            EE_HWREG(0x40034024)
#define TIMER4_TAILR_R          EE_HWREG(0x40034028)
#define TIMER4_TBILR_R          EE_HWREG(0x4003402C)
#define TIMER4_TAMATCHR_R       EE_HWREG(0x40034030)
#define TIMER4_TBMATCHR_R       EE_HWREG(0x40034034)
#define TIMER4_TAPR_R           EE_HWREG(0x40034038)
#define TIMER4_TBPR_R           EE_HWREG(0x4003403C)
#define TIMER4_TAPMR_R          EE_HWREG(0x40034040)
#define TIMER4_TBPMR_R          EE_HWREG(0x40034044)
#define TIMER4_TAR_R            EE_HWREG(0x40034048)
#define TIMER4_TBR_R            EE_HWREG(0x4003404C)
#define TIMER4_TAV_R            EE_HWREG(0x40034050)
#define TIMER4_TBV_R            EE_HWREG(0x40034054)
#define TIMER4_RTCPD_R          EE_HWREG(0x40034058)
#define TIMER4_TAPS_R           EE_HWREG(0x4003405C)
#define TIMER4_TBPS_R           EE_HWREG(0x40034060)
#define TIMER4_TAPV_R           EE_HWREG(0x40034064)
#define TIMER4_TBPV_R           EE_HWREG(0x40034068)
#define TIMER4_PP_R             EE_HWREG(0x40034FC0)

/* Timer registers (TIMER5) */
#define TIMER5_CFG_R            EE_HWREG(0x40035000)
#define TIMER5_TAMR_R           EE_HWREG(0x40035004)
#define TIMER5_TBMR_R           EE_HWREG(0x40035008)
#define TIMER5_CTL_R            EE_HWREG(0x4003500C)
#define TIMER5_SYNC_R           EE_HWREG(0x40035010)
#define TIMER5_IMR_R            EE_HWREG(0x40035018)
#define TIMER5_RIS_R            EE_HWREG(0x4003501C)
#define TIMER5_MIS_R            EE_HWREG(0x40035020)
#define TIMER5_ICR_R            EE_HWREG(0x40035024)
#define TIMER5_TAILR_R          EE_HWREG(0x40035028)
#define TIMER5_TBILR_R          EE_HWREG(0x4003502C)
#define TIMER5_TAMATCHR_R       EE_HWREG(0x40035030)
#define TIMER5_TBMATCHR_R       EE_HWREG(0x40035034)
#define TIMER5_TAPR_R           EE_HWREG(0x40035038)
#define TIMER5_TBPR_R           EE_HWREG(0x4003503C)
#define TIMER5_TAPMR_R          EE_HWREG(0x40035040)
#define TIMER5_TBPMR_R          EE_HWREG(0x40035044)
#define TIMER5_TAR_R            EE_HWREG(0x40035048)
#define TIMER5_TBR_R            EE_HWREG(0x4003504C)
#define TIMER5_TAV_R            EE_HWREG(0x40035050)
#define TIMER5_TBV_R            EE_HWREG(0x40035054)
#define TIMER5_RTCPD_R          EE_HWREG(0x40035058)
#define TIMER5_TAPS_R           EE_HWREG(0x4003505C)
#define TIMER5_TBPS_R           EE_HWREG(0x40035060)
#define TIMER5_TAPV_R           EE_HWREG(0x40035064)
#define TIMER5_TBPV_R           EE_HWREG(0x40035068)
#define TIMER5_PP_R             EE_HWREG(0x40035FC0)

/* Timer registers (WTIMER0) */
#define WTIMER0_CFG_R           EE_HWREG(0x40036000)
#define WTIMER0_TAMR_R          EE_HWREG(0x40036004)
#define WTIMER0_TBMR_R          EE_HWREG(0x40036008)
#define WTIMER0_CTL_R           EE_HWREG(0x4003600C)
#define WTIMER0_SYNC_R          EE_HWREG(0x40036010)
#define WTIMER0_IMR_R           EE_HWREG(0x40036018)
#define WTIMER0_RIS_R           EE_HWREG(0x4003601C)
#define WTIMER0_MIS_R           EE_HWREG(0x40036020)
#define WTIMER0_ICR_R           EE_HWREG(0x40036024)
#define WTIMER0_TAILR_R         EE_HWREG(0x40036028)
#define WTIMER0_TBILR_R         EE_HWREG(0x4003602C)
#define WTIMER0_TAMATCHR_R      EE_HWREG(0x40036030)
#define WTIMER0_TBMATCHR_R      EE_HWREG(0x40036034)
#define WTIMER0_TAPR_R          EE_HWREG(0x40036038)
#define WTIMER0_TBPR_R          EE_HWREG(0x4003603C)
#define WTIMER0_TAPMR_R         EE_HWREG(0x40036040)
#define WTIMER0_TBPMR_R         EE_HWREG(0x40036044)
#define WTIMER0_TAR_R           EE_HWREG(0x40036048)
#define WTIMER0_TBR_R           EE_HWREG(0x4003604C)
#define WTIMER0_TAV_R           EE_HWREG(0x40036050)
#define WTIMER0_TBV_R           EE_HWREG(0x40036054)
#define WTIMER0_RTCPD_R         EE_HWREG(0x40036058)
#define WTIMER0_TAPS_R          EE_HWREG(0x4003605C)
#define WTIMER0_TBPS_R          EE_HWREG(0x40036060)
#define WTIMER0_TAPV_R          EE_HWREG(0x40036064)
#define WTIMER0_TBPV_R          EE_HWREG(0x40036068)
#define WTIMER0_PP_R            EE_HWREG(0x40036FC0)

/* Timer registers (WTIMER1) */
#define WTIMER1_CFG_R           EE_HWREG(0x40037000)
#define WTIMER1_TAMR_R          EE_HWREG(0x40037004)
#define WTIMER1_TBMR_R          EE_HWREG(0x40037008)
#define WTIMER1_CTL_R           EE_HWREG(0x4003700C)
#define WTIMER1_SYNC_R          EE_HWREG(0x40037010)
#define WTIMER1_IMR_R           EE_HWREG(0x40037018)
#define WTIMER1_RIS_R           EE_HWREG(0x4003701C)
#define WTIMER1_MIS_R           EE_HWREG(0x40037020)
#define WTIMER1_ICR_R           EE_HWREG(0x40037024)
#define WTIMER1_TAILR_R         EE_HWREG(0x40037028)
#define WTIMER1_TBILR_R         EE_HWREG(0x4003702C)
#define WTIMER1_TAMATCHR_R      EE_HWREG(0x40037030)
#define WTIMER1_TBMATCHR_R      EE_HWREG(0x40037034)
#define WTIMER1_TAPR_R          EE_HWREG(0x40037038)
#define WTIMER1_TBPR_R          EE_HWREG(0x4003703C)
#define WTIMER1_TAPMR_R         EE_HWREG(0x40037040)
#define WTIMER1_TBPMR_R         EE_HWREG(0x40037044)
#define WTIMER1_TAR_R           EE_HWREG(0x40037048)
#define WTIMER1_TBR_R           EE_HWREG(0x4003704C)
#define WTIMER1_TAV_R           EE_HWREG(0x40037050)
#define WTIMER1_TBV_R           EE_HWREG(0x40037054)
#define WTIMER1_RTCPD_R         EE_HWREG(0x40037058)
#define WTIMER1_TAPS_R          EE_HWREG(0x4003705C)
#define WTIMER1_TBPS_R          EE_HWREG(0x40037060)
#define WTIMER1_TAPV_R          EE_HWREG(0x40037064)
#define WTIMER1_TBPV_R          EE_HWREG(0x40037068)
#define WTIMER1_PP_R            EE_HWREG(0x40037FC0)

/* ADC registers (ADC0) */
#define ADC0_ACTSS_R            EE_HWREG(0x40038000)
#define ADC0_RIS_R              EE_HWREG(0x40038004)
#define ADC0_IM_R               EE_HWREG(0x40038008)
#define ADC0_ISC_R              EE_HWREG(0x4003800C)
#define ADC0_OSTAT_R            EE_HWREG(0x40038010)
#define ADC0_EMUX_R             EE_HWREG(0x40038014)
#define ADC0_USTAT_R            EE_HWREG(0x40038018)
#define ADC0_TSSEL_R            EE_HWREG(0x4003801C)
#define ADC0_SSPRI_R            EE_HWREG(0x40038020)
#define ADC0_SPC_R              EE_HWREG(0x40038024)
#define ADC0_PSSI_R             EE_HWREG(0x40038028)
#define ADC0_SAC_R              EE_HWREG(0x40038030)
#define ADC0_DCISC_R            EE_HWREG(0x40038034)
#define ADC0_CTL_R              EE_HWREG(0x40038038)
#define ADC0_SSMUX0_R           EE_HWREG(0x40038040)
#define ADC0_SSCTL0_R           EE_HWREG(0x40038044)
#define ADC0_SSFIFO0_R          EE_HWREG(0x40038048)
#define ADC0_SSFSTAT0_R         EE_HWREG(0x4003804C)
#define ADC0_SSOP0_R            EE_HWREG(0x40038050)
#define ADC0_SSDC0_R            EE_HWREG(0x40038054)
#define ADC0_SSEMUX0_R          EE_HWREG(0x40038058)
#define ADC0_SSMUX1_R           EE_HWREG(0x40038060)
#define ADC0_SSCTL1_R           EE_HWREG(0x40038064)
#define ADC0_SSFIFO1_R          EE_HWREG(0x40038068)
#define ADC0_SSFSTAT1_R         EE_HWREG(0x4003806C)
#define ADC0_SSOP1_R            EE_HWREG(0x40038070)
#define ADC0_SSDC1_R            EE_HWREG(0x40038074)
#define ADC0_SSEMUX1_R          EE_HWREG(0x40038078)
#define ADC0_SSMUX2_R           EE_HWREG(0x40038080)
#define ADC0_SSCTL2_R           EE_HWREG(0x40038084)
#define ADC0_SSFIFO2_R          EE_HWREG(0x40038088)
#define ADC0_SSFSTAT2_R         EE_HWREG(0x4003808C)
#define ADC0_SSOP2_R            EE_HWREG(0x40038090)
#define ADC0_SSDC2_R            EE_HWREG(0x40038094)
#define ADC0_SSEMUX2_R          EE_HWREG(0x40038098)
#define ADC0_SSMUX3_R           EE_HWREG(0x400380A0)
#define ADC0_SSCTL3_R           EE_HWREG(0x400380A4)
#define ADC0_SSFIFO3_R          EE_HWREG(0x400380A8)
#define ADC0_SSFSTAT3_R         EE_HWREG(0x400380AC)
#define ADC0_SSOP3_R            EE_HWREG(0x400380B0)
#define ADC0_SSDC3_R            EE_HWREG(0x400380B4)
#define ADC0_SSEMUX3_R          EE_HWREG(0x400380B8)
#define ADC0_DCRIC_R            EE_HWREG(0x40038D00)
#define ADC0_DCCTL0_R           EE_HWREG(0x40038E00)
#define ADC0_DCCTL1_R           EE_HWREG(0x40038E04)
#define ADC0_DCCTL2_R           EE_HWREG(0x40038E08)
#define ADC0_DCCTL3_R           EE_HWREG(0x40038E0C)
#define ADC0_DCCTL4_R           EE_HWREG(0x40038E10)
#define ADC0_DCCTL5_R           EE_HWREG(0x40038E14)
#define ADC0_DCCTL6_R           EE_HWREG(0x40038E18)
#define ADC0_DCCTL7_R           EE_HWREG(0x40038E1C)
#define ADC0_DCCMP0_R           EE_HWREG(0x40038E40)
#define ADC0_DCCMP1_R           EE_HWREG(0x40038E44)
#define ADC0_DCCMP2_R           EE_HWREG(0x40038E48)
#define ADC0_DCCMP3_R           EE_HWREG(0x40038E4C)
#define ADC0_DCCMP4_R           EE_HWREG(0x40038E50)
#define ADC0_DCCMP5_R           EE_HWREG(0x40038E54)
#define ADC0_DCCMP6_R           EE_HWREG(0x40038E58)
#define ADC0_DCCMP7_R           EE_HWREG(0x40038E5C)
#define ADC0_PP_R               EE_HWREG(0x40038FC0)
#define ADC0_PC_R               EE_HWREG(0x40038FC4)
#define ADC0_CC_R               EE_HWREG(0x40038FC8)

/* ADC registers (ADC1) */
#define ADC1_ACTSS_R            EE_HWREG(0x40039000)
#define ADC1_RIS_R              EE_HWREG(0x40039004)
#define ADC1_IM_R               EE_HWREG(0x40039008)
#define ADC1_ISC_R              EE_HWREG(0x4003900C)
#define ADC1_OSTAT_R            EE_HWREG(0x40039010)
#define ADC1_EMUX_R             EE_HWREG(0x40039014)
#define ADC1_USTAT_R            EE_HWREG(0x40039018)
#define ADC1_TSSEL_R            EE_HWREG(0x4003901C)
#define ADC1_SSPRI_R            EE_HWREG(0x40039020)
#define ADC1_SPC_R              EE_HWREG(0x40039024)
#define ADC1_PSSI_R             EE_HWREG(0x40039028)
#define ADC1_SAC_R              EE_HWREG(0x40039030)
#define ADC1_DCISC_R            EE_HWREG(0x40039034)
#define ADC1_CTL_R              EE_HWREG(0x40039038)
#define ADC1_SSMUX0_R           EE_HWREG(0x40039040)
#define ADC1_SSCTL0_R           EE_HWREG(0x40039044)
#define ADC1_SSFIFO0_R          EE_HWREG(0x40039048)
#define ADC1_SSFSTAT0_R         EE_HWREG(0x4003904C)
#define ADC1_SSOP0_R            EE_HWREG(0x40039050)
#define ADC1_SSDC0_R            EE_HWREG(0x40039054)
#define ADC1_SSEMUX0_R          EE_HWREG(0x40039058)
#define ADC1_SSMUX1_R           EE_HWREG(0x40039060)
#define ADC1_SSCTL1_R           EE_HWREG(0x40039064)
#define ADC1_SSFIFO1_R          EE_HWREG(0x40039068)
#define ADC1_SSFSTAT1_R         EE_HWREG(0x4003906C)
#define ADC1_SSOP1_R            EE_HWREG(0x40039070)
#define ADC1_SSDC1_R            EE_HWREG(0x40039074)
#define ADC1_SSEMUX1_R          EE_HWREG(0x40039078)
#define ADC1_SSMUX2_R           EE_HWREG(0x40039080)
#define ADC1_SSCTL2_R           EE_HWREG(0x40039084)
#define ADC1_SSFIFO2_R          EE_HWREG(0x40039088)
#define ADC1_SSFSTAT2_R         EE_HWREG(0x4003908C)
#define ADC1_SSOP2_R            EE_HWREG(0x40039090)
#define ADC1_SSDC2_R            EE_HWREG(0x40039094)
#define ADC1_SSEMUX2_R          EE_HWREG(0x40039098)
#define ADC1_SSMUX3_R           EE_HWREG(0x400390A0)
#define ADC1_SSCTL3_R           EE_HWREG(0x400390A4)
#define ADC1_SSFIFO3_R          EE_HWREG(0x400390A8)
#define ADC1_SSFSTAT3_R         EE_HWREG(0x400390AC)
#define ADC1_SSOP3_R            EE_HWREG(0x400390B0)
#define ADC1_SSDC3_R            EE_HWREG(0x400390B4)
#define ADC1_SSEMUX3_R          EE_HWREG(0x400390B8)
#define ADC1_DCRIC_R            EE_HWREG(0x40039D00)
#define ADC1_DCCTL0_R           EE_HWREG(0x40039E00)
#define ADC1_DCCTL1_R           EE_HWREG(0x40039E04)
#define ADC1_DCCTL2_R           EE_HWREG(0x40039E08)
#define ADC1_DCCTL3_R           EE_HWREG(0x40039E0C)
#define ADC1_DCCTL4_R           EE_HWREG(0x40039E10)
#define ADC1_DCCTL5_R           EE_HWREG(0x40039E14)
#define ADC1_DCCTL6_R           EE_HWREG(0x40039E18)
#define ADC1_DCCTL7_R           EE_HWREG(0x40039E1C)
#define ADC1_DCCMP0_R           EE_HWREG(0x40039E40)
#define ADC1_DCCMP1_R           EE_HWREG(0x40039E44)
#define ADC1_DCCMP2_R           EE_HWREG(0x40039E48)
#define ADC1_DCCMP3_R           EE_HWREG(0x40039E4C)
#define ADC1_DCCMP4_R           EE_HWREG(0x40039E50)
#define ADC1_DCCMP5_R           EE_HWREG(0x40039E54)
#define ADC1_DCCMP6_R           EE_HWREG(0x40039E58)
#define ADC1_DCCMP7_R           EE_HWREG(0x40039E5C)
#define ADC1_PP_R               EE_HWREG(0x40039FC0)
#define ADC1_PC_R               EE_HWREG(0x40039FC4)
#define ADC1_CC_R               EE_HWREG(0x40039FC8)

/* Comparator registers (COMP) */
#define COMP_ACMIS_R            EE_HWREG(0x4003C000)
#define COMP_ACRIS_R            EE_HWREG(0x4003C004)
#define COMP_ACINTEN_R          EE_HWREG(0x4003C008)
#define COMP_ACREFCTL_R         EE_HWREG(0x4003C010)
#define COMP_ACSTAT0_R          EE_HWREG(0x4003C020)
#define COMP_ACCTL0_R           EE_HWREG(0x4003C024)
#define COMP_ACSTAT1_R          EE_HWREG(0x4003C040)
#define COMP_ACCTL1_R           EE_HWREG(0x4003C044)
#define COMP_ACSTAT2_R          EE_HWREG(0x4003C060)
#define COMP_ACCTL2_R           EE_HWREG(0x4003C064)
#define COMP_PP_R               EE_HWREG(0x4003CFC0)

/* GPIO registers (PORTJ) */
#define GPIO_PORTJ_DATA_BITS_R  EE_HWREG_ADDR(0x4003D000)
#define GPIO_PORTJ_DATA_R       EE_HWREG(0x4003D3FC)
#define GPIO_PORTJ_DIR_R        EE_HWREG(0x4003D400)
#define GPIO_PORTJ_IS_R         EE_HWREG(0x4003D404)
#define GPIO_PORTJ_IBE_R        EE_HWREG(0x4003D408)
#define GPIO_PORTJ_IEV_R        EE_HWREG(0x4003D40C)
#define GPIO_PORTJ_IM_R         EE_HWREG(0x4003D410)
#define GPIO_PORTJ_RIS_R        EE_HWREG(0x4003D414)
#define GPIO_PORTJ_MIS_R        EE_HWREG(0x4003D418)
#define GPIO_PORTJ_ICR_R        EE_HWREG(0x4003D41C)
#define GPIO_PORTJ_AFSEL_R      EE_HWREG(0x4003D420)
#define GPIO_PORTJ_DR2R_R       EE_HWREG(0x4003D500)
#define GPIO_PORTJ_DR4R_R       EE_HWREG(0x4003D504)
#define GPIO_PORTJ_DR8R_R       EE_HWREG(0x4003D508)
#define GPIO_PORTJ_ODR_R        EE_HWREG(0x4003D50C)
#define GPIO_PORTJ_PUR_R        EE_HWREG(0x4003D510)
#define GPIO_PORTJ_PDR_R        EE_HWREG(0x4003D514)
#define GPIO_PORTJ_SLR_R        EE_HWREG(0x4003D518)
#define GPIO_PORTJ_DEN_R        EE_HWREG(0x4003D51C)
#define GPIO_PORTJ_LOCK_R       EE_HWREG(0x4003D520)
#define GPIO_PORTJ_CR_R         EE_HWREG(0x4003D524)
#define GPIO_PORTJ_AMSEL_R      EE_HWREG(0x4003D528)
#define GPIO_PORTJ_PCTL_R       EE_HWREG(0x4003D52C)
#define GPIO_PORTJ_ADCCTL_R     EE_HWREG(0x4003D530)
#define GPIO_PORTJ_DMACTL_R     EE_HWREG(0x4003D534)
#define GPIO_PORTJ_SI_R         EE_HWREG(0x4003D538)

/* CAN registers (CAN0) */
#define CAN0_CTL_R              EE_HWREG(0x40040000)
#define CAN0_STS_R              EE_HWREG(0x40040004)
#define CAN0_ERR_R              EE_HWREG(0x40040008)
#define CAN0_BIT_R              EE_HWREG(0x4004000C)
#define CAN0_INT_R              EE_HWREG(0x40040010)
#define CAN0_TST_R              EE_HWREG(0x40040014)
#define CAN0_BRPE_R             EE_HWREG(0x40040018)
#define CAN0_IF1CRQ_R           EE_HWREG(0x40040020)
#define CAN0_IF1CMSK_R          EE_HWREG(0x40040024)
#define CAN0_IF1MSK1_R          EE_HWREG(0x40040028)
#define CAN0_IF1MSK2_R          EE_HWREG(0x4004002C)
#define CAN0_IF1ARB1_R          EE_HWREG(0x40040030)
#define CAN0_IF1ARB2_R          EE_HWREG(0x40040034)
#define CAN0_IF1MCTL_R          EE_HWREG(0x40040038)
#define CAN0_IF1DA1_R           EE_HWREG(0x4004003C)
#define CAN0_IF1DA2_R           EE_HWREG(0x40040040)
#define CAN0_IF1DB1_R           EE_HWREG(0x40040044)
#define CAN0_IF1DB2_R           EE_HWREG(0x40040048)
#define CAN0_IF2CRQ_R           EE_HWREG(0x40040080)
#define CAN0_IF2CMSK_R          EE_HWREG(0x40040084)
#define CAN0_IF2MSK1_R          EE_HWREG(0x40040088)
#define CAN0_IF2MSK2_R          EE_HWREG(0x4004008C)
#define CAN0_IF2ARB1_R          EE_HWREG(0x40040090)
#define CAN0_IF2ARB2_R          EE_HWREG(0x40040094)
#define CAN0_IF2MCTL_R          EE_HWREG(0x40040098)
#define CAN0_IF2DA1_R           EE_HWREG(0x4004009C)
#define CAN0_IF2DA2_R           EE_HWREG(0x400400A0)
#define CAN0_IF2DB1_R           EE_HWREG(0x400400A4)
#define CAN0_IF2DB2_R           EE_HWREG(0x400400A8)
#define CAN0_TXRQ1_R            EE_HWREG(0x40040100)
#define CAN0_TXRQ2_R            EE_HWREG(0x40040104)
#define CAN0_NWDA1_R            EE_HWREG(0x40040120)
#define CAN0_NWDA2_R            EE_HWREG(0x40040124)
#define CAN0_MSG1INT_R          EE_HWREG(0x40040140)
#define CAN0_MSG2INT_R          EE_HWREG(0x40040144)
#define CAN0_MSG1VAL_R          EE_HWREG(0x40040160)
#define CAN0_MSG2VAL_R          EE_HWREG(0x40040164)

/* CAN registers (CAN1) */
#define CAN1_CTL_R              EE_HWREG(0x40041000)
#define CAN1_STS_R              EE_HWREG(0x40041004)
#define CAN1_ERR_R              EE_HWREG(0x40041008)
#define CAN1_BIT_R              EE_HWREG(0x4004100C)
#define CAN1_INT_R              EE_HWREG(0x40041010)
#define CAN1_TST_R              EE_HWREG(0x40041014)
#define CAN1_BRPE_R             EE_HWREG(0x40041018)
#define CAN1_IF1CRQ_R           EE_HWREG(0x40041020)
#define CAN1_IF1CMSK_R          EE_HWREG(0x40041024)
#define CAN1_IF1MSK1_R          EE_HWREG(0x40041028)
#define CAN1_IF1MSK2_R          EE_HWREG(0x4004102C)
#define CAN1_IF1ARB1_R          EE_HWREG(0x40041030)
#define CAN1_IF1ARB2_R          EE_HWREG(0x40041034)
#define CAN1_IF1MCTL_R          EE_HWREG(0x40041038)
#define CAN1_IF1DA1_R           EE_HWREG(0x4004103C)
#define CAN1_IF1DA2_R           EE_HWREG(0x40041040)
#define CAN1_IF1DB1_R           EE_HWREG(0x40041044)
#define CAN1_IF1DB2_R           EE_HWREG(0x40041048)
#define CAN1_IF2CRQ_R           EE_HWREG(0x40041080)
#define CAN1_IF2CMSK_R          EE_HWREG(0x40041084)
#define CAN1_IF2MSK1_R          EE_HWREG(0x40041088)
#define CAN1_IF2MSK2_R          EE_HWREG(0x4004108C)
#define CAN1_IF2ARB1_R          EE_HWREG(0x40041090)
#define CAN1_IF2ARB2_R          EE_HWREG(0x40041094)
#define CAN1_IF2MCTL_R          EE_HWREG(0x40041098)
#define CAN1_IF2DA1_R           EE_HWREG(0x4004109C)
#define CAN1_IF2DA2_R           EE_HWREG(0x400410A0)
#define CAN1_IF2DB1_R           EE_HWREG(0x400410A4)
#define CAN1_IF2DB2_R           EE_HWREG(0x400410A8)
#define CAN1_TXRQ1_R            EE_HWREG(0x40041100)
#define CAN1_TXRQ2_R            EE_HWREG(0x40041104)
#define CAN1_NWDA1_R            EE_HWREG(0x40041120)
#define CAN1_NWDA2_R            EE_HWREG(0x40041124)
#define CAN1_MSG1INT_R          EE_HWREG(0x40041140)
#define CAN1_MSG2INT_R          EE_HWREG(0x40041144)
#define CAN1_MSG1VAL_R          EE_HWREG(0x40041160)
#define CAN1_MSG2VAL_R          EE_HWREG(0x40041164)

/* Timer registers (WTIMER2) */
#define WTIMER2_CFG_R           EE_HWREG(0x4004C000)
#define WTIMER2_TAMR_R          EE_HWREG(0x4004C004)
#define WTIMER2_TBMR_R          EE_HWREG(0x4004C008)
#define WTIMER2_CTL_R           EE_HWREG(0x4004C00C)
#define WTIMER2_SYNC_R          EE_HWREG(0x4004C010)
#define WTIMER2_IMR_R           EE_HWREG(0x4004C018)
#define WTIMER2_RIS_R           EE_HWREG(0x4004C01C)
#define WTIMER2_MIS_R           EE_HWREG(0x4004C020)
#define WTIMER2_ICR_R           EE_HWREG(0x4004C024)
#define WTIMER2_TAILR_R         EE_HWREG(0x4004C028)
#define WTIMER2_TBILR_R         EE_HWREG(0x4004C02C)
#define WTIMER2_TAMATCHR_R      EE_HWREG(0x4004C030)
#define WTIMER2_TBMATCHR_R      EE_HWREG(0x4004C034)
#define WTIMER2_TAPR_R          EE_HWREG(0x4004C038)
#define WTIMER2_TBPR_R          EE_HWREG(0x4004C03C)
#define WTIMER2_TAPMR_R         EE_HWREG(0x4004C040)
#define WTIMER2_TBPMR_R         EE_HWREG(0x4004C044)
#define WTIMER2_TAR_R           EE_HWREG(0x4004C048)
#define WTIMER2_TBR_R           EE_HWREG(0x4004C04C)
#define WTIMER2_TAV_R           EE_HWREG(0x4004C050)
#define WTIMER2_TBV_R           EE_HWREG(0x4004C054)
#define WTIMER2_RTCPD_R         EE_HWREG(0x4004C058)
#define WTIMER2_TAPS_R          EE_HWREG(0x4004C05C)
#define WTIMER2_TBPS_R          EE_HWREG(0x4004C060)
#define WTIMER2_TAPV_R          EE_HWREG(0x4004C064)
#define WTIMER2_TBPV_R          EE_HWREG(0x4004C068)
#define WTIMER2_PP_R            EE_HWREG(0x4004CFC0)

/* Timer registers (WTIMER3) */
#define WTIMER3_CFG_R           EE_HWREG(0x4004D000)
#define WTIMER3_TAMR_R          EE_HWREG(0x4004D004)
#define WTIMER3_TBMR_R          EE_HWREG(0x4004D008)
#define WTIMER3_CTL_R           EE_HWREG(0x4004D00C)
#define WTIMER3_SYNC_R          EE_HWREG(0x4004D010)
#define WTIMER3_IMR_R           EE_HWREG(0x4004D018)
#define WTIMER3_RIS_R           EE_HWREG(0x4004D01C)
#define WTIMER3_MIS_R           EE_HWREG(0x4004D020)
#define WTIMER3_ICR_R           EE_HWREG(0x4004D024)
#define WTIMER3_TAILR_R         EE_HWREG(0x4004D028)
#define WTIMER3_TBILR_R         EE_HWREG(0x4004D02C)
#define WTIMER3_TAMATCHR_R      EE_HWREG(0x4004D030)
#define WTIMER3_TBMATCHR_R      EE_HWREG(0x4004D034)
#define WTIMER3_TAPR_R          EE_HWREG(0x4004D038)
#define WTIMER3_TBPR_R          EE_HWREG(0x4004D03C)
#define WTIMER3_TAPMR_R         EE_HWREG(0x4004D040)
#define WTIMER3_TBPMR_R         EE_HWREG(0x4004D044)
#define WTIMER3_TAR_R           EE_HWREG(0x4004D048)
#define WTIMER3_TBR_R           EE_HWREG(0x4004D04C)
#define WTIMER3_TAV_R           EE_HWREG(0x4004D050)
#define WTIMER3_TBV_R           EE_HWREG(0x4004D054)
#define WTIMER3_RTCPD_R         EE_HWREG(0x4004D058)
#define WTIMER3_TAPS_R          EE_HWREG(0x4004D05C)
#define WTIMER3_TBPS_R          EE_HWREG(0x4004D060)
#define WTIMER3_TAPV_R          EE_HWREG(0x4004D064)
#define WTIMER3_TBPV_R          EE_HWREG(0x4004D068)
#define WTIMER3_PP_R            EE_HWREG(0x4004DFC0)

/* Timer registers (WTIMER4) */
#define WTIMER4_CFG_R           EE_HWREG(0x4004E000)
#define WTIMER4_TAMR_R          EE_HWREG(0x4004E004)
#define WTIMER4_TBMR_R          EE_HWREG(0x4004E008)
#define WTIMER4_CTL_R           EE_HWREG(0x4004E00C)
#define WTIMER4_SYNC_R          EE_HWREG(0x4004E010)
#define WTIMER4_IMR_R           EE_HWREG(0x4004E018)
#define WTIMER4_RIS_R           EE_HWREG(0x4004E01C)
#define WTIMER4_MIS_R           EE_HWREG(0x4004E020)
#define WTIMER4_ICR_R           EE_HWREG(0x4004E024)
#define WTIMER4_TAILR_R         EE_HWREG(0x4004E028)
#define WTIMER4_TBILR_R         EE_HWREG(0x4004E02C)
#define WTIMER4_TAMATCHR_R      EE_HWREG(0x4004E030)
#define WTIMER4_TBMATCHR_R      EE_HWREG(0x4004E034)
#define WTIMER4_TAPR_R          EE_HWREG(0x4004E038)
#define WTIMER4_TBPR_R          EE_HWREG(0x4004E03C)
#define WTIMER4_TAPMR_R         EE_HWREG(0x4004E040)
#define WTIMER4_TBPMR_R         EE_HWREG(0x4004E044)
#define WTIMER4_TAR_R           EE_HWREG(0x4004E048)
#define WTIMER4_TBR_R           EE_HWREG(0x4004E04C)
#define WTIMER4_TAV_R           EE_HWREG(0x4004E050)
#define WTIMER4_TBV_R           EE_HWREG(0x4004E054)
#define WTIMER4_RTCPD_R         EE_HWREG(0x4004E058)
#define WTIMER4_TAPS_R          EE_HWREG(0x4004E05C)
#define WTIMER4_TBPS_R          EE_HWREG(0x4004E060)
#define WTIMER4_TAPV_R          EE_HWREG(0x4004E064)
#define WTIMER4_TBPV_R          EE_HWREG(0x4004E068)
#define WTIMER4_PP_R            EE_HWREG(0x4004EFC0)

/* Timer registers (WTIMER5) */
#define WTIMER5_CFG_R           EE_HWREG(0x4004F000)
#define WTIMER5_TAMR_R          EE_HWREG(0x4004F004)
#define WTIMER5_TBMR_R          EE_HWREG(0x4004F008)
#define WTIMER5_CTL_R           EE_HWREG(0x4004F00C)
#define WTIMER5_SYNC_R          EE_HWREG(0x4004F010)
#define WTIMER5_IMR_R           EE_HWREG(0x4004F018)
#define WTIMER5_RIS_R           EE_HWREG(0x4004F01C)
#define WTIMER5_MIS_R           EE_HWREG(0x4004F020)
#define WTIMER5_ICR_R           EE_HWREG(0x4004F024)
#define WTIMER5_TAILR_R         EE_HWREG(0x4004F028)
#define WTIMER5_TBILR_R         EE_HWREG(0x4004F02C)
#define WTIMER5_TAMATCHR_R      EE_HWREG(0x4004F030)
#define WTIMER5_TBMATCHR_R      EE_HWREG(0x4004F034)
#define WTIMER5_TAPR_R          EE_HWREG(0x4004F038)
#define WTIMER5_TBPR_R          EE_HWREG(0x4004F03C)
#define WTIMER5_TAPMR_R         EE_HWREG(0x4004F040)
#define WTIMER5_TBPMR_R         EE_HWREG(0x4004F044)
#define WTIMER5_TAR_R           EE_HWREG(0x4004F048)
#define WTIMER5_TBR_R           EE_HWREG(0x4004F04C)
#define WTIMER5_TAV_R           EE_HWREG(0x4004F050)
#define WTIMER5_TBV_R           EE_HWREG(0x4004F054)
#define WTIMER5_RTCPD_R         EE_HWREG(0x4004F058)
#define WTIMER5_TAPS_R          EE_HWREG(0x4004F05C)
#define WTIMER5_TBPS_R          EE_HWREG(0x4004F060)
#define WTIMER5_TAPV_R          EE_HWREG(0x4004F064)
#define WTIMER5_TBPV_R          EE_HWREG(0x4004F068)
#define WTIMER5_PP_R            EE_HWREG(0x4004FFC0)

/* Univeral Serial Bus registers (USB0) */
#define USB0_FADDR_R            EE_HWREG(0x40050000)
#define USB0_POWER_R            EE_HWREG(0x40050001)
#define USB0_TXIS_R             EE_HWREG(0x40050002)
#define USB0_RXIS_R             EE_HWREG(0x40050004)
#define USB0_TXIE_R             EE_HWREG(0x40050006)
#define USB0_RXIE_R             EE_HWREG(0x40050008)
#define USB0_IS_R               EE_HWREG(0x4005000A)
#define USB0_IE_R               EE_HWREG(0x4005000B)
#define USB0_FRAME_R            EE_HWREG(0x4005000C)
#define USB0_EPIDX_R            EE_HWREG(0x4005000E)
#define USB0_TEST_R             EE_HWREG(0x4005000F)
#define USB0_FIFO0_R            EE_HWREG(0x40050020)
#define USB0_FIFO1_R            EE_HWREG(0x40050024)
#define USB0_FIFO2_R            EE_HWREG(0x40050028)
#define USB0_FIFO3_R            EE_HWREG(0x4005002C)
#define USB0_FIFO4_R            EE_HWREG(0x40050030)
#define USB0_FIFO5_R            EE_HWREG(0x40050034)
#define USB0_FIFO6_R            EE_HWREG(0x40050038)
#define USB0_FIFO7_R            EE_HWREG(0x4005003C)
#define USB0_DEVCTL_R           EE_HWREG(0x40050060)
#define USB0_TXFIFOSZ_R         EE_HWREG(0x40050062)
#define USB0_RXFIFOSZ_R         EE_HWREG(0x40050063)
#define USB0_TXFIFOADD_R        EE_HWREG(0x40050064)
#define USB0_RXFIFOADD_R        EE_HWREG(0x40050066)
#define USB0_CONTIM_R           EE_HWREG(0x4005007A)
#define USB0_VPLEN_R            EE_HWREG(0x4005007B)
#define USB0_FSEOF_R            EE_HWREG(0x4005007D)
#define USB0_LSEOF_R            EE_HWREG(0x4005007E)
#define USB0_TXFUNCADDR0_R      EE_HWREG(0x40050080)
#define USB0_TXHUBADDR0_R       EE_HWREG(0x40050082)
#define USB0_TXHUBPORT0_R       EE_HWREG(0x40050083)
#define USB0_TXFUNCADDR1_R      EE_HWREG(0x40050088)
#define USB0_TXHUBADDR1_R       EE_HWREG(0x4005008A)
#define USB0_TXHUBPORT1_R       EE_HWREG(0x4005008B)
#define USB0_RXFUNCADDR1_R      EE_HWREG(0x4005008C)
#define USB0_RXHUBADDR1_R       EE_HWREG(0x4005008E)
#define USB0_RXHUBPORT1_R       EE_HWREG(0x4005008F)
#define USB0_TXFUNCADDR2_R      EE_HWREG(0x40050090)
#define USB0_TXHUBADDR2_R       EE_HWREG(0x40050092)
#define USB0_TXHUBPORT2_R       EE_HWREG(0x40050093)
#define USB0_RXFUNCADDR2_R      EE_HWREG(0x40050094)
#define USB0_RXHUBADDR2_R       EE_HWREG(0x40050096)
#define USB0_RXHUBPORT2_R       EE_HWREG(0x40050097)
#define USB0_TXFUNCADDR3_R      EE_HWREG(0x40050098)
#define USB0_TXHUBADDR3_R       EE_HWREG(0x4005009A)
#define USB0_TXHUBPORT3_R       EE_HWREG(0x4005009B)
#define USB0_RXFUNCADDR3_R      EE_HWREG(0x4005009C)
#define USB0_RXHUBADDR3_R       EE_HWREG(0x4005009E)
#define USB0_RXHUBPORT3_R       EE_HWREG(0x4005009F)
#define USB0_TXFUNCADDR4_R      EE_HWREG(0x400500A0)
#define USB0_TXHUBADDR4_R       EE_HWREG(0x400500A2)
#define USB0_TXHUBPORT4_R       EE_HWREG(0x400500A3)
#define USB0_RXFUNCADDR4_R      EE_HWREG(0x400500A4)
#define USB0_RXHUBADDR4_R       EE_HWREG(0x400500A6)
#define USB0_RXHUBPORT4_R       EE_HWREG(0x400500A7)
#define USB0_TXFUNCADDR5_R      EE_HWREG(0x400500A8)
#define USB0_TXHUBADDR5_R       EE_HWREG(0x400500AA)
#define USB0_TXHUBPORT5_R       EE_HWREG(0x400500AB)
#define USB0_RXFUNCADDR5_R      EE_HWREG(0x400500AC)
#define USB0_RXHUBADDR5_R       EE_HWREG(0x400500AE)
#define USB0_RXHUBPORT5_R       EE_HWREG(0x400500AF)
#define USB0_TXFUNCADDR6_R      EE_HWREG(0x400500B0)
#define USB0_TXHUBADDR6_R       EE_HWREG(0x400500B2)
#define USB0_TXHUBPORT6_R       EE_HWREG(0x400500B3)
#define USB0_RXFUNCADDR6_R      EE_HWREG(0x400500B4)
#define USB0_RXHUBADDR6_R       EE_HWREG(0x400500B6)
#define USB0_RXHUBPORT6_R       EE_HWREG(0x400500B7)
#define USB0_TXFUNCADDR7_R      EE_HWREG(0x400500B8)
#define USB0_TXHUBADDR7_R       EE_HWREG(0x400500BA)
#define USB0_TXHUBPORT7_R       EE_HWREG(0x400500BB)
#define USB0_RXFUNCADDR7_R      EE_HWREG(0x400500BC)
#define USB0_RXHUBADDR7_R       EE_HWREG(0x400500BE)
#define USB0_RXHUBPORT7_R       EE_HWREG(0x400500BF)
#define USB0_CSRL0_R            EE_HWREG(0x40050102)
#define USB0_CSRH0_R            EE_HWREG(0x40050103)
#define USB0_COUNT0_R           EE_HWREG(0x40050108)
#define USB0_TYPE0_R            EE_HWREG(0x4005010A)
#define USB0_NAKLMT_R           EE_HWREG(0x4005010B)
#define USB0_TXMAXP1_R          EE_HWREG(0x40050110)
#define USB0_TXCSRL1_R          EE_HWREG(0x40050112)
#define USB0_TXCSRH1_R          EE_HWREG(0x40050113)
#define USB0_RXMAXP1_R          EE_HWREG(0x40050114)
#define USB0_RXCSRL1_R          EE_HWREG(0x40050116)
#define USB0_RXCSRH1_R          EE_HWREG(0x40050117)
#define USB0_RXCOUNT1_R         EE_HWREG(0x40050118)
#define USB0_TXTYPE1_R          EE_HWREG(0x4005011A)
#define USB0_TXINTERVAL1_R      EE_HWREG(0x4005011B)
#define USB0_RXTYPE1_R          EE_HWREG(0x4005011C)
#define USB0_RXINTERVAL1_R      EE_HWREG(0x4005011D)
#define USB0_TXMAXP2_R          EE_HWREG(0x40050120)
#define USB0_TXCSRL2_R          EE_HWREG(0x40050122)
#define USB0_TXCSRH2_R          EE_HWREG(0x40050123)
#define USB0_RXMAXP2_R          EE_HWREG(0x40050124)
#define USB0_RXCSRL2_R          EE_HWREG(0x40050126)
#define USB0_RXCSRH2_R          EE_HWREG(0x40050127)
#define USB0_RXCOUNT2_R         EE_HWREG(0x40050128)
#define USB0_TXTYPE2_R          EE_HWREG(0x4005012A)
#define USB0_TXINTERVAL2_R      EE_HWREG(0x4005012B)
#define USB0_RXTYPE2_R          EE_HWREG(0x4005012C)
#define USB0_RXINTERVAL2_R      EE_HWREG(0x4005012D)
#define USB0_TXMAXP3_R          EE_HWREG(0x40050130)
#define USB0_TXCSRL3_R          EE_HWREG(0x40050132)
#define USB0_TXCSRH3_R          EE_HWREG(0x40050133)
#define USB0_RXMAXP3_R          EE_HWREG(0x40050134)
#define USB0_RXCSRL3_R          EE_HWREG(0x40050136)
#define USB0_RXCSRH3_R          EE_HWREG(0x40050137)
#define USB0_RXCOUNT3_R         EE_HWREG(0x40050138)
#define USB0_TXTYPE3_R          EE_HWREG(0x4005013A)
#define USB0_TXINTERVAL3_R      EE_HWREG(0x4005013B)
#define USB0_RXTYPE3_R          EE_HWREG(0x4005013C)
#define USB0_RXINTERVAL3_R      EE_HWREG(0x4005013D)
#define USB0_TXMAXP4_R          EE_HWREG(0x40050140)
#define USB0_TXCSRL4_R          EE_HWREG(0x40050142)
#define USB0_TXCSRH4_R          EE_HWREG(0x40050143)
#define USB0_RXMAXP4_R          EE_HWREG(0x40050144)
#define USB0_RXCSRL4_R          EE_HWREG(0x40050146)
#define USB0_RXCSRH4_R          EE_HWREG(0x40050147)
#define USB0_RXCOUNT4_R         EE_HWREG(0x40050148)
#define USB0_TXTYPE4_R          EE_HWREG(0x4005014A)
#define USB0_TXINTERVAL4_R      EE_HWREG(0x4005014B)
#define USB0_RXTYPE4_R          EE_HWREG(0x4005014C)
#define USB0_RXINTERVAL4_R      EE_HWREG(0x4005014D)
#define USB0_TXMAXP5_R          EE_HWREG(0x40050150)
#define USB0_TXCSRL5_R          EE_HWREG(0x40050152)
#define USB0_TXCSRH5_R          EE_HWREG(0x40050153)
#define USB0_RXMAXP5_R          EE_HWREG(0x40050154)
#define USB0_RXCSRL5_R          EE_HWREG(0x40050156)
#define USB0_RXCSRH5_R          EE_HWREG(0x40050157)
#define USB0_RXCOUNT5_R         EE_HWREG(0x40050158)
#define USB0_TXTYPE5_R          EE_HWREG(0x4005015A)
#define USB0_TXINTERVAL5_R      EE_HWREG(0x4005015B)
#define USB0_RXTYPE5_R          EE_HWREG(0x4005015C)
#define USB0_RXINTERVAL5_R      EE_HWREG(0x4005015D)
#define USB0_TXMAXP6_R          EE_HWREG(0x40050160)
#define USB0_TXCSRL6_R          EE_HWREG(0x40050162)
#define USB0_TXCSRH6_R          EE_HWREG(0x40050163)
#define USB0_RXMAXP6_R          EE_HWREG(0x40050164)
#define USB0_RXCSRL6_R          EE_HWREG(0x40050166)
#define USB0_RXCSRH6_R          EE_HWREG(0x40050167)
#define USB0_RXCOUNT6_R         EE_HWREG(0x40050168)
#define USB0_TXTYPE6_R          EE_HWREG(0x4005016A)
#define USB0_TXINTERVAL6_R      EE_HWREG(0x4005016B)
#define USB0_RXTYPE6_R          EE_HWREG(0x4005016C)
#define USB0_RXINTERVAL6_R      EE_HWREG(0x4005016D)
#define USB0_TXMAXP7_R          EE_HWREG(0x40050170)
#define USB0_TXCSRL7_R          EE_HWREG(0x40050172)
#define USB0_TXCSRH7_R          EE_HWREG(0x40050173)
#define USB0_RXMAXP7_R          EE_HWREG(0x40050174)
#define USB0_RXCSRL7_R          EE_HWREG(0x40050176)
#define USB0_RXCSRH7_R          EE_HWREG(0x40050177)
#define USB0_RXCOUNT7_R         EE_HWREG(0x40050178)
#define USB0_TXTYPE7_R          EE_HWREG(0x4005017A)
#define USB0_TXINTERVAL7_R      EE_HWREG(0x4005017B)
#define USB0_RXTYPE7_R          EE_HWREG(0x4005017C)
#define USB0_RXINTERVAL7_R      EE_HWREG(0x4005017D)
#define USB0_RQPKTCOUNT1_R      EE_HWREG(0x40050304)
#define USB0_RQPKTCOUNT2_R      EE_HWREG(0x40050308)
#define USB0_RQPKTCOUNT3_R      EE_HWREG(0x4005030C)
#define USB0_RQPKTCOUNT4_R      EE_HWREG(0x40050310)
#define USB0_RQPKTCOUNT5_R      EE_HWREG(0x40050314)
#define USB0_RQPKTCOUNT6_R      EE_HWREG(0x40050318)
#define USB0_RQPKTCOUNT7_R      EE_HWREG(0x4005031C)
#define USB0_RXDPKTBUFDIS_R     EE_HWREG(0x40050340)
#define USB0_TXDPKTBUFDIS_R     EE_HWREG(0x40050342)
#define USB0_EPC_R              EE_HWREG(0x40050400)
#define USB0_EPCRIS_R           EE_HWREG(0x40050404)
#define USB0_EPCIM_R            EE_HWREG(0x40050408)
#define USB0_EPCISC_R           EE_HWREG(0x4005040C)
#define USB0_DRRIS_R            EE_HWREG(0x40050410)
#define USB0_DRIM_R             EE_HWREG(0x40050414)
#define USB0_DRISC_R            EE_HWREG(0x40050418)
#define USB0_GPCS_R             EE_HWREG(0x4005041C)
#define USB0_VDC_R              EE_HWREG(0x40050430)
#define USB0_VDCRIS_R           EE_HWREG(0x40050434)
#define USB0_VDCIM_R            EE_HWREG(0x40050438)
#define USB0_VDCISC_R           EE_HWREG(0x4005043C)
#define USB0_IDVRIS_R           EE_HWREG(0x40050444)
#define USB0_IDVIM_R            EE_HWREG(0x40050448)
#define USB0_IDVISC_R           EE_HWREG(0x4005044C)
#define USB0_DMASEL_R           EE_HWREG(0x40050450)
#define USB0_PP_R               EE_HWREG(0x40050FC0)

/* GPIO registers (PORTA AHB) */
#define GPIO_PORTA_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x40058000)
#define GPIO_PORTA_AHB_DATA_R   EE_HWREG(0x400583FC)
#define GPIO_PORTA_AHB_DIR_R    EE_HWREG(0x40058400)
#define GPIO_PORTA_AHB_IS_R     EE_HWREG(0x40058404)
#define GPIO_PORTA_AHB_IBE_R    EE_HWREG(0x40058408)
#define GPIO_PORTA_AHB_IEV_R    EE_HWREG(0x4005840C)
#define GPIO_PORTA_AHB_IM_R     EE_HWREG(0x40058410)
#define GPIO_PORTA_AHB_RIS_R    EE_HWREG(0x40058414)
#define GPIO_PORTA_AHB_MIS_R    EE_HWREG(0x40058418)
#define GPIO_PORTA_AHB_ICR_R    EE_HWREG(0x4005841C)
#define GPIO_PORTA_AHB_AFSEL_R  EE_HWREG(0x40058420)
#define GPIO_PORTA_AHB_DR2R_R   EE_HWREG(0x40058500)
#define GPIO_PORTA_AHB_DR4R_R   EE_HWREG(0x40058504)
#define GPIO_PORTA_AHB_DR8R_R   EE_HWREG(0x40058508)
#define GPIO_PORTA_AHB_ODR_R    EE_HWREG(0x4005850C)
#define GPIO_PORTA_AHB_PUR_R    EE_HWREG(0x40058510)
#define GPIO_PORTA_AHB_PDR_R    EE_HWREG(0x40058514)
#define GPIO_PORTA_AHB_SLR_R    EE_HWREG(0x40058518)
#define GPIO_PORTA_AHB_DEN_R    EE_HWREG(0x4005851C)
#define GPIO_PORTA_AHB_LOCK_R   EE_HWREG(0x40058520)
#define GPIO_PORTA_AHB_CR_R     EE_HWREG(0x40058524)
#define GPIO_PORTA_AHB_AMSEL_R  EE_HWREG(0x40058528)
#define GPIO_PORTA_AHB_PCTL_R   EE_HWREG(0x4005852C)
#define GPIO_PORTA_AHB_ADCCTL_R EE_HWREG(0x40058530)
#define GPIO_PORTA_AHB_DMACTL_R EE_HWREG(0x40058534)
#define GPIO_PORTA_AHB_SI_R     EE_HWREG(0x40058538)

/* GPIO registers (PORTB AHB) */
#define GPIO_PORTB_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x40059000)
#define GPIO_PORTB_AHB_DATA_R   EE_HWREG(0x400593FC)
#define GPIO_PORTB_AHB_DIR_R    EE_HWREG(0x40059400)
#define GPIO_PORTB_AHB_IS_R     EE_HWREG(0x40059404)
#define GPIO_PORTB_AHB_IBE_R    EE_HWREG(0x40059408)
#define GPIO_PORTB_AHB_IEV_R    EE_HWREG(0x4005940C)
#define GPIO_PORTB_AHB_IM_R     EE_HWREG(0x40059410)
#define GPIO_PORTB_AHB_RIS_R    EE_HWREG(0x40059414)
#define GPIO_PORTB_AHB_MIS_R    EE_HWREG(0x40059418)
#define GPIO_PORTB_AHB_ICR_R    EE_HWREG(0x4005941C)
#define GPIO_PORTB_AHB_AFSEL_R  EE_HWREG(0x40059420)
#define GPIO_PORTB_AHB_DR2R_R   EE_HWREG(0x40059500)
#define GPIO_PORTB_AHB_DR4R_R   EE_HWREG(0x40059504)
#define GPIO_PORTB_AHB_DR8R_R   EE_HWREG(0x40059508)
#define GPIO_PORTB_AHB_ODR_R    EE_HWREG(0x4005950C)
#define GPIO_PORTB_AHB_PUR_R    EE_HWREG(0x40059510)
#define GPIO_PORTB_AHB_PDR_R    EE_HWREG(0x40059514)
#define GPIO_PORTB_AHB_SLR_R    EE_HWREG(0x40059518)
#define GPIO_PORTB_AHB_DEN_R    EE_HWREG(0x4005951C)
#define GPIO_PORTB_AHB_LOCK_R   EE_HWREG(0x40059520)
#define GPIO_PORTB_AHB_CR_R     EE_HWREG(0x40059524)
#define GPIO_PORTB_AHB_AMSEL_R  EE_HWREG(0x40059528)
#define GPIO_PORTB_AHB_PCTL_R   EE_HWREG(0x4005952C)
#define GPIO_PORTB_AHB_ADCCTL_R EE_HWREG(0x40059530)
#define GPIO_PORTB_AHB_DMACTL_R EE_HWREG(0x40059534)
#define GPIO_PORTB_AHB_SI_R     EE_HWREG(0x40059538)

/* GPIO registers (PORTC AHB) */
#define GPIO_PORTC_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x4005A000)
#define GPIO_PORTC_AHB_DATA_R   EE_HWREG(0x4005A3FC)
#define GPIO_PORTC_AHB_DIR_R    EE_HWREG(0x4005A400)
#define GPIO_PORTC_AHB_IS_R     EE_HWREG(0x4005A404)
#define GPIO_PORTC_AHB_IBE_R    EE_HWREG(0x4005A408)
#define GPIO_PORTC_AHB_IEV_R    EE_HWREG(0x4005A40C)
#define GPIO_PORTC_AHB_IM_R     EE_HWREG(0x4005A410)
#define GPIO_PORTC_AHB_RIS_R    EE_HWREG(0x4005A414)
#define GPIO_PORTC_AHB_MIS_R    EE_HWREG(0x4005A418)
#define GPIO_PORTC_AHB_ICR_R    EE_HWREG(0x4005A41C)
#define GPIO_PORTC_AHB_AFSEL_R  EE_HWREG(0x4005A420)
#define GPIO_PORTC_AHB_DR2R_R   EE_HWREG(0x4005A500)
#define GPIO_PORTC_AHB_DR4R_R   EE_HWREG(0x4005A504)
#define GPIO_PORTC_AHB_DR8R_R   EE_HWREG(0x4005A508)
#define GPIO_PORTC_AHB_ODR_R    EE_HWREG(0x4005A50C)
#define GPIO_PORTC_AHB_PUR_R    EE_HWREG(0x4005A510)
#define GPIO_PORTC_AHB_PDR_R    EE_HWREG(0x4005A514)
#define GPIO_PORTC_AHB_SLR_R    EE_HWREG(0x4005A518)
#define GPIO_PORTC_AHB_DEN_R    EE_HWREG(0x4005A51C)
#define GPIO_PORTC_AHB_LOCK_R   EE_HWREG(0x4005A520)
#define GPIO_PORTC_AHB_CR_R     EE_HWREG(0x4005A524)
#define GPIO_PORTC_AHB_AMSEL_R  EE_HWREG(0x4005A528)
#define GPIO_PORTC_AHB_PCTL_R   EE_HWREG(0x4005A52C)
#define GPIO_PORTC_AHB_ADCCTL_R EE_HWREG(0x4005A530)
#define GPIO_PORTC_AHB_DMACTL_R EE_HWREG(0x4005A534)
#define GPIO_PORTC_AHB_SI_R     EE_HWREG(0x4005A538)

/* GPIO registers (PORTD AHB) */
#define GPIO_PORTD_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x4005B000)
#define GPIO_PORTD_AHB_DATA_R   EE_HWREG(0x4005B3FC)
#define GPIO_PORTD_AHB_DIR_R    EE_HWREG(0x4005B400)
#define GPIO_PORTD_AHB_IS_R     EE_HWREG(0x4005B404)
#define GPIO_PORTD_AHB_IBE_R    EE_HWREG(0x4005B408)
#define GPIO_PORTD_AHB_IEV_R    EE_HWREG(0x4005B40C)
#define GPIO_PORTD_AHB_IM_R     EE_HWREG(0x4005B410)
#define GPIO_PORTD_AHB_RIS_R    EE_HWREG(0x4005B414)
#define GPIO_PORTD_AHB_MIS_R    EE_HWREG(0x4005B418)
#define GPIO_PORTD_AHB_ICR_R    EE_HWREG(0x4005B41C)
#define GPIO_PORTD_AHB_AFSEL_R  EE_HWREG(0x4005B420)
#define GPIO_PORTD_AHB_DR2R_R   EE_HWREG(0x4005B500)
#define GPIO_PORTD_AHB_DR4R_R   EE_HWREG(0x4005B504)
#define GPIO_PORTD_AHB_DR8R_R   EE_HWREG(0x4005B508)
#define GPIO_PORTD_AHB_ODR_R    EE_HWREG(0x4005B50C)
#define GPIO_PORTD_AHB_PUR_R    EE_HWREG(0x4005B510)
#define GPIO_PORTD_AHB_PDR_R    EE_HWREG(0x4005B514)
#define GPIO_PORTD_AHB_SLR_R    EE_HWREG(0x4005B518)
#define GPIO_PORTD_AHB_DEN_R    EE_HWREG(0x4005B51C)
#define GPIO_PORTD_AHB_LOCK_R   EE_HWREG(0x4005B520)
#define GPIO_PORTD_AHB_CR_R     EE_HWREG(0x4005B524)
#define GPIO_PORTD_AHB_AMSEL_R  EE_HWREG(0x4005B528)
#define GPIO_PORTD_AHB_PCTL_R   EE_HWREG(0x4005B52C)
#define GPIO_PORTD_AHB_ADCCTL_R EE_HWREG(0x4005B530)
#define GPIO_PORTD_AHB_DMACTL_R EE_HWREG(0x4005B534)
#define GPIO_PORTD_AHB_SI_R     EE_HWREG(0x4005B538)

/* GPIO registers (PORTE AHB) */
#define GPIO_PORTE_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x4005C000)
#define GPIO_PORTE_AHB_DATA_R   EE_HWREG(0x4005C3FC)
#define GPIO_PORTE_AHB_DIR_R    EE_HWREG(0x4005C400)
#define GPIO_PORTE_AHB_IS_R     EE_HWREG(0x4005C404)
#define GPIO_PORTE_AHB_IBE_R    EE_HWREG(0x4005C408)
#define GPIO_PORTE_AHB_IEV_R    EE_HWREG(0x4005C40C)
#define GPIO_PORTE_AHB_IM_R     EE_HWREG(0x4005C410)
#define GPIO_PORTE_AHB_RIS_R    EE_HWREG(0x4005C414)
#define GPIO_PORTE_AHB_MIS_R    EE_HWREG(0x4005C418)
#define GPIO_PORTE_AHB_ICR_R    EE_HWREG(0x4005C41C)
#define GPIO_PORTE_AHB_AFSEL_R  EE_HWREG(0x4005C420)
#define GPIO_PORTE_AHB_DR2R_R   EE_HWREG(0x4005C500)
#define GPIO_PORTE_AHB_DR4R_R   EE_HWREG(0x4005C504)
#define GPIO_PORTE_AHB_DR8R_R   EE_HWREG(0x4005C508)
#define GPIO_PORTE_AHB_ODR_R    EE_HWREG(0x4005C50C)
#define GPIO_PORTE_AHB_PUR_R    EE_HWREG(0x4005C510)
#define GPIO_PORTE_AHB_PDR_R    EE_HWREG(0x4005C514)
#define GPIO_PORTE_AHB_SLR_R    EE_HWREG(0x4005C518)
#define GPIO_PORTE_AHB_DEN_R    EE_HWREG(0x4005C51C)
#define GPIO_PORTE_AHB_LOCK_R   EE_HWREG(0x4005C520)
#define GPIO_PORTE_AHB_CR_R     EE_HWREG(0x4005C524)
#define GPIO_PORTE_AHB_AMSEL_R  EE_HWREG(0x4005C528)
#define GPIO_PORTE_AHB_PCTL_R   EE_HWREG(0x4005C52C)
#define GPIO_PORTE_AHB_ADCCTL_R EE_HWREG(0x4005C530)
#define GPIO_PORTE_AHB_DMACTL_R EE_HWREG(0x4005C534)
#define GPIO_PORTE_AHB_SI_R     EE_HWREG(0x4005C538)

/* GPIO registers (PORTF AHB) */
#define GPIO_PORTF_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x4005D000)
#define GPIO_PORTF_AHB_DATA_R   EE_HWREG(0x4005D3FC)
#define GPIO_PORTF_AHB_DIR_R    EE_HWREG(0x4005D400)
#define GPIO_PORTF_AHB_IS_R     EE_HWREG(0x4005D404)
#define GPIO_PORTF_AHB_IBE_R    EE_HWREG(0x4005D408)
#define GPIO_PORTF_AHB_IEV_R    EE_HWREG(0x4005D40C)
#define GPIO_PORTF_AHB_IM_R     EE_HWREG(0x4005D410)
#define GPIO_PORTF_AHB_RIS_R    EE_HWREG(0x4005D414)
#define GPIO_PORTF_AHB_MIS_R    EE_HWREG(0x4005D418)
#define GPIO_PORTF_AHB_ICR_R    EE_HWREG(0x4005D41C)
#define GPIO_PORTF_AHB_AFSEL_R  EE_HWREG(0x4005D420)
#define GPIO_PORTF_AHB_DR2R_R   EE_HWREG(0x4005D500)
#define GPIO_PORTF_AHB_DR4R_R   EE_HWREG(0x4005D504)
#define GPIO_PORTF_AHB_DR8R_R   EE_HWREG(0x4005D508)
#define GPIO_PORTF_AHB_ODR_R    EE_HWREG(0x4005D50C)
#define GPIO_PORTF_AHB_PUR_R    EE_HWREG(0x4005D510)
#define GPIO_PORTF_AHB_PDR_R    EE_HWREG(0x4005D514)
#define GPIO_PORTF_AHB_SLR_R    EE_HWREG(0x4005D518)
#define GPIO_PORTF_AHB_DEN_R    EE_HWREG(0x4005D51C)
#define GPIO_PORTF_AHB_LOCK_R   EE_HWREG(0x4005D520)
#define GPIO_PORTF_AHB_CR_R     EE_HWREG(0x4005D524)
#define GPIO_PORTF_AHB_AMSEL_R  EE_HWREG(0x4005D528)
#define GPIO_PORTF_AHB_PCTL_R   EE_HWREG(0x4005D52C)
#define GPIO_PORTF_AHB_ADCCTL_R EE_HWREG(0x4005D530)
#define GPIO_PORTF_AHB_DMACTL_R EE_HWREG(0x4005D534)
#define GPIO_PORTF_AHB_SI_R     EE_HWREG(0x4005D538)

/* GPIO registers (PORTG AHB) */
#define GPIO_PORTG_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x4005E000)
#define GPIO_PORTG_AHB_DATA_R   EE_HWREG(0x4005E3FC)
#define GPIO_PORTG_AHB_DIR_R    EE_HWREG(0x4005E400)
#define GPIO_PORTG_AHB_IS_R     EE_HWREG(0x4005E404)
#define GPIO_PORTG_AHB_IBE_R    EE_HWREG(0x4005E408)
#define GPIO_PORTG_AHB_IEV_R    EE_HWREG(0x4005E40C)
#define GPIO_PORTG_AHB_IM_R     EE_HWREG(0x4005E410)
#define GPIO_PORTG_AHB_RIS_R    EE_HWREG(0x4005E414)
#define GPIO_PORTG_AHB_MIS_R    EE_HWREG(0x4005E418)
#define GPIO_PORTG_AHB_ICR_R    EE_HWREG(0x4005E41C)
#define GPIO_PORTG_AHB_AFSEL_R  EE_HWREG(0x4005E420)
#define GPIO_PORTG_AHB_DR2R_R   EE_HWREG(0x4005E500)
#define GPIO_PORTG_AHB_DR4R_R   EE_HWREG(0x4005E504)
#define GPIO_PORTG_AHB_DR8R_R   EE_HWREG(0x4005E508)
#define GPIO_PORTG_AHB_ODR_R    EE_HWREG(0x4005E50C)
#define GPIO_PORTG_AHB_PUR_R    EE_HWREG(0x4005E510)
#define GPIO_PORTG_AHB_PDR_R    EE_HWREG(0x4005E514)
#define GPIO_PORTG_AHB_SLR_R    EE_HWREG(0x4005E518)
#define GPIO_PORTG_AHB_DEN_R    EE_HWREG(0x4005E51C)
#define GPIO_PORTG_AHB_LOCK_R   EE_HWREG(0x4005E520)
#define GPIO_PORTG_AHB_CR_R     EE_HWREG(0x4005E524)
#define GPIO_PORTG_AHB_AMSEL_R  EE_HWREG(0x4005E528)
#define GPIO_PORTG_AHB_PCTL_R   EE_HWREG(0x4005E52C)
#define GPIO_PORTG_AHB_ADCCTL_R EE_HWREG(0x4005E530)
#define GPIO_PORTG_AHB_DMACTL_R EE_HWREG(0x4005E534)
#define GPIO_PORTG_AHB_SI_R     EE_HWREG(0x4005E538)

/* GPIO registers (PORTH AHB) */
#define GPIO_PORTH_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x4005F000)
#define GPIO_PORTH_AHB_DATA_R   EE_HWREG(0x4005F3FC)
#define GPIO_PORTH_AHB_DIR_R    EE_HWREG(0x4005F400)
#define GPIO_PORTH_AHB_IS_R     EE_HWREG(0x4005F404)
#define GPIO_PORTH_AHB_IBE_R    EE_HWREG(0x4005F408)
#define GPIO_PORTH_AHB_IEV_R    EE_HWREG(0x4005F40C)
#define GPIO_PORTH_AHB_IM_R     EE_HWREG(0x4005F410)
#define GPIO_PORTH_AHB_RIS_R    EE_HWREG(0x4005F414)
#define GPIO_PORTH_AHB_MIS_R    EE_HWREG(0x4005F418)
#define GPIO_PORTH_AHB_ICR_R    EE_HWREG(0x4005F41C)
#define GPIO_PORTH_AHB_AFSEL_R  EE_HWREG(0x4005F420)
#define GPIO_PORTH_AHB_DR2R_R   EE_HWREG(0x4005F500)
#define GPIO_PORTH_AHB_DR4R_R   EE_HWREG(0x4005F504)
#define GPIO_PORTH_AHB_DR8R_R   EE_HWREG(0x4005F508)
#define GPIO_PORTH_AHB_ODR_R    EE_HWREG(0x4005F50C)
#define GPIO_PORTH_AHB_PUR_R    EE_HWREG(0x4005F510)
#define GPIO_PORTH_AHB_PDR_R    EE_HWREG(0x4005F514)
#define GPIO_PORTH_AHB_SLR_R    EE_HWREG(0x4005F518)
#define GPIO_PORTH_AHB_DEN_R    EE_HWREG(0x4005F51C)
#define GPIO_PORTH_AHB_LOCK_R   EE_HWREG(0x4005F520)
#define GPIO_PORTH_AHB_CR_R     EE_HWREG(0x4005F524)
#define GPIO_PORTH_AHB_AMSEL_R  EE_HWREG(0x4005F528)
#define GPIO_PORTH_AHB_PCTL_R   EE_HWREG(0x4005F52C)
#define GPIO_PORTH_AHB_ADCCTL_R EE_HWREG(0x4005F530)
#define GPIO_PORTH_AHB_DMACTL_R EE_HWREG(0x4005F534)
#define GPIO_PORTH_AHB_SI_R     EE_HWREG(0x4005F538)

/* GPIO registers (PORTJ AHB) */
#define GPIO_PORTJ_AHB_DATA_BITS_R \
                                EE_HWREG_ADDR(0x40060000)
#define GPIO_PORTJ_AHB_DATA_R   EE_HWREG(0x400603FC)
#define GPIO_PORTJ_AHB_DIR_R    EE_HWREG(0x40060400)
#define GPIO_PORTJ_AHB_IS_R     EE_HWREG(0x40060404)
#define GPIO_PORTJ_AHB_IBE_R    EE_HWREG(0x40060408)
#define GPIO_PORTJ_AHB_IEV_R    EE_HWREG(0x4006040C)
#define GPIO_PORTJ_AHB_IM_R     EE_HWREG(0x40060410)
#define GPIO_PORTJ_AHB_RIS_R    EE_HWREG(0x40060414)
#define GPIO_PORTJ_AHB_MIS_R    EE_HWREG(0x40060418)
#define GPIO_PORTJ_AHB_ICR_R    EE_HWREG(0x4006041C)
#define GPIO_PORTJ_AHB_AFSEL_R  EE_HWREG(0x40060420)
#define GPIO_PORTJ_AHB_DR2R_R   EE_HWREG(0x40060500)
#define GPIO_PORTJ_AHB_DR4R_R   EE_HWREG(0x40060504)
#define GPIO_PORTJ_AHB_DR8R_R   EE_HWREG(0x40060508)
#define GPIO_PORTJ_AHB_ODR_R    EE_HWREG(0x4006050C)
#define GPIO_PORTJ_AHB_PUR_R    EE_HWREG(0x40060510)
#define GPIO_PORTJ_AHB_PDR_R    EE_HWREG(0x40060514)
#define GPIO_PORTJ_AHB_SLR_R    EE_HWREG(0x40060518)
#define GPIO_PORTJ_AHB_DEN_R    EE_HWREG(0x4006051C)
#define GPIO_PORTJ_AHB_LOCK_R   EE_HWREG(0x40060520)
#define GPIO_PORTJ_AHB_CR_R     EE_HWREG(0x40060524)
#define GPIO_PORTJ_AHB_AMSEL_R  EE_HWREG(0x40060528)
#define GPIO_PORTJ_AHB_PCTL_R   EE_HWREG(0x4006052C)
#define GPIO_PORTJ_AHB_ADCCTL_R EE_HWREG(0x40060530)
#define GPIO_PORTJ_AHB_DMACTL_R EE_HWREG(0x40060534)
#define GPIO_PORTJ_AHB_SI_R     EE_HWREG(0x40060538)

/* GPIO registers (PORTK) */
#define GPIO_PORTK_DATA_BITS_R  EE_HWREG_ADDR(0x40061000)
#define GPIO_PORTK_DATA_R       EE_HWREG(0x400613FC)
#define GPIO_PORTK_DIR_R        EE_HWREG(0x40061400)
#define GPIO_PORTK_IS_R         EE_HWREG(0x40061404)
#define GPIO_PORTK_IBE_R        EE_HWREG(0x40061408)
#define GPIO_PORTK_IEV_R        EE_HWREG(0x4006140C)
#define GPIO_PORTK_IM_R         EE_HWREG(0x40061410)
#define GPIO_PORTK_RIS_R        EE_HWREG(0x40061414)
#define GPIO_PORTK_MIS_R        EE_HWREG(0x40061418)
#define GPIO_PORTK_ICR_R        EE_HWREG(0x4006141C)
#define GPIO_PORTK_AFSEL_R      EE_HWREG(0x40061420)
#define GPIO_PORTK_DR2R_R       EE_HWREG(0x40061500)
#define GPIO_PORTK_DR4R_R       EE_HWREG(0x40061504)
#define GPIO_PORTK_DR8R_R       EE_HWREG(0x40061508)
#define GPIO_PORTK_ODR_R        EE_HWREG(0x4006150C)
#define GPIO_PORTK_PUR_R        EE_HWREG(0x40061510)
#define GPIO_PORTK_PDR_R        EE_HWREG(0x40061514)
#define GPIO_PORTK_SLR_R        EE_HWREG(0x40061518)
#define GPIO_PORTK_DEN_R        EE_HWREG(0x4006151C)
#define GPIO_PORTK_LOCK_R       EE_HWREG(0x40061520)
#define GPIO_PORTK_CR_R         EE_HWREG(0x40061524)
#define GPIO_PORTK_AMSEL_R      EE_HWREG(0x40061528)
#define GPIO_PORTK_PCTL_R       EE_HWREG(0x4006152C)
#define GPIO_PORTK_ADCCTL_R     EE_HWREG(0x40061530)
#define GPIO_PORTK_DMACTL_R     EE_HWREG(0x40061534)
#define GPIO_PORTK_SI_R         EE_HWREG(0x40061538)

/* GPIO registers (PORTL) */
#define GPIO_PORTL_DATA_BITS_R  EE_HWREG_ADDR(0x40062000)
#define GPIO_PORTL_DATA_R       EE_HWREG(0x400623FC)
#define GPIO_PORTL_DIR_R        EE_HWREG(0x40062400)
#define GPIO_PORTL_IS_R         EE_HWREG(0x40062404)
#define GPIO_PORTL_IBE_R        EE_HWREG(0x40062408)
#define GPIO_PORTL_IEV_R        EE_HWREG(0x4006240C)
#define GPIO_PORTL_IM_R         EE_HWREG(0x40062410)
#define GPIO_PORTL_RIS_R        EE_HWREG(0x40062414)
#define GPIO_PORTL_MIS_R        EE_HWREG(0x40062418)
#define GPIO_PORTL_ICR_R        EE_HWREG(0x4006241C)
#define GPIO_PORTL_AFSEL_R      EE_HWREG(0x40062420)
#define GPIO_PORTL_DR2R_R       EE_HWREG(0x40062500)
#define GPIO_PORTL_DR4R_R       EE_HWREG(0x40062504)
#define GPIO_PORTL_DR8R_R       EE_HWREG(0x40062508)
#define GPIO_PORTL_ODR_R        EE_HWREG(0x4006250C)
#define GPIO_PORTL_PUR_R        EE_HWREG(0x40062510)
#define GPIO_PORTL_PDR_R        EE_HWREG(0x40062514)
#define GPIO_PORTL_SLR_R        EE_HWREG(0x40062518)
#define GPIO_PORTL_DEN_R        EE_HWREG(0x4006251C)
#define GPIO_PORTL_LOCK_R       EE_HWREG(0x40062520)
#define GPIO_PORTL_CR_R         EE_HWREG(0x40062524)
#define GPIO_PORTL_AMSEL_R      EE_HWREG(0x40062528)
#define GPIO_PORTL_PCTL_R       EE_HWREG(0x4006252C)
#define GPIO_PORTL_ADCCTL_R     EE_HWREG(0x40062530)
#define GPIO_PORTL_DMACTL_R     EE_HWREG(0x40062534)
#define GPIO_PORTL_SI_R         EE_HWREG(0x40062538)

/* GPIO registers (PORTM) */
#define GPIO_PORTM_DATA_BITS_R  EE_HWREG_ADDR(0x40063000)
#define GPIO_PORTM_DATA_R       EE_HWREG(0x400633FC)
#define GPIO_PORTM_DIR_R        EE_HWREG(0x40063400)
#define GPIO_PORTM_IS_R         EE_HWREG(0x40063404)
#define GPIO_PORTM_IBE_R        EE_HWREG(0x40063408)
#define GPIO_PORTM_IEV_R        EE_HWREG(0x4006340C)
#define GPIO_PORTM_IM_R         EE_HWREG(0x40063410)
#define GPIO_PORTM_RIS_R        EE_HWREG(0x40063414)
#define GPIO_PORTM_MIS_R        EE_HWREG(0x40063418)
#define GPIO_PORTM_ICR_R        EE_HWREG(0x4006341C)
#define GPIO_PORTM_AFSEL_R      EE_HWREG(0x40063420)
#define GPIO_PORTM_DR2R_R       EE_HWREG(0x40063500)
#define GPIO_PORTM_DR4R_R       EE_HWREG(0x40063504)
#define GPIO_PORTM_DR8R_R       EE_HWREG(0x40063508)
#define GPIO_PORTM_ODR_R        EE_HWREG(0x4006350C)
#define GPIO_PORTM_PUR_R        EE_HWREG(0x40063510)
#define GPIO_PORTM_PDR_R        EE_HWREG(0x40063514)
#define GPIO_PORTM_SLR_R        EE_HWREG(0x40063518)
#define GPIO_PORTM_DEN_R        EE_HWREG(0x4006351C)
#define GPIO_PORTM_LOCK_R       EE_HWREG(0x40063520)
#define GPIO_PORTM_CR_R         EE_HWREG(0x40063524)
#define GPIO_PORTM_AMSEL_R      EE_HWREG(0x40063528)
#define GPIO_PORTM_PCTL_R       EE_HWREG(0x4006352C)
#define GPIO_PORTM_ADCCTL_R     EE_HWREG(0x40063530)
#define GPIO_PORTM_DMACTL_R     EE_HWREG(0x40063534)
#define GPIO_PORTM_SI_R         EE_HWREG(0x40063538)

/* GPIO registers (PORTN) */
#define GPIO_PORTN_DATA_BITS_R  EE_HWREG_ADDR(0x40064000)
#define GPIO_PORTN_DATA_R       EE_HWREG(0x400643FC)
#define GPIO_PORTN_DIR_R        EE_HWREG(0x40064400)
#define GPIO_PORTN_IS_R         EE_HWREG(0x40064404)
#define GPIO_PORTN_IBE_R        EE_HWREG(0x40064408)
#define GPIO_PORTN_IEV_R        EE_HWREG(0x4006440C)
#define GPIO_PORTN_IM_R         EE_HWREG(0x40064410)
#define GPIO_PORTN_RIS_R        EE_HWREG(0x40064414)
#define GPIO_PORTN_MIS_R        EE_HWREG(0x40064418)
#define GPIO_PORTN_ICR_R        EE_HWREG(0x4006441C)
#define GPIO_PORTN_AFSEL_R      EE_HWREG(0x40064420)
#define GPIO_PORTN_DR2R_R       EE_HWREG(0x40064500)
#define GPIO_PORTN_DR4R_R       EE_HWREG(0x40064504)
#define GPIO_PORTN_DR8R_R       EE_HWREG(0x40064508)
#define GPIO_PORTN_ODR_R        EE_HWREG(0x4006450C)
#define GPIO_PORTN_PUR_R        EE_HWREG(0x40064510)
#define GPIO_PORTN_PDR_R        EE_HWREG(0x40064514)
#define GPIO_PORTN_SLR_R        EE_HWREG(0x40064518)
#define GPIO_PORTN_DEN_R        EE_HWREG(0x4006451C)
#define GPIO_PORTN_LOCK_R       EE_HWREG(0x40064520)
#define GPIO_PORTN_CR_R         EE_HWREG(0x40064524)
#define GPIO_PORTN_AMSEL_R      EE_HWREG(0x40064528)
#define GPIO_PORTN_PCTL_R       EE_HWREG(0x4006452C)
#define GPIO_PORTN_ADCCTL_R     EE_HWREG(0x40064530)
#define GPIO_PORTN_DMACTL_R     EE_HWREG(0x40064534)
#define GPIO_PORTN_SI_R         EE_HWREG(0x40064538)

/* GPIO registers (PORTP) */
#define GPIO_PORTP_DATA_BITS_R  EE_HWREG_ADDR(0x40065000)
#define GPIO_PORTP_DATA_R       EE_HWREG(0x400653FC)
#define GPIO_PORTP_DIR_R        EE_HWREG(0x40065400)
#define GPIO_PORTP_IS_R         EE_HWREG(0x40065404)
#define GPIO_PORTP_IBE_R        EE_HWREG(0x40065408)
#define GPIO_PORTP_IEV_R        EE_HWREG(0x4006540C)
#define GPIO_PORTP_IM_R         EE_HWREG(0x40065410)
#define GPIO_PORTP_RIS_R        EE_HWREG(0x40065414)
#define GPIO_PORTP_MIS_R        EE_HWREG(0x40065418)
#define GPIO_PORTP_ICR_R        EE_HWREG(0x4006541C)
#define GPIO_PORTP_AFSEL_R      EE_HWREG(0x40065420)
#define GPIO_PORTP_DR2R_R       EE_HWREG(0x40065500)
#define GPIO_PORTP_DR4R_R       EE_HWREG(0x40065504)
#define GPIO_PORTP_DR8R_R       EE_HWREG(0x40065508)
#define GPIO_PORTP_ODR_R        EE_HWREG(0x4006550C)
#define GPIO_PORTP_PUR_R        EE_HWREG(0x40065510)
#define GPIO_PORTP_PDR_R        EE_HWREG(0x40065514)
#define GPIO_PORTP_SLR_R        EE_HWREG(0x40065518)
#define GPIO_PORTP_DEN_R        EE_HWREG(0x4006551C)
#define GPIO_PORTP_LOCK_R       EE_HWREG(0x40065520)
#define GPIO_PORTP_CR_R         EE_HWREG(0x40065524)
#define GPIO_PORTP_AMSEL_R      EE_HWREG(0x40065528)
#define GPIO_PORTP_PCTL_R       EE_HWREG(0x4006552C)
#define GPIO_PORTP_ADCCTL_R     EE_HWREG(0x40065530)
#define GPIO_PORTP_DMACTL_R     EE_HWREG(0x40065534)
#define GPIO_PORTP_SI_R         EE_HWREG(0x40065538)

/* I2C registers (I2C4 MASTER) */
#define I2C4_MASTER_MSA_R       EE_HWREG(0x400C0000)
#define I2C4_MASTER_MCS_R       EE_HWREG(0x400C0004)
#define I2C4_MASTER_MDR_R       EE_HWREG(0x400C0008)
#define I2C4_MASTER_MTPR_R      EE_HWREG(0x400C000C)
#define I2C4_MASTER_MIMR_R      EE_HWREG(0x400C0010)
#define I2C4_MASTER_MRIS_R      EE_HWREG(0x400C0014)
#define I2C4_MASTER_MMIS_R      EE_HWREG(0x400C0018)
#define I2C4_MASTER_MICR_R      EE_HWREG(0x400C001C)
#define I2C4_MASTER_MCR_R       EE_HWREG(0x400C0020)
#define I2C4_MASTER_MCLKOCNT_R  EE_HWREG(0x400C0024)
#define I2C4_MASTER_MBMON_R     EE_HWREG(0x400C002C)

/* I2C registers (I2C4 SLAVE) */
#define I2C4_SLAVE_SOAR_R       EE_HWREG(0x400C0800)
#define I2C4_SLAVE_SCSR_R       EE_HWREG(0x400C0804)
#define I2C4_SLAVE_SDR_R        EE_HWREG(0x400C0808)
#define I2C4_SLAVE_SIMR_R       EE_HWREG(0x400C080C)
#define I2C4_SLAVE_SRIS_R       EE_HWREG(0x400C0810)
#define I2C4_SLAVE_SMIS_R       EE_HWREG(0x400C0814)
#define I2C4_SLAVE_SICR_R       EE_HWREG(0x400C0818)
#define I2C4_SLAVE_SOAR2_R      EE_HWREG(0x400C081C)
#define I2C4_SLAVE_SACKCTL_R    EE_HWREG(0x400C0820)

/* I2C registers (I2C5 MASTER) */
#define I2C5_MASTER_MSA_R       EE_HWREG(0x400C1000)
#define I2C5_MASTER_MCS_R       EE_HWREG(0x400C1004)
#define I2C5_MASTER_MDR_R       EE_HWREG(0x400C1008)
#define I2C5_MASTER_MTPR_R      EE_HWREG(0x400C100C)
#define I2C5_MASTER_MIMR_R      EE_HWREG(0x400C1010)
#define I2C5_MASTER_MRIS_R      EE_HWREG(0x400C1014)
#define I2C5_MASTER_MMIS_R      EE_HWREG(0x400C1018)
#define I2C5_MASTER_MICR_R      EE_HWREG(0x400C101C)
#define I2C5_MASTER_MCR_R       EE_HWREG(0x400C1020)
#define I2C5_MASTER_MCLKOCNT_R  EE_HWREG(0x400C1024)
#define I2C5_MASTER_MBMON_R     EE_HWREG(0x400C102C)

/* I2C registers (I2C5 SLAVE) */
#define I2C5_SLAVE_SOAR_R       EE_HWREG(0x400C1800)
#define I2C5_SLAVE_SCSR_R       EE_HWREG(0x400C1804)
#define I2C5_SLAVE_SDR_R        EE_HWREG(0x400C1808)
#define I2C5_SLAVE_SIMR_R       EE_HWREG(0x400C180C)
#define I2C5_SLAVE_SRIS_R       EE_HWREG(0x400C1810)
#define I2C5_SLAVE_SMIS_R       EE_HWREG(0x400C1814)
#define I2C5_SLAVE_SICR_R       EE_HWREG(0x400C1818)
#define I2C5_SLAVE_SOAR2_R      EE_HWREG(0x400C181C)
#define I2C5_SLAVE_SACKCTL_R    EE_HWREG(0x400C1820)

/* System Exception Module registers (SYSEXC) */
#define SYSEXC_RIS_R            EE_HWREG(0x400F9000)
#define SYSEXC_IM_R             EE_HWREG(0x400F9004)
#define SYSEXC_MIS_R            EE_HWREG(0x400F9008)
#define SYSEXC_IC_R             EE_HWREG(0x400F900C)

/* Hibernation module registers (HIB) */
#define HIB_RTCC_R              EE_HWREG(0x400FC000)
#define HIB_RTCM0_R             EE_HWREG(0x400FC004)
#define HIB_RTCLD_R             EE_HWREG(0x400FC00C)
#define HIB_CTL_R               EE_HWREG(0x400FC010)
#define HIB_IM_R                EE_HWREG(0x400FC014)
#define HIB_RIS_R               EE_HWREG(0x400FC018)
#define HIB_MIS_R               EE_HWREG(0x400FC01C)
#define HIB_IC_R                EE_HWREG(0x400FC020)
#define HIB_RTCT_R              EE_HWREG(0x400FC024)
#define HIB_RTCSS_R             EE_HWREG(0x400FC028)
#define HIB_DATA_R              EE_HWREG(0x400FC030)

/* FLASH registers (FLASH CTRL) */
#define FLASH_FMA_R             EE_HWREG(0x400FD000)
#define FLASH_FMD_R             EE_HWREG(0x400FD004)
#define FLASH_FMC_R             EE_HWREG(0x400FD008)
#define FLASH_FCRIS_R           EE_HWREG(0x400FD00C)
#define FLASH_FCIM_R            EE_HWREG(0x400FD010)
#define FLASH_FCMISC_R          EE_HWREG(0x400FD014)
#define FLASH_FMC2_R            EE_HWREG(0x400FD020)
#define FLASH_FWBVAL_R          EE_HWREG(0x400FD030)
#define FLASH_FWBN_R            EE_HWREG(0x400FD100)
#define FLASH_FSIZE_R           EE_HWREG(0x400FDFC0)
#define FLASH_SSIZE_R           EE_HWREG(0x400FDFC4)
#define FLASH_ROMSWMAP_R        EE_HWREG(0x400FDFCC)
#define FLASH_RMCTL_R           EE_HWREG(0x400FE0F0)
#define FLASH_BOOTCFG_R         EE_HWREG(0x400FE1D0)
#define FLASH_USERREG0_R        EE_HWREG(0x400FE1E0)
#define FLASH_USERREG1_R        EE_HWREG(0x400FE1E4)
#define FLASH_USERREG2_R        EE_HWREG(0x400FE1E8)
#define FLASH_USERREG3_R        EE_HWREG(0x400FE1EC)
#define FLASH_FMPRE0_R          EE_HWREG(0x400FE200)
#define FLASH_FMPRE1_R          EE_HWREG(0x400FE204)
#define FLASH_FMPRE2_R          EE_HWREG(0x400FE208)
#define FLASH_FMPRE3_R          EE_HWREG(0x400FE20C)
#define FLASH_FMPPE0_R          EE_HWREG(0x400FE400)
#define FLASH_FMPPE1_R          EE_HWREG(0x400FE404)
#define FLASH_FMPPE2_R          EE_HWREG(0x400FE408)
#define FLASH_FMPPE3_R          EE_HWREG(0x400FE40C)

/* System Control registers (SYSCTL) */
#define SYSCTL_DID0_R           EE_HWREG(0x400FE000)
#define SYSCTL_DID1_R           EE_HWREG(0x400FE004)
#define SYSCTL_DC0_R            EE_HWREG(0x400FE008)
#define SYSCTL_DC1_R            EE_HWREG(0x400FE010)
#define SYSCTL_DC2_R            EE_HWREG(0x400FE014)
#define SYSCTL_DC3_R            EE_HWREG(0x400FE018)
#define SYSCTL_DC4_R            EE_HWREG(0x400FE01C)
#define SYSCTL_DC5_R            EE_HWREG(0x400FE020)
#define SYSCTL_DC6_R            EE_HWREG(0x400FE024)
#define SYSCTL_DC7_R            EE_HWREG(0x400FE028)
#define SYSCTL_DC8_R            EE_HWREG(0x400FE02C)
#define SYSCTL_PBORCTL_R        EE_HWREG(0x400FE030)
#define SYSCTL_SRCR0_R          EE_HWREG(0x400FE040)
#define SYSCTL_SRCR1_R          EE_HWREG(0x400FE044)
#define SYSCTL_SRCR2_R          EE_HWREG(0x400FE048)
#define SYSCTL_RIS_R            EE_HWREG(0x400FE050)
#define SYSCTL_IMC_R            EE_HWREG(0x400FE054)
#define SYSCTL_MISC_R           EE_HWREG(0x400FE058)
#define SYSCTL_RESC_R           EE_HWREG(0x400FE05C)
#define SYSCTL_RCC_R            EE_HWREG(0x400FE060)
#define SYSCTL_GPIOHBCTL_R      EE_HWREG(0x400FE06C)
#define SYSCTL_RCC2_R           EE_HWREG(0x400FE070)
#define SYSCTL_MOSCCTL_R        EE_HWREG(0x400FE07C)
#define SYSCTL_RCGC0_R          EE_HWREG(0x400FE100)
#define SYSCTL_RCGC1_R          EE_HWREG(0x400FE104)
#define SYSCTL_RCGC2_R          EE_HWREG(0x400FE108)
#define SYSCTL_SCGC0_R          EE_HWREG(0x400FE110)
#define SYSCTL_SCGC1_R          EE_HWREG(0x400FE114)
#define SYSCTL_SCGC2_R          EE_HWREG(0x400FE118)
#define SYSCTL_DCGC0_R          EE_HWREG(0x400FE120)
#define SYSCTL_DCGC1_R          EE_HWREG(0x400FE124)
#define SYSCTL_DCGC2_R          EE_HWREG(0x400FE128)
#define SYSCTL_DSLPCLKCFG_R     EE_HWREG(0x400FE144)
#define SYSCTL_SYSPROP_R        EE_HWREG(0x400FE14C)
#define SYSCTL_PIOSCCAL_R       EE_HWREG(0x400FE150)
#define SYSCTL_PIOSCSTAT_R      EE_HWREG(0x400FE154)
#define SYSCTL_PLLFREQ0_R       EE_HWREG(0x400FE160)
#define SYSCTL_PLLFREQ1_R       EE_HWREG(0x400FE164)
#define SYSCTL_PLLSTAT_R        EE_HWREG(0x400FE168)
#define SYSCTL_DC9_R            EE_HWREG(0x400FE190)
#define SYSCTL_NVMSTAT_R        EE_HWREG(0x400FE1A0)
#define SYSCTL_PPWD_R           EE_HWREG(0x400FE300)
#define SYSCTL_PPTIMER_R        EE_HWREG(0x400FE304)
#define SYSCTL_PPGPIO_R         EE_HWREG(0x400FE308)
#define SYSCTL_PPDMA_R          EE_HWREG(0x400FE30C)
#define SYSCTL_PPHIB_R          EE_HWREG(0x400FE314)
#define SYSCTL_PPUART_R         EE_HWREG(0x400FE318)
#define SYSCTL_PPSSI_R          EE_HWREG(0x400FE31C)
#define SYSCTL_PPI2C_R          EE_HWREG(0x400FE320)
#define SYSCTL_PPUSB_R          EE_HWREG(0x400FE328)
#define SYSCTL_PPCAN_R          EE_HWREG(0x400FE334)
#define SYSCTL_PPADC_R          EE_HWREG(0x400FE338)
#define SYSCTL_PPACMP_R         EE_HWREG(0x400FE33C)
#define SYSCTL_PPPWM_R          EE_HWREG(0x400FE340)
#define SYSCTL_PPQEI_R          EE_HWREG(0x400FE344)
#define SYSCTL_PPEEPROM_R       EE_HWREG(0x400FE358)
#define SYSCTL_PPWTIMER_R       EE_HWREG(0x400FE35C)
#define SYSCTL_SRWD_R           EE_HWREG(0x400FE500)
#define SYSCTL_SRTIMER_R        EE_HWREG(0x400FE504)
#define SYSCTL_SRGPIO_R         EE_HWREG(0x400FE508)
#define SYSCTL_SRDMA_R          EE_HWREG(0x400FE50C)
#define SYSCTL_SRHIB_R          EE_HWREG(0x400FE514)
#define SYSCTL_SRUART_R         EE_HWREG(0x400FE518)
#define SYSCTL_SRSSI_R          EE_HWREG(0x400FE51C)
#define SYSCTL_SRI2C_R          EE_HWREG(0x400FE520)
#define SYSCTL_SRUSB_R          EE_HWREG(0x400FE528)
#define SYSCTL_SRCAN_R          EE_HWREG(0x400FE534)
#define SYSCTL_SRADC_R          EE_HWREG(0x400FE538)
#define SYSCTL_SRACMP_R         EE_HWREG(0x400FE53C)
#define SYSCTL_SRPWM_R          EE_HWREG(0x400FE540)
#define SYSCTL_SRQEI_R          EE_HWREG(0x400FE544)
#define SYSCTL_SREEPROM_R       EE_HWREG(0x400FE558)
#define SYSCTL_SRWTIMER_R       EE_HWREG(0x400FE55C)
#define SYSCTL_RCGCWD_R         EE_HWREG(0x400FE600)
#define SYSCTL_RCGCTIMER_R      EE_HWREG(0x400FE604)
#define SYSCTL_RCGCGPIO_R       EE_HWREG(0x400FE608)
#define SYSCTL_RCGCDMA_R        EE_HWREG(0x400FE60C)
#define SYSCTL_RCGCHIB_R        EE_HWREG(0x400FE614)
#define SYSCTL_RCGCUART_R       EE_HWREG(0x400FE618)
#define SYSCTL_RCGCSSI_R        EE_HWREG(0x400FE61C)
#define SYSCTL_RCGCI2C_R        EE_HWREG(0x400FE620)
#define SYSCTL_RCGCUSB_R        EE_HWREG(0x400FE628)
#define SYSCTL_RCGCCAN_R        EE_HWREG(0x400FE634)
#define SYSCTL_RCGCADC_R        EE_HWREG(0x400FE638)
#define SYSCTL_RCGCACMP_R       EE_HWREG(0x400FE63C)
#define SYSCTL_RCGCPWM_R        EE_HWREG(0x400FE640)
#define SYSCTL_RCGCQEI_R        EE_HWREG(0x400FE644)
#define SYSCTL_RCGCEEPROM_R     EE_HWREG(0x400FE658)
#define SYSCTL_RCGCWTIMER_R     EE_HWREG(0x400FE65C)
#define SYSCTL_SCGCWD_R         EE_HWREG(0x400FE700)
#define SYSCTL_SCGCTIMER_R      EE_HWREG(0x400FE704)
#define SYSCTL_SCGCGPIO_R       EE_HWREG(0x400FE708)
#define SYSCTL_SCGCDMA_R        EE_HWREG(0x400FE70C)
#define SYSCTL_SCGCHIB_R        EE_HWREG(0x400FE714)
#define SYSCTL_SCGCUART_R       EE_HWREG(0x400FE718)
#define SYSCTL_SCGCSSI_R        EE_HWREG(0x400FE71C)
#define SYSCTL_SCGCI2C_R        EE_HWREG(0x400FE720)
#define SYSCTL_SCGCUSB_R        EE_HWREG(0x400FE728)
#define SYSCTL_SCGCCAN_R        EE_HWREG(0x400FE734)
#define SYSCTL_SCGCADC_R        EE_HWREG(0x400FE738)
#define SYSCTL_SCGCACMP_R       EE_HWREG(0x400FE73C)
#define SYSCTL_SCGCPWM_R        EE_HWREG(0x400FE740)
#define SYSCTL_SCGCQEI_R        EE_HWREG(0x400FE744)
#define SYSCTL_SCGCEEPROM_R     EE_HWREG(0x400FE758)
#define SYSCTL_SCGCWTIMER_R     EE_HWREG(0x400FE75C)
#define SYSCTL_DCGCWD_R         EE_HWREG(0x400FE800)
#define SYSCTL_DCGCTIMER_R      EE_HWREG(0x400FE804)
#define SYSCTL_DCGCGPIO_R       EE_HWREG(0x400FE808)
#define SYSCTL_DCGCDMA_R        EE_HWREG(0x400FE80C)
#define SYSCTL_DCGCHIB_R        EE_HWREG(0x400FE814)
#define SYSCTL_DCGCUART_R       EE_HWREG(0x400FE818)
#define SYSCTL_DCGCSSI_R        EE_HWREG(0x400FE81C)
#define SYSCTL_DCGCI2C_R        EE_HWREG(0x400FE820)
#define SYSCTL_DCGCUSB_R        EE_HWREG(0x400FE828)
#define SYSCTL_DCGCCAN_R        EE_HWREG(0x400FE834)
#define SYSCTL_DCGCADC_R        EE_HWREG(0x400FE838)
#define SYSCTL_DCGCACMP_R       EE_HWREG(0x400FE83C)
#define SYSCTL_DCGCPWM_R        EE_HWREG(0x400FE840)
#define SYSCTL_DCGCQEI_R        EE_HWREG(0x400FE844)
#define SYSCTL_DCGCEEPROM_R     EE_HWREG(0x400FE858)
#define SYSCTL_DCGCWTIMER_R     EE_HWREG(0x400FE85C)
#define SYSCTL_PCWD_R           EE_HWREG(0x400FE900)
#define SYSCTL_PCTIMER_R        EE_HWREG(0x400FE904)
#define SYSCTL_PCGPIO_R         EE_HWREG(0x400FE908)
#define SYSCTL_PCDMA_R          EE_HWREG(0x400FE90C)
#define SYSCTL_PCHIB_R          EE_HWREG(0x400FE914)
#define SYSCTL_PCUART_R         EE_HWREG(0x400FE918)
#define SYSCTL_PCSSI_R          EE_HWREG(0x400FE91C)
#define SYSCTL_PCI2C_R          EE_HWREG(0x400FE920)
#define SYSCTL_PCUSB_R          EE_HWREG(0x400FE928)
#define SYSCTL_PCCAN_R          EE_HWREG(0x400FE934)
#define SYSCTL_PCADC_R          EE_HWREG(0x400FE938)
#define SYSCTL_PCACMP_R         EE_HWREG(0x400FE93C)
#define SYSCTL_PCPWM_R          EE_HWREG(0x400FE940)
#define SYSCTL_PCQEI_R          EE_HWREG(0x400FE944)
#define SYSCTL_PCEEPROM_R       EE_HWREG(0x400FE958)
#define SYSCTL_PCWTIMER_R       EE_HWREG(0x400FE95C)
#define SYSCTL_PRWD_R           EE_HWREG(0x400FEA00)
#define SYSCTL_PRTIMER_R        EE_HWREG(0x400FEA04)
#define SYSCTL_PRGPIO_R         EE_HWREG(0x400FEA08)
#define SYSCTL_PRDMA_R          EE_HWREG(0x400FEA0C)
#define SYSCTL_PRHIB_R          EE_HWREG(0x400FEA14)
#define SYSCTL_PRUART_R         EE_HWREG(0x400FEA18)
#define SYSCTL_PRSSI_R          EE_HWREG(0x400FEA1C)
#define SYSCTL_PRI2C_R          EE_HWREG(0x400FEA20)
#define SYSCTL_PRUSB_R          EE_HWREG(0x400FEA28)
#define SYSCTL_PRCAN_R          EE_HWREG(0x400FEA34)
#define SYSCTL_PRADC_R          EE_HWREG(0x400FEA38)
#define SYSCTL_PRACMP_R         EE_HWREG(0x400FEA3C)
#define SYSCTL_PRPWM_R          EE_HWREG(0x400FEA40)
#define SYSCTL_PRQEI_R          EE_HWREG(0x400FEA44)
#define SYSCTL_PREEPROM_R       EE_HWREG(0x400FEA58)
#define SYSCTL_PRWTIMER_R       EE_HWREG(0x400FEA5C)

/* Micro Direct Memory Access registers (UDMA) */
#define UDMA_STAT_R             EE_HWREG(0x400FF000)
#define UDMA_CFG_R              EE_HWREG(0x400FF004)
#define UDMA_CTLBASE_R          EE_HWREG(0x400FF008)
#define UDMA_ALTBASE_R          EE_HWREG(0x400FF00C)
#define UDMA_WAITSTAT_R         EE_HWREG(0x400FF010)
#define UDMA_SWREQ_R            EE_HWREG(0x400FF014)
#define UDMA_USEBURSTSET_R      EE_HWREG(0x400FF018)
#define UDMA_USEBURSTCLR_R      EE_HWREG(0x400FF01C)
#define UDMA_REQMASKSET_R       EE_HWREG(0x400FF020)
#define UDMA_REQMASKCLR_R       EE_HWREG(0x400FF024)
#define UDMA_ENASET_R           EE_HWREG(0x400FF028)
#define UDMA_ENACLR_R           EE_HWREG(0x400FF02C)
#define UDMA_ALTSET_R           EE_HWREG(0x400FF030)
#define UDMA_ALTCLR_R           EE_HWREG(0x400FF034)
#define UDMA_PRIOSET_R          EE_HWREG(0x400FF038)
#define UDMA_PRIOCLR_R          EE_HWREG(0x400FF03C)
#define UDMA_ERRCLR_R           EE_HWREG(0x400FF04C)
#define UDMA_CHASGN_R           EE_HWREG(0x400FF500)
#define UDMA_CHIS_R             EE_HWREG(0x400FF504)
#define UDMA_CHMAP0_R           EE_HWREG(0x400FF510)
#define UDMA_CHMAP1_R           EE_HWREG(0x400FF514)
#define UDMA_CHMAP2_R           EE_HWREG(0x400FF518)
#define UDMA_CHMAP3_R           EE_HWREG(0x400FF51C)
...
#endif	/* __INCLUDE_STELLARIS_LM4F232XXXX_MCUREGS_H__ */
