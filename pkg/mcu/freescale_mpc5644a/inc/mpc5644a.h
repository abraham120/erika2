/**************************************************************************/
/* FILE NAME: MPC5644A.h                     COPYRIGHT (c) Freescale 2009 */
        ...
        union {
            ...
            struct {
	            ...
	            vuint32_t MSTR7:3;    	/* Master 7 Priority - Reserved */
                  ...
                  vuint32_t:1;
                vuint32_t MSTR5:3;    	/* Master 5 Priority - FlexRay */
                  vuint32_t:1;
...
/****************************************************************************/
    struct INTC_tag {
        ...
        int32_t INTC_reserverd_0004[1];		/* 0x0004 - 0x0007 */
        ...
        int32_t INTC_reserverd_0014;       /* 0x0014 - 0x00017 */
        ...
        int32_t INTC_reserverd_001C;       /* 0x001C - 0x001F */
        ...
        int32_t INTC_reserverd_0028[6];		/* 0x0028 - 0x003F */
...
/****************************************************************************/
    struct SIU_tag {
		...
		int32_t SIU_reserverd_0008;		/* 0x0008 - 0x000B */
        ...
        union {
            vuint32_t R;
            struct {
                vuint32_t NMIFE:1;      /* NMI Falling-Edge Event Enable x */
                vuint32_t Reserverd:15; /*  */
        ...
        int32_t SIU_reserverd_0034[3];		/* 0x0034 - 0x003F */
        ...
        int32_t SIU_reserverd_0374[112];   	/* 0x0374 - 0x05FF */
        ...
        int32_t SIU_reserverd_0910[4];		/* 0x0910 - 0x091F */
        ...
        int32_t SIU_reserverd_0928[22];		/* 0x0928 - 0x097F */
        ...
        int32_t SIU_reserverd_0998[2];		/* 0x0998 - 0x099F */
...
/****************************************************************************/
    struct ECSM_tag {
        ...
        uint32_t ecsm_reserved0048[2];     /* 0x0048 - 0x004C*/
...
/****************************************************************************/
    struct EMIOS_tag {
        ...
        int32_t EMIOS_reserverd_0010[4];    /* 0x0010 - 0x001F */
...
/****************************************************************************/
    struct EQADC_tag {
        ...
        } CFTCR[3];             /* CFIFO Transfer Counter Registers */
...
/****************************************************************************/
    struct DECFIL_tag {
        ...
        uint32_t decfil_reserved0008[2];	/* 0x0008 - 0x000F */
        ...
        /* 0x0E0 */
        uint32_t decfil_reserved00E0;

        /* 0x0E4 */
        uint32_t decfil_reserved00E4;

        /* 0x0E8 */
        uint32_t decfil_reserved00E8;

        /* 0x0EC */
        uint32_t decfil_reserved00EC;
...
/* wakeup status */
    ...
    typedef struct FR_tag {
        ...
        volatile M_CR_t MCR;     /*module configuration register *//*2  */
...
#define PIT       (*( struct PIT_tag *)        0xC3FF0000)
...
#define DECFIL_B   (*( struct DECFIL_tag *)      0xFFF8C000)
...
#define ESCI_C    (*( struct ESCI_tag *)       0xFFFB8000)
