...
{
    unsigned int SEL0:1;                    /**< \brief [0:0] Pin Controller Select for Pin x (rw) */
    unsigned int SEL1:1;                    /**< \brief [1:1] Pin Controller Select for Pin x (rw) */
    unsigned int SEL2:1;                    /**< \brief [2:2] Pin Controller Select for Pin x (rw) */
    unsigned int SEL3:1;                    /**< \brief [3:3] Pin Controller Select for Pin x (rw) */
    unsigned int SEL4:1;                    /**< \brief [4:4] Pin Controller Select for Pin x (rw) */
    unsigned int SEL5:1;                    /**< \brief [5:5] Pin Controller Select for Pin x (rw) */
    unsigned int SEL6:1;                    /**< \brief [6:6] Pin Controller Select for Pin x (rw) */
    unsigned int SEL7:1;                    /**< \brief [7:7] Pin Controller Select for Pin x (rw) */
    unsigned int reserved_8:2;              /**< \brief \internal Reserved */
    unsigned int SEL10:1;                   /**< \brief [10:10] Pin Controller Select for Pin x (rw) */
    unsigned int SEL11:1;                   /**< \brief [11:11] Pin Controller Select for Pin x (rw) */
...
{
    unsigned int PDIS0:1;                   /**< \brief [0:0] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS1:1;                   /**< \brief [1:1] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS2:1;                   /**< \brief [2:2] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS3:1;                   /**< \brief [3:3] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS4:1;                   /**< \brief [4:4] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS5:1;                   /**< \brief [5:5] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS6:1;                   /**< \brief [6:6] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS7:1;                   /**< \brief [7:7] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS8:1;                   /**< \brief [8:8] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS9:1;                   /**< \brief [9:9] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS10:1;                  /**< \brief [10:10] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS11:1;                  /**< \brief [11:11] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS12:1;                  /**< \brief [12:12] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS13:1;                  /**< \brief [13:13] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS14:1;                  /**< \brief [14:14] Pin Function Decision Control for Pin x (rw) */
    unsigned int PDIS15:1;                  /**< \brief [15:15] Pin Function Decision Control for Pin x (rw) */
    unsigned int reserved_16:16;            /**< \brief \internal Reserved */
} Ifx_P_PDISC_Bits;
...
/** \\brief  Port LVDS Pad Control Register 1
 * Port LVDS Pad Control Register 1
 */
typedef union
{
    /** \brief Unsigned access */
    ...
    /** \brief Signed access */
    signed int I;
    /** \brief Bitfield access: Port LVDS Pad Control Register 1 */
