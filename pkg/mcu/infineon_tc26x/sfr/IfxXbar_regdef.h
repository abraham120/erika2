...
typedef struct _Ifx_XBAR_IDINTEN_Bits
{
    ...
    unsigned int ENMCI4:1;                  /**< \brief [20:20] Enable ID Error from MCIn (rw) */
    unsigned int ENMCI5:1;                  /**< \brief [21:21] Enable ID Error from MCIn (rw) */
    unsigned int reserved_22:2;             /**< \brief \internal Reserved */
    unsigned int ENMCI8:1;                  /**< \brief [24:24] Enable ID Error from MCIn (rw) */
    unsigned int ENMCI9:1;                  /**< \brief [25:25] Enable ID Error from MCIn (rw) */
    unsigned int reserved_26:2;             /**< \brief \internal Reserved */
    unsigned int ENMCI12:1;                 /**< \brief [28:28] Enable ID Error from MCIn (rw) */
    unsigned int ENMCI13:1;                 /**< \brief [29:29] Enable ID Error from MCIn (rw) */
    unsigned int reserved_30:2;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_XBAR_IDINTSAT_Bits
{
    ...
    unsigned int reserved_17:3;             /**< \brief \internal Reserved */
    unsigned int IDMCI4:1;                  /**< \brief [20:20] Transaction ID Error from MCIn Status (rwh) */
    unsigned int IDMCI5:1;                  /**< \brief [21:21] Transaction ID Error from MCIn Status (rwh) */
    unsigned int reserved_22:2;             /**< \brief \internal Reserved */
    unsigned int IDMCI8:1;                  /**< \brief [24:24] Transaction ID Error from MCIn Status (rwh) */
    unsigned int IDMCI9:1;                  /**< \brief [25:25] Transaction ID Error from MCIn Status (rwh) */
    unsigned int reserved_26:2;             /**< \brief \internal Reserved */
    unsigned int IDMCI12:1;                 /**< \brief [28:28] Transaction ID Error from MCIn Status (rwh) */
    unsigned int IDMCI13:1;                 /**< \brief [29:29] Transaction ID Error from MCIn Status (rwh) */
    unsigned int reserved_30:2;             /**< \brief \internal Reserved */
...
typedef struct _Ifx_XBAR_INTSAT_Bits
{
    ...
    unsigned int PRSCI0:1;                  /**< \brief [16:16] Protocol Error from SCIn Status (rwh) */
    unsigned int PRSCI1:1;                  /**< \brief [17:17] Protocol Error from SCIn Status (rwh) */
    ...
    unsigned int PRSCI6:1;                  /**< \brief [22:22] Protocol Error from SCIn Status (rwh) */
    unsigned int PRSCI7:1;                  /**< \brief [23:23] Protocol Error from SCIn Status (rwh) */
    unsigned int PRSCI8:1;                  /**< \brief [24:24] Protocol Error from SCIn Status (rwh) */
