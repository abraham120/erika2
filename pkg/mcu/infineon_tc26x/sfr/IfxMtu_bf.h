...
#define IFX_MTU_MEMMAP_CPU2DXMAP_LEN (2)

/** \\brief  Mask for Ifx_MTU_MEMMAP_Bits.CPU2DxMAP */
#define IFX_MTU_MEMMAP_CPU2DXMAP_MSK (0x3)

/** \\brief  Offset for Ifx_MTU_MEMMAP_Bits.CPU2DxMAP */
#define IFX_MTU_MEMMAP_CPU2DXMAP_OFF (1)

/** \\brief  Length for Ifx_MTU_MEMMAP_Bits.CPU2PxMAP */
#define IFX_MTU_MEMMAP_CPU2PXMAP_LEN (2)

/** \\brief  Mask for Ifx_MTU_MEMMAP_Bits.CPU2PxMAP */
#define IFX_MTU_MEMMAP_CPU2PXMAP_MSK (0x3)

/** \\brief  Offset for Ifx_MTU_MEMMAP_Bits.CPU2PxMAP */
#define IFX_MTU_MEMMAP_CPU2PXMAP_OFF (4)
...
/** \\brief  Length for Ifx_MTU_MEMSTAT0_Bits.CPU2xAIU */
#define IFX_MTU_MEMSTAT0_CPU2XAIU_LEN (1)

/** \\brief  Mask for Ifx_MTU_MEMSTAT0_Bits.CPU2xAIU */
#define IFX_MTU_MEMSTAT0_CPU2XAIU_MSK (0x1)

/** \\brief  Offset for Ifx_MTU_MEMSTAT0_Bits.CPU2xAIU */
#define IFX_MTU_MEMSTAT0_CPU2XAIU_OFF (0)
...
/** \\brief  Length for Ifx_MTU_MEMSTAT0_Bits.HSMxAIU */
#define IFX_MTU_MEMSTAT0_HSMXAIU_LEN (1)

/** \\brief  Mask for Ifx_MTU_MEMSTAT0_Bits.HSMxAIU */
#define IFX_MTU_MEMSTAT0_HSMXAIU_MSK (0x1)

/** \\brief  Offset for Ifx_MTU_MEMSTAT0_Bits.HSMxAIU */
#define IFX_MTU_MEMSTAT0_HSMXAIU_OFF (23)
...
#define IFX_MTU_MEMTEST0_CPU2XEN_LEN (6)

/** \\brief  Mask for Ifx_MTU_MEMTEST0_Bits.CPU2XEN */
#define IFX_MTU_MEMTEST0_CPU2XEN_MSK (0x3f)

/** \\brief  Offset for Ifx_MTU_MEMTEST0_Bits.CPU2XEN */
#define IFX_MTU_MEMTEST0_CPU2XEN_OFF (0)
...
#define IFX_MTU_MEMTEST1_EMEMLXEN_LEN (8)

/** \\brief  Mask for Ifx_MTU_MEMTEST1_Bits.EMEMLXEN */
#define IFX_MTU_MEMTEST1_EMEMLXEN_MSK (0xff)

/** \\brief  Offset for Ifx_MTU_MEMTEST1_Bits.EMEMLXEN */
#define IFX_MTU_MEMTEST1_EMEMLXEN_OFF (22)
