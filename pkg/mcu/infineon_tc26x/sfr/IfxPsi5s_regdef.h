...
{
    unsigned int FC0:3;                     /**< \brief [2:0] Frame Counter for Channel x (r) */
    unsigned int FC1:3;                     /**< \brief [5:3] Frame Counter for Channel x (r) */
    unsigned int FC2:3;                     /**< \brief [8:6] Frame Counter for Channel x (r) */
    unsigned int FC3:3;                     /**< \brief [11:9] Frame Counter for Channel x (r) */
    unsigned int FC4:3;                     /**< \brief [14:12] Frame Counter for Channel x (r) */
    unsigned int FC5:3;                     /**< \brief [17:15] Frame Counter for Channel x (r) */
    unsigned int FC6:3;                     /**< \brief [20:18] Frame Counter for Channel x (r) */
    unsigned int FC7:3;                     /**< \brief [23:21] Frame Counter for Channel x (r) */
    unsigned int NFCLR0:1;                  /**< \brief [24:24] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR1:1;                  /**< \brief [25:25] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR2:1;                  /**< \brief [26:26] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR3:1;                  /**< \brief [27:27] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR4:1;                  /**< \brief [28:28] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR5:1;                  /**< \brief [29:29] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR6:1;                  /**< \brief [30:30] Clear Number of Frame Counter for Channel x (w) */
    unsigned int NFCLR7:1;                  /**< \brief [31:31] Clear Number of Frame Counter for Channel x (w) */
} Ifx_PSI5S_FCNT_Bits;
...
typedef struct _Ifx_PSI5S_GCR_Bits
{
    ...
    unsigned int CEN0:1;                    /**< \brief [16:16] Enable Channel x (rw) */
    unsigned int CEN1:1;                    /**< \brief [17:17] Enable Channel x (rw) */
    unsigned int CEN2:1;                    /**< \brief [18:18] Enable Channel x (rw) */
...
{
    unsigned int NF0:3;                     /**< \brief [2:0] Number of expected Frames on Channel x (rw) */
    unsigned int NF1:3;                     /**< \brief [5:3] Number of expected Frames on Channel x (rw) */
    unsigned int NF2:3;                     /**< \brief [8:6] Number of expected Frames on Channel x (rw) */
    unsigned int NF3:3;                     /**< \brief [11:9] Number of expected Frames on Channel x (rw) */
    unsigned int NF4:3;                     /**< \brief [14:12] Number of expected Frames on Channel x (rw) */
    unsigned int NF5:3;                     /**< \brief [17:15] Number of expected Frames on Channel x (rw) */
    unsigned int NF6:3;                     /**< \brief [20:18] Number of expected Frames on Channel x (rw) */
    unsigned int NF7:3;                     /**< \brief [23:21] Number of expected Frames on Channel x (rw) */
...
typedef struct _Ifx_PSI5S_RCRA_Bits
{
    ...
    unsigned int reserved_11:5;             /**< \brief \internal Reserved */
    unsigned int UFC0:2;                    /**< \brief [17:16] UART Frame Count per Packet Frame in Slot y (rw) */
    unsigned int UFC1:2;                    /**< \brief [19:18] UART Frame Count per Packet Frame in Slot y (rw) */
    unsigned int UFC2:2;                    /**< \brief [21:20] UART Frame Count per Packet Frame in Slot y (rw) */
    unsigned int UFC3:2;                    /**< \brief [23:22] UART Frame Count per Packet Frame in Slot y (rw) */
    unsigned int UFC4:2;                    /**< \brief [25:24] UART Frame Count per Packet Frame in Slot y (rw) */
    unsigned int UFC5:2;                    /**< \brief [27:26] UART Frame Count per Packet Frame in Slot y (rw) */
...
typedef volatile struct _Ifx_PSI5S
{
    ...
    Ifx_PSI5S_FDR FDR;                      /**< \brief C, I2C Fractional Divider Register */
    ...
    Ifx_PSI5S_RCRA RCRA[3];                 /**< \brief 30, Receiver Control Register A */
    unsigned char reserved_3C[20];          /**< \brief 3C, \internal Reserved */
    Ifx_PSI5S_RCRB RCRB[3];                 /**< \brief 50, Receiver Control Register B */
    unsigned char reserved_5C[20];          /**< \brief 5C, \internal Reserved */
    Ifx_PSI5S_WDT WDT[3];                   /**< \brief 70, Watch Dog Timer Register */
    unsigned char reserved_7C[20];          /**< \brief 7C, \internal Reserved */
    Ifx_PSI5S_TSCR TSCR[3];                 /**< \brief 90, Capture Register */
    unsigned char reserved_9C[20];          /**< \brief 9C, \internal Reserved */
    ...
    Ifx_PSI5S_PGC PGC[3];                   /**< \brief F0, Pulse Generation Control Register */
    unsigned char reserved_FC[20];          /**< \brief FC, \internal Reserved */
    Ifx_PSI5S_CTV CTV[3];                   /**< \brief 110, Channel Trigger Value Register */
    unsigned char reserved_11C[20];         /**< \brief 11C, \internal Reserved */
    Ifx_PSI5S_SCR SCR[3];                   /**< \brief 130, Send Control Register */
    unsigned char reserved_13C[20];         /**< \brief 13C, \internal Reserved */
    Ifx_PSI5S_SDR SDR[3];                   /**< \brief 150, Send Data Register */
    unsigned char reserved_15C[20];         /**< \brief 15C, \internal Reserved */
    ...
    Ifx_PSI5S_INTSTAT INTSTAT[3];           /**< \brief 260, Interrupt Status Register */
    unsigned char reserved_26C[20];         /**< \brief 26C, \internal Reserved */
    Ifx_PSI5S_INTSET INTSET[3];             /**< \brief 280, Interrupt Set Register */
    unsigned char reserved_28C[20];         /**< \brief 28C, \internal Reserved */
    Ifx_PSI5S_INTCLR INTCLR[3];             /**< \brief 2A0, Interrupt Clear Register */
    unsigned char reserved_2AC[20];         /**< \brief 2AC, \internal Reserved */
    Ifx_PSI5S_INTEN INTEN[3];               /**< \brief 2C0, Interrupt Enable Register */
    unsigned char reserved_2CC[20];         /**< \brief 2CC, \internal Reserved */
    Ifx_PSI5S_INP INP[3];                   /**< \brief 2E0, Interrupt Node Pointer Register */
    unsigned char reserved_2EC[20];         /**< \brief 2EC, \internal Reserved */
