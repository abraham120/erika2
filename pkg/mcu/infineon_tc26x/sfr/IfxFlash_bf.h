...
/** \\brief  Length for Ifx_FLASH_PROCOND_Bits.RSTCNT */
#define IFX_FLASH_PROCOND_RSTCNT_LEN (12)

/** \\brief  Mask for Ifx_FLASH_PROCOND_Bits.RSTCNT */
#define IFX_FLASH_PROCOND_RSTCNT_MSK (0xfff)

/** \\brief  Offset for Ifx_FLASH_PROCOND_Bits.RSTCNT */
#define IFX_FLASH_PROCOND_RSTCNT_OFF (16)
