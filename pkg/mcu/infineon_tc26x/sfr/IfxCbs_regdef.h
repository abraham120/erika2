...
typedef struct _Ifx_CBS_OIFM_Bits
{
    ...
    unsigned int PADCTL:4;                  /**< \brief [15:12] Pad Control for Debug Interface Pins [RfQ00256] (rw) */
...
typedef struct _Ifx_CBS_OSTATE_Bits
{
    ...
    unsigned int WDTSUS:1;                  /**< \brief [7:7] Control of Watchdog Timer Suspension [RfQ00610] (rh) */
...
typedef struct _Ifx_CBS_TCCB_Bits
{
    ...
    unsigned int HSM:1;                     /**< \brief [31:31] Capture of BRKOUT Signal of <Security_Module> (rh) */
} Ifx_CBS_TCCB_Bits;
...
typedef struct _Ifx_CBS_TCCH_Bits
{
    ...
    unsigned int reserved_3:28;             /**< \brief \internal Reserved */
    unsigned int HSM:1;                     /**< \brief [31:31] Capture of HALT Signal of <Security_Module> (rh) */
} Ifx_CBS_TCCH_Bits;
...
typedef struct _Ifx_CBS_TCIP_Bits
{
    ...
    unsigned int P4:1;                      /**< \brief [4:4] Capture of Trigger Input Pin x (rh) */
    unsigned int P5:1;                      /**< \brief [5:5] Capture of Trigger Input Pin x (rh) */
    unsigned int P6:1;                      /**< \brief [6:6] Capture of Trigger Input Pin x (rh) */
    unsigned int P7:1;                      /**< \brief [7:7] Capture of Trigger Input Pin x (rh) */
...
typedef struct _Ifx_CBS_TL1ST_Bits
{
    ...
    unsigned int HSM:1;                     /**< \brief [31:31] <Security_Module> as Suspend Target (rw) */
} Ifx_CBS_TL1ST_Bits;
