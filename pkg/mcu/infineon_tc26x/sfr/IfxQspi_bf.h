...
/** \\brief  Length for Ifx_QSPI_FLAGSCLEAR_Bits.HC1C */
#define IFX_QSPI_FLAGSCLEAR_HC1C_LEN (1)

/** \\brief  Mask for Ifx_QSPI_FLAGSCLEAR_Bits.HC1C */
#define IFX_QSPI_FLAGSCLEAR_HC1C_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_FLAGSCLEAR_Bits.HC1C */
#define IFX_QSPI_FLAGSCLEAR_HC1C_OFF (13)

/** \\brief  Length for Ifx_QSPI_FLAGSCLEAR_Bits.HC2C */
#define IFX_QSPI_FLAGSCLEAR_HC2C_LEN (1)

/** \\brief  Mask for Ifx_QSPI_FLAGSCLEAR_Bits.HC2C */
#define IFX_QSPI_FLAGSCLEAR_HC2C_MSK (0x1)

/** \\brief  Offset for Ifx_QSPI_FLAGSCLEAR_Bits.HC2C */
#define IFX_QSPI_FLAGSCLEAR_HC2C_OFF (14)
