...
{
    unsigned int ARW0:2;                    /**< \brief [1:0] Access Rule for Window x (rw) */
    unsigned int ARW1:2;                    /**< \brief [3:2] Access Rule for Window x (rw) */
    unsigned int ARW2:2;                    /**< \brief [5:4] Access Rule for Window x (rw) */
    unsigned int ARW3:2;                    /**< \brief [7:6] Access Rule for Window x (rw) */
