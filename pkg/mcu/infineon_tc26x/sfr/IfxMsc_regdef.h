...
{
    unsigned int ENL16:1;                   /**< \brief [0:0] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL17:1;                   /**< \brief [1:1] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL18:1;                   /**< \brief [2:2] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL19:1;                   /**< \brief [3:3] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL20:1;                   /**< \brief [4:4] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL21:1;                   /**< \brief [5:5] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL22:1;                   /**< \brief [6:6] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL23:1;                   /**< \brief [7:7] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL24:1;                   /**< \brief [8:8] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL25:1;                   /**< \brief [9:9] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL26:1;                   /**< \brief [10:10] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL27:1;                   /**< \brief [11:11] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL28:1;                   /**< \brief [12:12] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL29:1;                   /**< \brief [13:13] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL30:1;                   /**< \brief [14:14] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENL31:1;                   /**< \brief [15:15] Emergency Stop Enable for Bit x in SRL (rw) */
    unsigned int ENH16:1;                   /**< \brief [16:16] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH17:1;                   /**< \brief [17:17] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH18:1;                   /**< \brief [18:18] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH19:1;                   /**< \brief [19:19] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH20:1;                   /**< \brief [20:20] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH21:1;                   /**< \brief [21:21] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH22:1;                   /**< \brief [22:22] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH23:1;                   /**< \brief [23:23] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH24:1;                   /**< \brief [24:24] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH25:1;                   /**< \brief [25:25] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH26:1;                   /**< \brief [26:26] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH27:1;                   /**< \brief [27:27] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH28:1;                   /**< \brief [28:28] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH29:1;                   /**< \brief [29:29] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH30:1;                   /**< \brief [30:30] Emergency Stop Enable for Bit x in SRH (rw) */
    unsigned int ENH31:1;                   /**< \brief [31:31] Emergency Stop Enable for Bit x in SRH (rw) */
} Ifx_MSC_ESRE_Bits;
