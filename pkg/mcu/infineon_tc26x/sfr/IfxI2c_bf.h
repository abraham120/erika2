...
#define IFX_I2C_ID_MODREV_LEN (8)

/** \\brief  Mask for Ifx_I2C_ID_Bits.MODREV */
#define IFX_I2C_ID_MODREV_MSK (0xff)

/** \\brief  Offset for Ifx_I2C_ID_Bits.MODREV */
#define IFX_I2C_ID_MODREV_OFF (0)
