...
{
    unsigned int FEG0:1;                    /**< \brief [0:0] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG1:1;                    /**< \brief [1:1] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG2:1;                    /**< \brief [2:2] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG3:1;                    /**< \brief [3:3] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG4:1;                    /**< \brief [4:4] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG5:1;                    /**< \brief [5:5] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG6:1;                    /**< \brief [6:6] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG7:1;                    /**< \brief [7:7] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG8:1;                    /**< \brief [8:8] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG9:1;                    /**< \brief [9:9] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG10:1;                   /**< \brief [10:10] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG11:1;                   /**< \brief [11:11] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG12:1;                   /**< \brief [12:12] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG13:1;                   /**< \brief [13:13] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG14:1;                   /**< \brief [14:14] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int FEG15:1;                   /**< \brief [15:15] Falling Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG0:1;                    /**< \brief [16:16] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG1:1;                    /**< \brief [17:17] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG2:1;                    /**< \brief [18:18] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG3:1;                    /**< \brief [19:19] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG4:1;                    /**< \brief [20:20] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG5:1;                    /**< \brief [21:21] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG6:1;                    /**< \brief [22:22] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG7:1;                    /**< \brief [23:23] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG8:1;                    /**< \brief [24:24] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG9:1;                    /**< \brief [25:25] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG10:1;                   /**< \brief [26:26] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG11:1;                   /**< \brief [27:27] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG12:1;                   /**< \brief [28:28] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG13:1;                   /**< \brief [29:29] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG14:1;                   /**< \brief [30:30] Rising Edge Glitch Flag for FPCk (rwh) */
    unsigned int REG15:1;                   /**< \brief [31:31] Rising Edge Glitch Flag for FPCk (rwh) */
} Ifx_IOM_FPCESR_Bits;
