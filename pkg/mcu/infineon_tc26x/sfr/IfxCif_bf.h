...
#define IFX_CIF_BBB_MODID_MODREV_LEN (8)

/** \\brief  Mask for Ifx_CIF_BBB_MODID_Bits.MODREV */
#define IFX_CIF_BBB_MODID_MODREV_MSK (0xff)

/** \\brief  Offset for Ifx_CIF_BBB_MODID_Bits.MODREV */
#define IFX_CIF_BBB_MODID_MODREV_OFF (0)

/** \\brief  Length for Ifx_CIF_BBB_MODID_Bits.MODTYPE */
#define IFX_CIF_BBB_MODID_MODTYPE_LEN (8)

/** \\brief  Mask for Ifx_CIF_BBB_MODID_Bits.MODTYPE */
#define IFX_CIF_BBB_MODID_MODTYPE_MSK (0xff)

/** \\brief  Offset for Ifx_CIF_BBB_MODID_Bits.MODTYPE */
#define IFX_CIF_BBB_MODID_MODTYPE_OFF (8)
