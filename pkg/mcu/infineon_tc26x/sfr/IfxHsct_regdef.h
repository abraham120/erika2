...
typedef struct _Ifx_HSCT_IRQCLR_Bits
{
    ...
    unsigned int SFOEN:1;                   /**< \brief [11:11] Synchronization FIFO overflow (in RX direction) interrupt clear (w) */
    unsigned int SFUEN:1;                   /**< \brief [12:12] Synchronization FIFO underflow (in TX direction) interrupt clear (w) */
    unsigned int reserved_13:19;            /**< \brief \internal Reserved */
