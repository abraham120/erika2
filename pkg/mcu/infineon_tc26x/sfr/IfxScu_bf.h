...
/** \\brief  Length for Ifx_SCU_CCUCONSM_Bits.BACKREL */
#define IFX_SCU_CCUCONSM_BACKREL_LEN (5)

/** \\brief  Mask for Ifx_SCU_CCUCONSM_Bits.BACKREL */
#define IFX_SCU_CCUCONSM_BACKREL_MSK (0x1f)

/** \\brief  Offset for Ifx_SCU_CCUCONSM_Bits.BACKREL */
#define IFX_SCU_CCUCONSM_BACKREL_OFF (0)

/** \\brief  Length for Ifx_SCU_CCUCONSM_Bits.EN */
#define IFX_SCU_CCUCONSM_EN_LEN (1)

/** \\brief  Mask for Ifx_SCU_CCUCONSM_Bits.EN */
#define IFX_SCU_CCUCONSM_EN_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_CCUCONSM_Bits.EN */
#define IFX_SCU_CCUCONSM_EN_OFF (31)

/** \\brief  Length for Ifx_SCU_CCUCONSM_Bits.SPBREL */
#define IFX_SCU_CCUCONSM_SPBREL_LEN (5)

/** \\brief  Mask for Ifx_SCU_CCUCONSM_Bits.SPBREL */
#define IFX_SCU_CCUCONSM_SPBREL_MSK (0x1f)

/** \\brief  Offset for Ifx_SCU_CCUCONSM_Bits.SPBREL */
#define IFX_SCU_CCUCONSM_SPBREL_OFF (8)
...
#define IFX_SCU_PMSWSTATCLR_SCRSTCLR_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWSTATCLR_Bits.SCRSTCLR */
#define IFX_SCU_PMSWSTATCLR_SCRSTCLR_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWSTATCLR_Bits.SCRSTCLR */
#define IFX_SCU_PMSWSTATCLR_SCRSTCLR_OFF (16)

/** \\brief  Length for Ifx_SCU_PMSWSTATCLR_Bits.SCRWKPCLR */
#define IFX_SCU_PMSWSTATCLR_SCRWKPCLR_LEN (1)

/** \\brief  Mask for Ifx_SCU_PMSWSTATCLR_Bits.SCRWKPCLR */
#define IFX_SCU_PMSWSTATCLR_SCRWKPCLR_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_PMSWSTATCLR_Bits.SCRWKPCLR */
#define IFX_SCU_PMSWSTATCLR_SCRWKPCLR_OFF (17)
...
#define IFX_SCU_STCON_CFCBAE_LEN (1)

/** \\brief  Mask for Ifx_SCU_STCON_Bits.CFCBAE */
#define IFX_SCU_STCON_CFCBAE_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_STCON_Bits.CFCBAE */
#define IFX_SCU_STCON_CFCBAE_OFF (14)

/** \\brief  Length for Ifx_SCU_STCON_Bits.HWCFG */
#define IFX_SCU_STCON_HWCFG_LEN (8)

/** \\brief  Mask for Ifx_SCU_STCON_Bits.HWCFG */
#define IFX_SCU_STCON_HWCFG_MSK (0xff)

/** \\brief  Offset for Ifx_SCU_STCON_Bits.HWCFG */
#define IFX_SCU_STCON_HWCFG_OFF (0)

/** \\brief  Length for Ifx_SCU_STCON_Bits.SFCBAE */
#define IFX_SCU_STCON_SFCBAE_LEN (1)

/** \\brief  Mask for Ifx_SCU_STCON_Bits.SFCBAE */
#define IFX_SCU_STCON_SFCBAE_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_STCON_Bits.SFCBAE */
#define IFX_SCU_STCON_SFCBAE_OFF (13)

/** \\brief  Length for Ifx_SCU_STCON_Bits.STP */
#define IFX_SCU_STCON_STP_LEN (1)

/** \\brief  Mask for Ifx_SCU_STCON_Bits.STP */
#define IFX_SCU_STCON_STP_MSK (0x1)

/** \\brief  Offset for Ifx_SCU_STCON_Bits.STP */
#define IFX_SCU_STCON_STP_OFF (15)
