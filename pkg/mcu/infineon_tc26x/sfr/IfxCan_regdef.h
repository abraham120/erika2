...
typedef struct _Ifx_CAN_MO_CTR_STAT_CTR_Bits
{
...
} Ifx_CAN_MO_CTR_STAT_CTR_Bits;

/** \\brief  Message Object  Status Register */
typedef struct _Ifx_CAN_MO_CTR_STAT_STAT_Bits
{
...
typedef union
{
    ...
    /** \brief Signed access */
    signed int I;
    /** \brief Bitfield access: Message Object  Control Register */
    Ifx_CAN_MO_CTR_STAT_CTR_Bits B_CTR;
    /** \brief Bitfield access: Message Object  Status Register */
    Ifx_CAN_MO_CTR_STAT_STAT_Bits B_STAT;
} Ifx_CAN_MO_CTR_STAT;
...
typedef volatile struct _Ifx_CAN_MO
{
    ...
    Ifx_CAN_MO_CTR_STAT CTR_STAT;           /**< \brief 1C, Message Object  Control Register */
} Ifx_CAN_MO;
