...
{
    unsigned int CPU2xAIU:1;                /**< \brief [0:0] Reserved in this product (r) */
    ...
    unsigned int HSMxAIU:1;                 /**< \brief [23:23] Reserved in this product (r) */
...
typedef struct _Ifx_MTU_MEMTEST1_Bits
{
    ...
    unsigned int EMEML0EN:1;                /**< \brief [14:14] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML1EN:1;                /**< \brief [15:15] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML2EN:1;                /**< \brief [16:16] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML3EN:1;                /**< \brief [17:17] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML4EN:1;                /**< \brief [18:18] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML5EN:1;                /**< \brief [19:19] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML6EN:1;                /**< \brief [20:20] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
    unsigned int EMEML7EN:1;                /**< \brief [21:21] EMEM Lower x (TCM) MBIST Controller Memory Test Enable (ED only) (rwh) */
