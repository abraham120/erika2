...
#define IFX_SBCU_DBGRNT_ONE3_LEN (5)

/** \\brief  Mask for Ifx_SBCU_DBGRNT_Bits.ONE3 */
#define IFX_SBCU_DBGRNT_ONE3_MSK (0x1f)

/** \\brief  Offset for Ifx_SBCU_DBGRNT_Bits.ONE3 */
#define IFX_SBCU_DBGRNT_ONE3_OFF (9)
...
#define IFX_SBCU_ID_MODREV_LEN (8)

/** \\brief  Mask for Ifx_SBCU_ID_Bits.MODREV */
#define IFX_SBCU_ID_MODREV_MSK (0xff)

/** \\brief  Offset for Ifx_SBCU_ID_Bits.MODREV */
#define IFX_SBCU_ID_MODREV_OFF (0)
...
#define IFX_SBCU_PRIOH_RESERVED9_LEN (4)

/** \\brief  Mask for Ifx_SBCU_PRIOH_Bits.RESERVED9 */
#define IFX_SBCU_PRIOH_RESERVED9_MSK (0xf)

/** \\brief  Offset for Ifx_SBCU_PRIOH_Bits.RESERVED9 */
#define IFX_SBCU_PRIOH_RESERVED9_OFF (4)
...
#define IFX_SBCU_PRIOH_RESERVEDC_LEN (4)

/** \\brief  Mask for Ifx_SBCU_PRIOH_Bits.RESERVEDC */
#define IFX_SBCU_PRIOH_RESERVEDC_MSK (0xf)

/** \\brief  Offset for Ifx_SBCU_PRIOH_Bits.RESERVEDC */
#define IFX_SBCU_PRIOH_RESERVEDC_OFF (16)

/** \\brief  Length for Ifx_SBCU_PRIOH_Bits.RESERVEDD */
#define IFX_SBCU_PRIOH_RESERVEDD_LEN (4)

/** \\brief  Mask for Ifx_SBCU_PRIOH_Bits.RESERVEDD */
#define IFX_SBCU_PRIOH_RESERVEDD_MSK (0xf)

/** \\brief  Offset for Ifx_SBCU_PRIOH_Bits.RESERVEDD */
#define IFX_SBCU_PRIOH_RESERVEDD_OFF (20)
