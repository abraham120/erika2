...
/** Alias (User Manual Name) for SRC_FFT_FFT0_FFTDONE.
* To use register names with standard convension, please use SRC_FFT_FFT0_FFTDONE.
*/
...
/** Alias (User Manual Name) for SRC_FFT_FFT0_FFTERR.
* To use register names with standard convension, please use SRC_FFT_FFT0_FFTERR.
*/
...
/** Alias (User Manual Name) for SRC_FFT_FFT0_FFTRFS.
* To use register names with standard convension, please use SRC_FFT_FFT0_FFTRFS.
*/
...
/** \\brief  1A0, QSPI Half Cycle Service Request */
...
*/
#define	SRC_QSPI0HC	(SRC_QSPI_QSPI0_HC)
...
/** \\brief  1B8, QSPI Half Cycle Service Request */
...
*/
#define	SRC_QSPI1HC	(SRC_QSPI_QSPI1_HC)
...
/** \\brief  1D0, QSPI Half Cycle Service Request */
...
/** \\brief  1E8, QSPI Half Cycle Service Request */
