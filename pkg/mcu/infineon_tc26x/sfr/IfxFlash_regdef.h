...
typedef struct _Ifx_FLASH_PROCOND_Bits
{
    ...
    unsigned int CAP0EN:1;                  /**< \brief [12:12] OSC Capacitance x Enable (x=0-3) (rh) */
    unsigned int CAP1EN:1;                  /**< \brief [13:13] OSC Capacitance x Enable (x=0-3) (rh) */
    unsigned int CAP2EN:1;                  /**< \brief [14:14] OSC Capacitance x Enable (x=0-3) (rh) */
    unsigned int CAP3EN:1;                  /**< \brief [15:15] OSC Capacitance x Enable (x=0-3) (rh) */
    unsigned int RSTCNT:12;                 /**< \brief [27:16] ESR0 Delay (rh) */
