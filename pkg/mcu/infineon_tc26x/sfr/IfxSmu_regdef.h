...
{
    unsigned int DF0:1;                     /**< \brief [0:0] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF1:1;                     /**< \brief [1:1] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF2:1;                     /**< \brief [2:2] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF3:1;                     /**< \brief [3:3] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF4:1;                     /**< \brief [4:4] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF5:1;                     /**< \brief [5:5] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF6:1;                     /**< \brief [6:6] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF7:1;                     /**< \brief [7:7] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF8:1;                     /**< \brief [8:8] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF9:1;                     /**< \brief [9:9] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF10:1;                    /**< \brief [10:10] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF11:1;                    /**< \brief [11:11] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF12:1;                    /**< \brief [12:12] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF13:1;                    /**< \brief [13:13] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF14:1;                    /**< \brief [14:14] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF15:1;                    /**< \brief [15:15] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF16:1;                    /**< \brief [16:16] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF17:1;                    /**< \brief [17:17] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF18:1;                    /**< \brief [18:18] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF19:1;                    /**< \brief [19:19] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF20:1;                    /**< \brief [20:20] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF21:1;                    /**< \brief [21:21] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF22:1;                    /**< \brief [22:22] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF23:1;                    /**< \brief [23:23] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF24:1;                    /**< \brief [24:24] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF25:1;                    /**< \brief [25:25] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF26:1;                    /**< \brief [26:26] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF27:1;                    /**< \brief [27:27] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF28:1;                    /**< \brief [28:28] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF29:1;                    /**< \brief [29:29] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF30:1;                    /**< \brief [30:30] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
    unsigned int DF31:1;                    /**< \brief [31:31] Debug flag for alarm n belonging to alarm group x (x=0-6). (rh) */
} Ifx_SMU_AD_Bits;
...
{
    unsigned int SF0:1;                     /**< \brief [0:0] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF1:1;                     /**< \brief [1:1] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF2:1;                     /**< \brief [2:2] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF3:1;                     /**< \brief [3:3] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF4:1;                     /**< \brief [4:4] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF5:1;                     /**< \brief [5:5] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF6:1;                     /**< \brief [6:6] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF7:1;                     /**< \brief [7:7] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF8:1;                     /**< \brief [8:8] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF9:1;                     /**< \brief [9:9] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF10:1;                    /**< \brief [10:10] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF11:1;                    /**< \brief [11:11] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF12:1;                    /**< \brief [12:12] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF13:1;                    /**< \brief [13:13] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF14:1;                    /**< \brief [14:14] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF15:1;                    /**< \brief [15:15] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF16:1;                    /**< \brief [16:16] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF17:1;                    /**< \brief [17:17] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF18:1;                    /**< \brief [18:18] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF19:1;                    /**< \brief [19:19] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF20:1;                    /**< \brief [20:20] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF21:1;                    /**< \brief [21:21] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF22:1;                    /**< \brief [22:22] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF23:1;                    /**< \brief [23:23] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF24:1;                    /**< \brief [24:24] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF25:1;                    /**< \brief [25:25] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF26:1;                    /**< \brief [26:26] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF27:1;                    /**< \brief [27:27] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF28:1;                    /**< \brief [28:28] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF29:1;                    /**< \brief [29:29] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF30:1;                    /**< \brief [30:30] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
    unsigned int SF31:1;                    /**< \brief [31:31] Status flag for alarm n belonging to alarm group x (x=0-6). (rwh) */
} Ifx_SMU_AG_Bits;
