...
typedef volatile struct _Ifx_INT
{
    ...
    Ifx_INT_ICU CH0;                        /**< \brief 100, Interrupt router channel */
    Ifx_INT_ICU CH1;                        /**< \brief 110, Interrupt router channel */
    unsigned char reserved_120[16];         /**< \brief 120, \internal Reserved */
    Ifx_INT_ICU CH3;                        /**< \brief 130, Interrupt router channel */
