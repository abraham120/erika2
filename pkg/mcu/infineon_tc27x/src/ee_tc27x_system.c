    ...
    EE_TYPEISR2PRIO intvec)
{
  ...
  us_in_ticks = EE_tc27x_stm_us_ticks(usec);
  ...
  EE_STM_CMP0.U = us_in_ticks + EE_tc27x_stm_get_time_lower_word();
...
EE_STM_SR0_STORAGE void EE_tc27x_stm_set_sr0_next_match(EE_UINT32 usec)
{
  /* Evaluate next compare value (previous one + increment,
     I don't need to handle wrap around) */
  EE_STM_CMP0.U += EE_tc27x_stm_us_ticks(usec);
}
  ...
  EE_TYPEISR2PRIO intvec)
{
  ...
  /*  Set Compare Value Register (actual value + increment,
      I don't need to handle wrap around) */
  EE_STM_CMP1.U = us_in_ticks + EE_tc27x_stm_get_time_lower_word();
...
EE_STM_SR1_STORAGE void EE_tc27x_stm_set_sr1_next_match(EE_UINT32 usec)
{
  /* Evaluate next compare value (previous one + increment,
     I don't need to handle wrap around) */
  EE_STM_CMP1.U += EE_tc27x_stm_us_ticks(usec);
}
