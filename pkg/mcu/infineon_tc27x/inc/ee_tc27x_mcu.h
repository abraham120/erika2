 ...
 * ###*E*### */
  ...
  *  @date 2012
  */
#ifndef INCLUDE_EE_TC27X_MCU_H__
#define INCLUDE_EE_TC27X_MCU_H__
 ...
 ****************************************************************/
#define EE_TC27X_SRN_PRIORITY(intvec)     (((EE_UINT32)(intvec)) & \
  (EE_UINT32)0x7FU)
#define EE_TC27X_SRN_ENABLE               ((EE_UINT32)1U << 10U)
#define EE_TC27X_SRN_TYPE_OF_SERVICE(tos) ((((EE_UINT32)(tos)) & \
  (EE_UINT32)0x3U) << 11U)
...
#define EE_TC27X_SCU_OSCCON_OSCRES ( (EE_UINT32)1U << 2U )
/* Default Reset Value for OSCCCON.GAIN Should not be Changed. Bits[3:4] */
#define EE_TC27X_SCU_OSCCON_GAINSEL ( (EE_UINT32)3U << 3U )
/* Extern Cristall is 00 mode so this define doesn't change the OSSCON
   Value. Bits[5:6] */
#define EE_TC27X_SCU_OSCCON_MODE(mode) ( (((EE_UINT32)(mode)) & \
  (EE_UINT32)0x3U) << 5U )
/* OSCCCON.OSCVAL OSC Frequency Value
   fOSC is divided by OSCVAL + 1. Bits [16:20]
   (15 is The only value that work. Found empirically) */
#define EE_TC27X_SCU_OSCCON_OSCVAL(oscval) ( (((EE_UINT32)(oscval)) & \
  (EE_UINT32)0xFU) << 16U )

__INLINE__ void __ALWAYS_INLINE__ EE_tc27x_set_osccon( EE_UREG value )
{
...
/**
  ...
  */
void EE_tc27x_stm_set_sr0( EE_UINT32 usec, EE_TYPEISR2PRIO intvec );
...
/**
  ...
  *  @param usec microseconds after you want get an IRQ on intvec
  */
void EE_tc27x_stm_set_sr0_next_match( EE_UINT32 usec );
...
/**
  ...
  *         unprogrammed or resetted.
  */
void EE_tc27x_stm_set_sr1( EE_UINT32 usec, EE_TYPEISR2PRIO intvec );
...
/**
  ...
  *         word.
 */
__INLINE__ EE_UREG __ALWAYS_INLINE__ EE_tc27x_stm_get_time_lower_word( void )
{
...
/*  Input - No input pull device connected, tri-state mode
    (same as 0x03U) */
#define EE_TC27X_INPUT_TRISTATE         0x00U
/*  Input - Pull-Down device connected */
#define EE_TC27X_INPUT_PULL_DOWN        0x01U
/*  Input - Pull-Up device connected. RESET Default */
#define EE_TC27X_INPUT_PULL_UP          0x02U

/*  Output - Push-pull General-purpose output */
#define EE_TC27X_OUTPUT_PUSH_PULL_GP    0x10U
/*  Output - Push-pull Alternate output function 1 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT1  0x11U
/*  Output - Push-pull Alternate output function 2 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT2  0x12U
/*  Output - Push-pull Alternate output function 3 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT3  0x13U
/*  Output - Push-pull Alternate output function 4 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT4  0x14U
/*  Output - Push-pull Alternate output function 5 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT5  0x15U
/*  Output - Push-pull Alternate output function 6 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT6  0x16U
/*  Output - Push-pull Alternate output function 7 */
#define EE_TC27X_OUTPUT_PUSH_PULL_ALT7  0x17U

/*  Output - Open-drain General-purpose output */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_GP   0x24U
/*  Output - Open-drain Alternate output function 1 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT1 0x25U
/*  Output - Open-drain Alternate output function 2 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT2 0x26U
/*  Output - Open-drain Alternate output function 3 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT3 0x27U
/*  Output - Open-drain Alternate output function 4 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT4 0x28U
/*  Output - Open-drain Alternate output function 5 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT5 0x29U
/*  Output - Open-drain Alternate output function 6 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT6 0x30U
/*  Output - Open-drain Alternate output function 7 */
#define EE_TC27X_OUTPUT_OPEN_DRAIN_ALT7 0x31U

#endif /* INCLUDE_EE_TC27X_MCU_H__ */
