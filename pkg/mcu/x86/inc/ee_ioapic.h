...
#ifndef __INCLUDE__X86_IOAPIC_H__
#define __INCLUDE__X86_IOAPIC_H__
...
void EE_ioapic_setup_irq_extended(EE_UINT8 pin, EE_UINT8 vector,
        enum ee_ioapic_delivery_mode delivery_mode, EE_UINT8 active_low);
