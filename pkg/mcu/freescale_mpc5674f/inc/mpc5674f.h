...
#define ETPU_DATA_RAM_END  (*( uint32_t *)              0xC3FC8FFC) 
...
/* For backward compatibility with mpc5500 family */
#define EDMA      EDMA_A
...
#define ESCI_D    (*( struct ESCI_tag *)       0xFFFBC000)
