...
/*
 * Stack related configurations
 * Author: 2012 Gianluca Franchino
 * The following code is based on "ee_sbrk.c" file generated by Renesas Hew IDE.
 */

#include "cpu/common/inc/ee_types.h"
#include "mcu/renesas_r5f5210x/inc/ee_sbrk.h"

/*******************************************************************************
* Local Function Prototypes
*******************************************************************************/
/* Memory allocation function prototype declaration */
EE_INT8  *sbrk(EE_UINT32 size);

/*******************************************************************************
* Global Variables
*******************************************************************************/
extern EE_INT8 *_s1ptr;

union HEAP_TYPE {
    /* Dummy for 4-byte boundary */
	EE_INT32  dummy ;		
    /* Declaration of the area managed by sbrk*/
	EE_INT8 heap[EE_HEAP_SIZE];	
};
/* Declare memory heap area */
static union HEAP_TYPE heap_area ;
/* End address allocated by sbrk	*/
static EE_INT8 *brk=(EE_INT8 *)&heap_area;
...
EE_INT8  *sbrk(EE_UINT32 size)                      
{
    ...
    if(brk+size > heap_area.heap+EE_HEAP_SIZE)
	{     
        /* Empty area size  */
		p = (EE_INT8 *)-1;
    }
