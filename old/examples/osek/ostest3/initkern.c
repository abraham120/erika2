 ...
 * CVS: $Id: initkern.c,v 1.2 2006/02/22 16:26:25 pj Exp $
 */
...
#ifndef __OSEKOS_NO_CHAINTASK__
...
#if defined(__OSEKOS_BCC1__) || defined(__OSEKOS_ECC1__)
...
#if defined(__OSEKOS_BCC2__) || defined(__OSEKOS_ECC2__)

#if defined(__OSEKOS_BCC2__)
...
/* Event handling */
#if defined(__OSEKOS_ECC1__) || defined(__OSEKOS_ECC2__)
...
#ifdef __OSEKOS_EXTENDED_STATUS__ 
...
#endif /* __OSEKOS_EXTENDED_STATUS__ */

#if defined(__OSEKOS_EXTENDED_STATUS__) || defined(__OSEKOS_ORTI_RESLOCKED__)
...
#ifdef __OSEKOS_ORTI_RES_LOCKER_TASK__
/* This is task that has currently locked the resource. */
EE_UREG EE_ORTI_res_locker[EE_MAX_RESOURCE];
#endif
