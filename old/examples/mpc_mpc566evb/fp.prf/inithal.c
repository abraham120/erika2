...
struct ERIKA_TOS ERIKA_arm7_system_tos[THREAD_MAX+1] =
{
    ...
    {(ERIKA_ADDR)(__SYS_STACK_ADDRESS-2560-32), (ERIKA_ADDR)(__IRQ_STACK_ADDRESS-2560-32)}, /* thread4 */
    {(ERIKA_ADDR)(__SYS_STACK_ADDRESS-3072-32), (ERIKA_ADDR)(__IRQ_STACK_ADDRESS-3072-32)}, /* thread5 */
    {(ERIKA_ADDR)(__SYS_STACK_ADDRESS-3584-32), (ERIKA_ADDR)(__IRQ_STACK_ADDRESS-3584-32)}  /* thread6 */
};
...
struct ERIKA_TOS ERIKA_arm7_IRQ_tos = {
  (ERIKA_ADDR)(__SYS_STACK_ADDRESS-4096-32), (ERIKA_ADDR)(__IRQ_STACK_ADDRESS-4096-32)
};
#endif
