 ...
 * CVS: $Id: code.c,v 1.6 2006/05/14 18:00:59 pj Exp $
 */
 ...
 * Watchdog countdown 
 */
#define COUNTDOWN (1000 * 1000 * 300) /* 10 sec */


/*
 * Display a number during a short pause 
 */
#define LOOP_LENGHT (1000 * 1000)	//~1 sec	@ 30MHz 
...
void timer_and_watchdog_handler(void)
{
    /* activate thread */
