 ...
 * CVS: $Id: timer.c,v 1.3 2006/05/14 18:01:00 pj Exp $
 */
...
//    EE_timer_1_set(min_dline);
    EE_timer1_start(min_dline, 0x000000c8);
...
void tick_handler(void)
{
	 ...
	 * several times */
	while ((EE_STIME)time_countdown[i] <= TIMER_TOLERANCE) {
	    time_countdown[i] += th_period[i];
	    EE_thread_activate(i);
	}
