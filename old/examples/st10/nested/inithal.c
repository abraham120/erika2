...
__IRAM__ struct EE_TOS EE_st10_system_tos[THREAD_MAX+1] = 
{ 
...
__IRAM__ EE_UINT16 EE_st10_thread_tos[THREAD_MAX+1] =
{
  ...
  (EE_UINT16)(EE_st10_system_tos+1), // Threads
...
// ROM
iram EE_ADDR EE_st10_IRQ_tos   = (EE_ADDR)(EE_st10_user_stack+120);
