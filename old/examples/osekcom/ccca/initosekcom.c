...
EE_OSEKCOM_DEFINE_INTERNAL_UNQUEUED_MESSAGE(RECEIVER1,32,F_Always,NULL,EE_OSEKCOM_T_OK,&t1,RECEIVER2);
EE_OSEKCOM_DEFINE_INTERNAL_UNQUEUED_MESSAGE(RECEIVER2,32,F_Always,NULL,EE_OSEKCOM_CB_OK,callback,EE_OSEKCOM_NULL);

/* Transmission
 */
EE_OSEKCOM_DEFINE_INTERNAL_MESSAGE(ABS,32,RECEIVER1);
...
struct EE_osekcom_msg_RAM_TYPE * EE_osekcom_msg_RAM[EE_OSEKCOM_N_MSG] = {
  ...
  EE_osekcom_msg_RAM(RECEIVER1),
  EE_osekcom_msg_RAM(RECEIVER2)
};

const struct EE_osekcom_msg_ROM_TYPE * EE_osekcom_msg_ROM[EE_OSEKCOM_N_MSG] = {
  EE_osekcom_msg_ROM(ABS),
  EE_osekcom_msg_ROM(RECEIVER1),
  EE_osekcom_msg_ROM(RECEIVER2)
};
