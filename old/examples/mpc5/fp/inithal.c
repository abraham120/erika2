...
/*
 * CVS: $Id: inithal.c,v 1.4 2006/05/14 18:00:59 pj Exp $
 */
...
{
    {(EE_ADDR)(__SYS_STACK_ADDRESS        )}, /* main. MANDATORY! */
    {(EE_ADDR)(__SYS_STACK_ADDRESS-512 -32)}, /* thread0 */
    {(EE_ADDR)(__SYS_STACK_ADDRESS-1024-32)}, /* thread1 */
    {(EE_ADDR)(__SYS_STACK_ADDRESS-1536-32)}, /* thread2 */
    {(EE_ADDR)(__SYS_STACK_ADDRESS-2048-32)} /* thread3 */
};
...
struct EE_TOS EE_mpc5_IRQ_tos = {
  (EE_ADDR)(__SYS_STACK_ADDRESS-2560-32)
};
#endif
