 ...
 * CVS: $Id: initkern.c,v 1.1 2005/07/16 13:41:15 pj Exp $
 */

#include "ee.h"

// the ifdef is only part of this example NOT of the automatically
// generated code. Generated code should have when needed EE_MAX_TASK
// and not MY_EE_MAX_TASK
#ifndef EE_MAX_TASK
const unsigned int EE_MAX_TASK = 4;
#define MY_EE_MAX_TASK 4
#endif

#ifndef EE_MAX_RESOURCE
const unsigned int EE_MAX_RESOURCE = 2;
#define MY_EE_MAX_RESOURCE 2
#endif
...
// see pkg/kernel/oo/lookup.c
#if defined(__BIN_DISTR_LIMITED__) || defined(__BIN_DISTR_FULL__)
/* All this WILL BE REMOVED and produced by PETHRA */
#ifdef __OO_ORTI_PRIORITY__
/* maybe these variables should be moved into the application files
   like initkern.c, since they depends on the number of
   tasks/resources */
EE_TYPEPRIO EE_ORTI_th_priority[MY_EE_MAX_TASK];
EE_TYPEPRIO EE_ORTI_resource_oldpriority[MY_EE_MAX_RESOURCE];
#endif
#endif
...
/* thread status */
EE_TYPESTATUS EE_th_status[MY_EE_MAX_TASK] = 
  {SUSPENDED, SUSPENDED, SUSPENDED, SUSPENDED};

/* next: is used for the stacked queue and for WaitEvent */
EE_TID   EE_th_next[MY_EE_MAX_TASK] =
  {EE_NIL, EE_NIL, EE_NIL, EE_NIL};     /* remaining nact */

/* priorities */
const EE_TYPEPRIO EE_th_ready_prio[MY_EE_MAX_TASK] =
  {0x01, 0x02, 0x04, 0x08};
const EE_TYPEPRIO EE_th_dispatch_prio[MY_EE_MAX_TASK] =
  {0x01, 0x02, 0x04, 0x08};

#ifndef __OO_NO_CHAINTASK__
/* The next task to be activated after a ChainTask */
EE_TID EE_th_terminate_nextask[MY_EE_MAX_TASK] = 
...
EE_TYPENACT   EE_th_rnact[MY_EE_MAX_TASK] = {1, 1, 1, 1};
...
/* remaining nact: init= maximum pending activations of a Task */
EE_TYPENACT   EE_th_rnact[MY_EE_MAX_TASK] =
  {1, 3, 1, 1};

EE_TYPEPRIO EE_rq_link[MY_EE_MAX_TASK] = {0, 1, 2, 3};
...
EE_TYPEEVENTMASK EE_th_event_active[MY_EE_MAX_TASK] =
  {0,0,0,0};      /* thread event already active */
EE_TYPEEVENTMASK EE_th_event_waitmask[MY_EE_MAX_TASK] =
  {0,0,0,0};    /* thread wait mask */

EE_TYPEBOOL EE_th_waswaiting[MY_EE_MAX_TASK] =
  {0,0,0,0};

EE_TYPEBOOL EE_th_is_extended[MY_EE_MAX_TASK] =
  {0,0,0,0};
...
const EE_TYPEPRIO   EE_resource_ceiling[MY_EE_MAX_RESOURCE] = { 0x04 };
EE_TYPEPRIO   EE_resource_oldceiling[MY_EE_MAX_RESOURCE];
...
EE_UREG EE_th_resource_last[MY_EE_MAX_TASK] = {-1, -1, -1, -1};
...
EE_UREG EE_resource_stack[MY_EE_MAX_RESOURCE] = {-1, -1};
...
*/
EE_TYPEBOOL EE_resource_locked[MY_EE_MAX_RESOURCE] = {0, 0};
#endif
