 ...
 * CVS: $Id: inithal.c,v 1.3 2006/01/17 13:17:12 pj Exp $
 */
...
const EE_ADDR EE_hal_thread_body[MY_EE_MAX_TASK] = {
...
struct EE_TOS EE_arm7_system_tos[MY_EE_MAX_TASK+1] =
{
...
EE_UREG EE_arm7_thread_tos[MY_EE_MAX_TASK+1] =
{
    0,				/* main */
    1,				/* thread0 */
    2,				/* thread1 */
...
EE_UINT32 EE_terminate_data[MY_EE_MAX_TASK];
const EE_ADDR EE_terminate_real_th_body[MY_EE_MAX_TASK] = {
    (EE_ADDR)Functhread0,
    (EE_ADDR)Functhread1,
    (EE_ADDR)Functhread2,
    (EE_ADDR)Functhread3
