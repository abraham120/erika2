...
EE_TIME profiling_overhead_time = 0;
EE_TIME tmp_profiling_time = 0;

EE_TIME first_thread_activate_time = 0;
EE_TIME second_thread_activate_time = 0;
EE_TIME thread_activate_ready_time = 0;
EE_TIME thread_activate_stacked_time = 0;
EE_TIME scheduler_ready_time = 0;
EE_TIME scheduler_stacked_time = 0;
EE_TIME end_instance_ready_time = 0;
EE_TIME end_instance_stacked_time = 0;
EE_TIME mutex_lock_time = 0;
EE_TIME mutex_unlock_stacked_time = 0;


__INLINE__ void start_profiling()
{
  tmp_profiling_time = EE_sys_gettime();
}

__INLINE__ void end_profiling(EE_TIME *variable)
{
    *variable = EE_sys_gettime();
