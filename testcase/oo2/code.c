...
/* Test Description:
   ...
   - ready priority r1<r2<r3<r4
   - dispatch priority d1=r1<d2=r2<d3=d4=r4
   ...
   - Activate into a Task (no preemption)
   - Schedule with preemption

   Thread 4 activates d3 that do not preempt until the Schedule is called...
*/
