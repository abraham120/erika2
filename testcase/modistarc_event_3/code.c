...
TASK(Task1)
{
  ...
  EE_assert(3, (TaskState=WAITING), 2);
#else
  s = GetTaskState(Task2, &TaskState);
  EE_assert(3, (s==E_OK && TaskState==WAITING), 2);
#endif

#ifndef __OO_EXTENDED_STATUS__
  GetEvent(Task2, &EventMask);
  EE_assert(4, (EventMask==0x0), 3);
#else
  s = GetEvent(Task2, &EventMask);
  EE_assert(4, (s==E_OK && EventMask==0x0), 3);
#endif
...
#ifndef __OO_EXTENDED_STATUS__
  GetTaskState(Task2, &TaskState);
  EE_assert(6, (TaskState=WAITING), 5);
#else
  s = GetTaskState(Task2, &TaskState);
  EE_assert(6, (s==E_OK && TaskState==WAITING), 5);
#endif

#ifndef __OO_EXTENDED_STATUS__
  GetEvent(Task2, &EventMask);
  EE_assert(7, (EventMask==Event2), 6);
#else
  s = GetEvent(Task2, &EventMask);
  EE_assert(7, (s==E_OK && EventMask==Event2), 6);
#endif
...
#ifndef __OO_EXTENDED_STATUS__
  GetTaskState(Task2, &TaskState);
  EE_assert(9, (TaskState=READY), 8);
#else
  s = GetTaskState(Task2, &TaskState);
  EE_assert(9, (s==E_OK && TaskState==READY), 8);
#endif

#ifndef __OO_EXTENDED_STATUS__
  GetEvent(Task2, &EventMask);
  EE_assert(10, (EventMask==(Event1|Event2)), 9);
#else
  s = GetEvent(Task2, &EventMask);
  EE_assert(10, (s==E_OK && EventMask==(Event1|Event2)), 9);
#endif
...
#else
  s = SetEvent(Task2, Event3);
  EE_assert(11, (s==E_OK), 10);
#endif

#ifndef __OO_EXTENDED_STATUS__
  GetEvent(Task2, &EventMask);
  EE_assert(12, (EventMask==(Event1|Event2|Event3)), 11);
#else
  s = GetEvent(Task2, &EventMask);
  EE_assert(12, (s==E_OK && EventMask==(Event1|Event2|Event3)), 11);
#endif
