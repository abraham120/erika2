...
FILE_LOCK = $(EE_TMPDIR)/pic30_manual.lock
...
RTDRUID_pic30 = \
	...
	echo \<rtdruid.Oil.Configurator inputfile=\"$(call native_path,$(OUTDIR_PREFIX)$*/ee.oil)\" outputdir=\"$(call native_path,$(OUTDIR_PREFIX)$*/Debug)\" /\> >> $(EE_TMPDIR)/pic30_rtdruid_partial.xml;
