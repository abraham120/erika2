...
C:\Programmi\Freescale\CWS12v5.1\Prog\hiwave.exe -Prod=%ERIKA_FILES%\testcase\common\s12\s12g_cw\PE_Multilink_CyclonePro.ini -c %ERIKA_FILES%\testcase\tmp\s12.cmd -instance=softec
