...
C:\Programmi\Freescale\CWS12v5.1\Prog\hiwave.exe -Prod=%ERIKA_FILES%\testcase\common\s12\s12xs_cosmic\SofTec_HCS12.ini -c %ERIKA_FILES%\testcase\tmp\s12.cmd -instance=softec
