 ...
 * CVS: $Id: initst10.c,v 1.2 2006/01/05 14:35:53 pj Exp $
 */
...
// (ROM)
const EE_UINT16 EE_st10_thread_cp[EE_MAX_TASK] = 
...
__IRAM__ struct EE_TOS EE_st10_system_tos[EE_MAX_TASK+1] = 
{ 
...
__IRAM__ EE_UINT16 EE_st10_thread_tos[EE_MAX_TASK+1] =
{
  (EE_UINT16)(EE_st10_system_tos),   // main
  (EE_UINT16)(EE_st10_system_tos+1),
  (EE_UINT16)(EE_st10_system_tos+2),
  (EE_UINT16)(EE_st10_system_tos+3),
  (EE_UINT16)(EE_st10_system_tos+4)
};


// RAM
__IRAM__ EE_UREG EE_hal_active_tos = (EE_UREG)EE_st10_system_tos;

// ROM
__IRAM__ EE_UREG EE_st10_IRQ_user_tos = (EE_UREG)(EE_st10_user_stack+150);
__IRAM__ EE_UREG EE_st10_IRQ_sys_tos	= 0xfa40;
