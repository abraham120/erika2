...
/**@}*/
/* USER CODE BEGIN (2) */
void pwmNotification0();
void pwmNotification1();
void pwmNotification2();
void pwmNotification3();
void pwmNotification4();
void pwmNotification5();
void pwmNotification6();
void pwmNotification7();
/* USER CODE END */
#endif
