...
/* USER CODE BEGIN (0) */
void __attribute__((weak)) pwmNotification0(void){};
void __attribute__((weak)) pwmNotification1(void){};
void __attribute__((weak)) pwmNotification2(void){};
void __attribute__((weak)) pwmNotification3(void){};
void __attribute__((weak)) pwmNotification4(void){};
void __attribute__((weak)) pwmNotification5(void){};
void __attribute__((weak)) pwmNotification6(void){};
void __attribute__((weak)) pwmNotification7(void){};
/* USER CODE END */

/*----------------------------------------------------------------------------*/
/* Global variables                                                           */
static const uint32 s_pwmPolarity[8] =
{
    3U,
    3U,
    3U,
...
/** @var static const hetINSTRUCTION_t hetPROGRAM[58]
*   @brief Default Program
*
*   Het program running after initialization.
*/

static const hetINSTRUCTION_t hetPROGRAM[] =
{
    /* CNT: Timebase
    *       - Instruction                  = 0
    *       - Next instruction             = 1
...
*
*   This function initializes the het module.
*/
void hetInit(void)
{
    /** @b initialize @b HET */
...
/* USER CODE END */
 ...
 /** - Release from reset */
    ...
    */
    hetREG->INTENAC = 0xFFFFFFFFU;
    hetREG->INTENAS = 0x00000000U
                    | 0x00000000U
                    | 0x00000000U
                    | 0x00000000U
                    | 0x00000000U
...
/** @fn void pwmSetDuty(uint32 pwm, uint32 pwmDuty)
...
void pwmSetDuty(uint32 pwm, uint32 pwmDuty)
{
    ...
    if (pwmDuty == 0U)
    {
        action = (s_pwmPolarity[pwm] == 3U) ? 0U : 2U;
    }
    else if (pwmDuty >= 100U)
    {
        action = (s_pwmPolarity[pwm] == 3U) ? 2U : 0U;
    }
    else
    {
        action = s_pwmPolarity[pwm];
    }
...
/** @fn void pwmSetSignal(uint32 pwm, hetSIGNAL_t signal)
*   @brief Set period
*   @param[in] pwm Pwm signal:
*              - pwm0: Pwm 0
*              - pwm1: Pwm 1
...
void pwmSetSignal(uint32 pwm, hetSIGNAL_t signal)
{
    uint32 action;
    uint32 pwmPeriod;
        pwmPeriod  = (uint32)((signal.period * 1000.0) / 800.000) << 7U;
...
/** @fn hetSIGNAL_t pwmGetSignal(uint32 pwm)
...
hetSIGNAL_t pwmGetSignal(uint32 pwm)
{
    ...
    signal.period = ((pwmPeriod >> 7U) * 800.000) / 1000.0;

    return signal;
}


/** @fn void pwmEnableNotification(uint32 pwm, uint32 notification)
...
/** @fn void pwmDisableNotification(uint32 pwm, uint32 notification)
*   @brief Enable pwm notification
*   @param[in] pwm Pwm signal:
*              - pwm0: Pwm 0
*              - pwm1: Pwm 1
...
/** @fn void edgeResetCounter(uint32 edge)
...
/** @fn uint32 edgeGetCounter(uint32 edge)
...
/** @fn void edgeEnableNotification(uint32 edge)
...
/** @fn void edgeDisableNotification(uint32 edge)
*   @brief Enable edge notification
*   @param[in] edge Edge signal:
*              - edge0: Edge 0
*              - edge1: Edge 1
...
/** @fn hetSIGNAL_t capGetSignal(uint32 cap)
...
/** @fn void hetResetTimestamp(void)
...
/** @fn uint32 hetGetTimestamp(void)
...
/** @fn void hetHighLevelInterrupt(void)
*   @brief High Level Interrupt for HET
*/

void hetHighLevelInterrupt(void)
{
    uint32 vec = hetREG->OFF1;

    if (vec < 18U)
    {
        if ((vec & 1U) != 0U)
        {
            pwmNotification((vec >> 1U) - 1U, pwmEND_OF_PERIOD);
        }
        else
        {
    ...
    {
        edgeNotification(vec - 18U);
    }
}


/** @fn void hetLowLevelInterrupt(void)
*   @brief Pwm Interrupt
*/

void hetLowLevelInterrupt(void)
{
    uint32 vec = hetREG->OFF2;
