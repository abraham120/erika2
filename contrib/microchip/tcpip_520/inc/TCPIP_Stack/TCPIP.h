...
#include "HardwareProfile.h"
		...
		#define MTCP_TIMER_REG_CON T4CON
		#define MTCP_TIMER_REG_CONbits T4CONbits
		#define MTCP_TIMER_REG_TMR TMR4
		#define MTCP_TIMER_REG_PERIOD PR4
		#define MTCP_TIMER_INTERRUPT_NAME _T4Interrupt
	#if defined(__C30__)
		#define MTCP_TIMER_INTERRUPT_FLAG IFS1bits.T4IF
		#define MTCP_TIMER_INTERRUPT_PRIORITY IPC6bits.T4IP
		#define MTCP_TIMER_INTERRUPT_FLAG_RESET() IFS1bits.T4IF = 0
		#define MTCP_TIMER_INTERRUPT_SET_ENABLED() IEC1bits.T4IE = 1
		#define MTCP_TIMER_INTERRUPT_SET_DISABLED() IEC1bits.T4IE = 0
	#elif defined(__PIC32MX__)
		#define MTCP_TIMER_INTERRUPT_FLAG IFS0bits.T4IF
		#define MTCP_TIMER_INTERRUPT_PRIORITY IPC4bits.T4IP
		#define MTCP_TIMER_INTERRUPT_FLAG_RESET() IFS0CLR = _IFS0_T4IF_MASK
		#define MTCP_TIMER_INTERRUPT_SET_ENABLED() IEC0SET = _IEC0_T4IE_MASK
		#define MTCP_TIMER_INTERRUPT_SET_DISABLED() IEC0CLR = _IEC0_T4IE_MASK
		#define MTCP_TIMER_INTERRUPT_VECTOR _TIMER_4_VECTOR
	#endif
#endif
