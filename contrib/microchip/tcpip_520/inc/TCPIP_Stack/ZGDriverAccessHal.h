...
/* zgHalIsEinitDisabled - used by the ZG Driver to test for whether */
/* external interrupts are disabled */
tZGBool zgHalIsEintDisabled(tZGVoidInput);

/* zgHalIsEinitPending - used by the ZG Driver to test for whether */
...
/* asserted but the ZG_EINT_IF bit is not set, thus, no interrupt generated */
