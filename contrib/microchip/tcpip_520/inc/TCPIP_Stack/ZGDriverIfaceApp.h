...
#define kZGBssInfra        (1u)    /* infrastructure only bss */
#define kZGBssAdHoc        (2u)    /* Ad-hoc only Bss (ibss) */
#define kZGBssAny          (3u)    /* any BSS infrastructure or independant (Ad-Hoc) */
