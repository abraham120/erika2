...
%WF_USE_DATA_TX_RX_FUNCTIONS%#define WF_USE_DATA_TX_RX_FUNCTIONS
...
/*====================================================================================*/
%WF_CONSOLE%#define WF_CONSOLE              /* needed for console demo */
%WF_CONSOLE%#define WF_CONSOLE_IFCFGUTIL    /* needed for console demo */


/*--------------------------------------------*/
/* Default settings for Connection Management */
/*--------------------------------------------*/
#define MY_DEFAULT_SSID_NAME                %MY_DEFAULT_SSID_NAME%

#define MY_DEFAULT_NETWORK_TYPE             %MY_DEFAULT_NETWORK_TYPE%   /* WF_INFRASTRUCTURE or WF_ADHOC     */
...
%USE_MRF24W_HOST_BUFFER%#define USE_MRF24W_HOST_BUFFER

%STACK_USE_EZ_CONFIG%#define STACK_USE_EZ_CONFIG
%STACK_USE_EZ_CONFIG%#define EZ_CONFIG_SCAN
%STACK_USE_EZ_CONFIG%#define EZ_CONFIG_STALL
%STACK_USE_EZ_CONFIG%#define EZ_CONFIG_STORE
