#ifndef HV7131GP_HAL_EE_BOARD_SINGLE_128K_H
#define HV7131GP_HAL_EE_BOARD_SINGLE_128K_H
...
#define HV7131GP_I2C_PORT 	EE_I2C_PORT_2
#endif
...
do { 										\
	INTCONbits.INT0EP = 1;	/*  Extern Interrupt on positive edge */	\
	IPC0bits.INT0IP  = 7;	/*  Set INT0 interrupt priority */		\
} while (0)									\

#define HV7131GP_PIN_VSYNC_INIT_NEGATIVE()					\
do { 										\
	INTCONbits.INT0EP = 0;	/*  Extern Interrupt on negative edge */	\
	IPC0bits.INT0IP  = 7;	/*  Set INT0 interrupt priority */		\
} while (0)									\
...
#define HV7131GP_VSYNC_IF_VALUE	IFS0bits.INT0IF /*  Return INT0 interrupt flag value*/


#define HV7131GP_VSYNC_INTERRUPT()  ISR1(_EXTERNAL_0_VECTOR)
...
#endif // HV7131GP_HAL_EE_BOARD_SINGLE_128K_H
