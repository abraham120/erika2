...
#include "SystemProfile.h"
    ...
    */
     ...
     *
     * Overview:        This function initialize MRF24J40 transceiver
     *
     * PreCondition:    Communication port to the MRF24J40 initialized
     *
     * Input:           none
     ...
     * Output:          none
     *
     * Side Effects:    MRF24J40 transceiver is initialized
     *
     ********************************************************************/
    void InitMRF24J40(void)
    {
     ...
     ********************************************************************/
        ...
        //GF void _ISRFAST __attribute__((interrupt, auto_psv)) _INT1Interrupt(void)
        void mrf24j40_isr(void) /* This function is called by a task in
									the application file of Erika. Usually, its
									code.c
								*/
    #elif defined(__PIC32MX__)
