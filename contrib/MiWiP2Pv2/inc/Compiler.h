 ...
 * Yifeng Yang          04/15/2009  MiMAC and MiApp revision
...
#if defined(__PIC24FJ32GA004__) && !defined(C30)
#define __PIC24F__
#endif
//End GF
    ...
    // (HardwareProfile.h)
    	...
    	// PIC24F processor
		#include "ee_pic30regs.h" //#include "p24Fxxxx.h"
    	#define INSTR_FREQ			(CLOCK_FREQ/2)
    #elif defined(__PIC24H__)	// Microchip C30 compiler
    	// PIC24H processor
    	#include "ee_pic30regs.h" //#include <p24Hxxxx.h>
    	#define INSTR_FREQ			(CLOCK_FREQ/2)
    #elif defined(__dsPIC33F__)	// Microchip C30 compiler
    	// dsPIC33F processor
		#if defined(C30) //Start GF
			#include "ee_pic30regs.h" //#include <p33Fxxxx.h>
		#endif //End GF
		#define INSTR_FREQ			(CLOCK_FREQ/2)
    #elif defined(__dsPIC30F__)	// Microchip C30 compiler
    	// dsPIC30F processor
    	#include "ee_pic30regs.h" //#include <p30fxxxx.h>
    	#define INSTR_FREQ			(CLOCK_FREQ/4)
