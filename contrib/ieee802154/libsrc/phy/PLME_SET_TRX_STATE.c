...
* CVS: 
*
* $Id: PLME_SET_TRX_STATE.c,v 1.3 2008/07/04 09:47:25 chris Exp $
* $Log: PLME_SET_TRX_STATE.c,v $
...
#include "phy/PLME_SET_TRX_STATE.h"

EE_UINT8 PLME_SET_TRX_STATE_request(EE_UINT8 state)
{
