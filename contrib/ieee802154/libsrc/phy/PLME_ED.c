...
* CVS: 
*
* $Id: PLME_ED.c,v 1.2 2008/07/04 09:47:25 chris Exp $
* $Log: PLME_ED.c,v $
...
#include "phy/PLME_ED.h"

EE_UINT8 PLME_ED_request()
{
return 1;
}

EE_UINT8 PLME_ED_confirm(EE_UINT8 status,EE_UINT8 EnergyLevel)
{
return 1;
}
