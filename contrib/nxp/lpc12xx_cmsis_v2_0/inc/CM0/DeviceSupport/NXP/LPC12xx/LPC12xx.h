/**************************************************************************//**
 * $Id: LPC12xx.h 7535 2011-06-09 09:13:16Z cnh20509 $
 *
 * @file     LPC12xx.h
...
/** @addtogroup LPC12xx_ACOMP LPC12xx Analog Comparator 
  @{
*/
typedef struct
{
...
typedef struct
{
  ...
  union{
  __I  uint32_t GPREG[4];				/*!< Offset: 0x004-0x010 General purpose Registers (R/W)*/
  struct{
  ...
  __IO uint32_t SYSCFG; 	            /*!< Offset: System configuration register (R/W) */
} LPC_PMU_TypeDef;
...
/*------------- Timer (TMR) --------------------------------------------------*/
/** @addtogroup LPC_CTxxBx LPC12xx 16/32-bit Counter/Timer 
  @{
*/
typedef struct
{
  ...
  __IO uint32_t MCR;                    /*!< Offset: 0x014 Match Control Register (R/W) */
    union {
  __IO uint32_t MR[4];                 /*!< Offset: 0x018-0x024 (R/W)  Match Registers */
  struct
  {
  ...
  __IO uint32_t CCR;                    /*!< Offset: 0x028 Capture Control Register (R/W) */
    union{
  __I  uint32_t CR[4];					/*!< Offset: 0x02C-0x038 Capture Registers (R/ )*/
  struct{
...
/** @addtogroup LPC12xx_UART0 LPC12xx Universal Asynchronous Receiver/Transmitter0 
  @{
*/
typedef struct
{
  ...
  __IO uint32_t  THR;               /*!< Offset: 0x000 Transmit Holding Register ( /W) */             
...
/*@}*/ /* end of group LPC12xx_UART0 */

/** @addtogroup LPC12xx_UART1 LPC12xx Universal Asynchronous Receiver/Transmitter1
  @{
*/
typedef struct
{
...
typedef struct
{
  ...
  union{  
  __IO uint32_t MASK[4];                /*!< Offset: 0x030 I2C Slave address mask register. */
  struct{
...
/** @addtogroup LPC12xx_WDT LPC12xx Windowed WatchDog Timer 
  @{
*/
typedef struct
{
...
typedef struct
{
  ...
  struct{
  __IO uint32_t DR0;					/*!< Offset: 0x010 A/D Channel Register 0 (R/W) */
  __IO uint32_t DR1;					/*!< Offset: 0x014 A/D Channel Register 1 (R/W) */
  __IO uint32_t DR2;					/*!< Offset: 0x018 A/D Channel Register 2 (R/W) */
  __IO uint32_t DR3;					/*!< Offset: 0x01C A/D Channel Register 3 (R/W) */
  __IO uint32_t DR4;					/*!< Offset: 0x020 A/D Channel Register 4 (R/W) */
  __IO uint32_t DR5;					/*!< Offset: 0x024 A/D Channel Register 5 (R/W) */
  __IO uint32_t DR6;					/*!< Offset: 0x028 A/D Channel Register 6 (R/W) */
  __IO uint32_t DR7;					/*!< Offset: 0x02C A/D Channel Register 7 (R/W) */
  };
  };
...
#define LPC_ACOMP_BASE        (LPC_APB0_BASE + 0x54000)
...
#define LPC_WDT               ((LPC_WWDT_TypeDef   *) LPC_WWDT_BASE  )
...
#define LPC_ACOMP             ((LPC_ACOMP_TypeDef  *) LPC_ACOMP_BASE)
