/**************************************************************************//**
 * $Id: lpc12xx_iocon.h 7535 2011-06-09 09:13:16Z cnh20509 $
 *
...
/**
  ...
  * @{
  */
#define IOCON_PIO_DRV_LOW     ((uint16_t)0x0000  )   /* Drive current */
#define IOCON_PIO_DRV_HIGH    ((uint16_t)0x1000  )   /* Drive current */

#define PARAM_IOCON_PIO_DRV(hys)    ((  hys == IOCON_PIO_DRV_LOW)|| \
                                     (  hys == IOCON_PIO_DRV_HIGH))
/**
  * @}
  */
