/**************************************************************************//**
 * $Id: system_LPC12xx.c 7535 2011-06-09 09:13:16Z cnh20509 $
 *
 ...
 *
 * @Change history [Remove when release]
 * 2011-01-25 11:33 , Roger: 
 * (1) Modified "Select RTC clock source" configuration wizard value
 * (2) Modified RTC clock configuration process (see #if (RTCCLK_SETUP) )
 ******************************************************************************/
...
//                     <i> 0 = is disabled
//   <o14.0..7> Select RTC PCLK Divider <0-255> 
//                     <i> 0 = is disabled
//   <e15> PMU SYSCFG Setup
//      <o16.10> WAKEUP pin hysteresis
//                     <0=> DISABLED
//                     <1=> ENABLED
//      <o16.11..14> Select RTC clock source
//                     <0=> RTC Oscillator 1 Hz
//                     <1=> RTC Oscillator delayed 1 Hz
//                     <10=> RTC Oscillator 1 KHz
//                     <4=> RTC PCLK
//   </e15>
//   <e17> CLKOUT Clock Setup
//      <o18.0..2> Select CLKOUT clock source
//                     <0=> IRC Oscillator
//                     <1=> System Oscillator
//                     <2=> WDT Oscillator
//                     <3=> Main clock
//      <o19.0..7> Select CLKOUT PCLK Divider <0-255> 
//                     <i> 0 = Gate
//   </e17>
// </e>
*/
...
void SystemInit (void)
{
...
#if 1
  /* Below lines are for debugging only. For future release, WDT is 
  ...
  during debugging. */
  LPC_WDT->MOD = 0x00;  	/* Disable the WDT */
