/**************************************************************************//**
 * $Id: lpc12xx_timer16.c 7535 2011-06-09 09:13:16Z cnh20509 $
 *
...
/**
  ...
  */
IntStatus TIM16_GetIntStatus(LPC_CTxxBx_TypeDef *TIMx, uint8_t IntFlag)
{
    uint8_t temp;
...
uint32_t TIM16_GetIntStatusReg(LPC_CTxxBx_TypeDef *TIMx)
{
    return (TIMx->IR);
}
...
/**
  ...
  * @retval None
  */
void TIM16_ClearIntPendingBit(LPC_CTxxBx_TypeDef *TIMx, uint8_t IntFlag)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
    CHECK_PARAM(PARAM_TIM16_INT_TYPE(IntFlag));
...
/**
  ...
  *
  */
void TIM16_DeInit(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  */
void TIM16_Init(LPC_CTxxBx_TypeDef *TIMx, uint8_t TimerCounterMode, void *TIM16_InitStruct)
{
...
/**
  ...
  *
  */
void TIM16_ConfigMatch(LPC_CTxxBx_TypeDef *TIMx, TIM16_MATCHTypeDef *TIM16_MatchConfigStruct)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  *
  */
void TIM16_ConfigCapture(LPC_CTxxBx_TypeDef *TIMx, TIM16_CAPTURETypeDef *TIM16_CaptureConfigStruct)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  *
  */
void TIM16_ConfigPWM(LPC_CTxxBx_TypeDef *TIMx, TIM16_PWMTypeDef *TIM16_PWMConfigStruct)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  *
  */
void TIM16_Cmd(LPC_CTxxBx_TypeDef *TIMx, FunctionalState NewState)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  */
void TIM16_ResetCounter(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  *
  */
uint32_t TIM16_GetTCValue(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  *
  */
uint32_t TIM16_GetCaptureValue(LPC_CTxxBx_TypeDef *TIMx, uint8_t CaptureChannel)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  *
  */
void TIM16_ClearPWMOuptut(LPC_CTxxBx_TypeDef *TIMx, uint8_t PWMChannel)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
...
/**
  ...
  */
void TIM16_ClearAllPWM(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM16x(TIMx));
