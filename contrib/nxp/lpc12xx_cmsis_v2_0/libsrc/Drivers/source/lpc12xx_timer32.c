/**************************************************************************//**
 * $Id: lpc12xx_timer32.c 7535 2011-06-09 09:13:16Z cnh20509 $
 *
...
/**
  ...
  *             @arg LPC_CT32B0: timer/counter CT32B0
  *             @arg LPC_CT32B1: timer/counter CT32B1
  ...
  */
IntStatus TIM32_GetIntStatus(LPC_CTxxBx_TypeDef *TIMx, uint8_t IntFlag)
{
    uint8_t temp;
...
uint32_t TIM32_GetIntStatusReg(LPC_CTxxBx_TypeDef *TIMx)
{
    return (TIMx->IR);
}
...
/**
  ...
  * @retval None
  */
void TIM32_ClearIntPendingBit(LPC_CTxxBx_TypeDef *TIMx, uint8_t IntFlag)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
    CHECK_PARAM(PARAM_TIM32_INT_TYPE(IntFlag));
...
/**
  ...
  *
  */
void TIM32_DeInit(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  */
void TIM32_Init(LPC_CTxxBx_TypeDef *TIMx, uint8_t TimerCounterMode, void *TIM32_InitStruct)
{
...
/**
  ...
  *
  */
void TIM32_ConfigMatch(LPC_CTxxBx_TypeDef *TIMx, TIM32_MATCHTypeDef *TIM32_MatchConfigStruct)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  *
  */
void TIM32_ConfigCapture(LPC_CTxxBx_TypeDef *TIMx, TIM32_CAPTURETypeDef *TIM32_CaptureConfigStruct)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  *
  */
void TIM32_ConfigPWM(LPC_CTxxBx_TypeDef *TIMx, TIM32_PWMTypeDef *TIM32_PWMConfigStruct)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  *
  */
void TIM32_Cmd(LPC_CTxxBx_TypeDef *TIMx, FunctionalState NewState)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  * @param  TIMx: Pointer to specified timer/counter. TIMx Timer selection.
  *         This parameter can be one of the following values:
  *             @arg LPC_CT16B0: timer/counter CT16B0
  *             @arg LPC_CT16B1: timer/counter CT16B1
  *             @arg LPC_CT32B0: timer/counter CT32B0
  *             @arg LPC_CT32B1: timer/counter CT32B1
  * @retval None
  *
  ...
  */
void TIM32_ResetCounter(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  *
  */
uint32_t TIM32_GetTCValue(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  *
  */
uint32_t TIM32_GetCaptureValue(LPC_CTxxBx_TypeDef *TIMx, uint8_t CaptureChannel)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
...
/**
  ...
  *
  */
void TIM32_ClearPWMOuptut(LPC_CTxxBx_TypeDef *TIMx, uint8_t PWMChannel)
{
...
/**
  ...
  */
void TIM32_ClearAllPWM(LPC_CTxxBx_TypeDef *TIMx)
{
    CHECK_PARAM(PARAM_TIM32x(TIMx));
