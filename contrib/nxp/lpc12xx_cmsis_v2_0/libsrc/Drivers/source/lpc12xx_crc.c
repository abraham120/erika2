/**************************************************************************//**
 * $Id: lpc12xx_crc.c 7535 2011-06-09 09:13:16Z cnh20509 $
 *
 * @file    lpc12xx_crc.c
...
#define LPC_MYCRC   (LPC_MYCRC_TypeDef *)LPC_CRC_BASE;
...
void CRC_WriteData( uint8_t * data, uint8_t bitlen )
{
    ...
    {
        case 32:
        	LPC_MYCRC->WR_DATA_DWORD = *data_dword;
        	break;
        case 16:
        	LPC_MYCRC->WR_DATA_WORD = *data_word;
        	break;
        case 8:
       		LPC_MYCRC->WR_DATA_BYTE = *data;
        	break;
        default:
        	break;
    }
