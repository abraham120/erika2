...
/** 
	@file flex_daughter_therm.c
	@author Roberto Bucher, SUPSI- Lugano (linux3.dti.supsi.ch/~bucher)
	@author Simone Mannori, ScicosLab developer (www.scicos.org, www.scicoslab.org)
	@date 2006-2010
*/  
