 ...
 *  R4.0 Rev 2
 */
#define	WDG_IWDT_MODULE_ID	102

#define	WDG_IWDT_SW_MAJOR_VERSION	1 /**< Software Version Major Number  */
#define	WDG_IWDT_SW_MINOR_VERSION	0 /**< Software Version Minor Number  */
#define	WDG_IWDT_SW_PATCH_VERSION	0 /**< Software Version Patch Number  */

#define	WDG_IWDT_AR_MAJOR_VERSION	4 /**< AUTOSAR Version Major Number   */
#define	WDG_IWDT_AR_MINOR_VERSION	0 /**< AUTOSAR Version Minor Number   */
#define	WDG_IWDT_AR_PATCH_VERSION	2 /**< AUTOSAR Version Patch Number   */
 ...
 *  configured.
 *
 *  The notifications callback <tt>Wdg_IWDT_Notification()</tt> shall be
 ...
 */
typedef void (*Wdg_IWDT_Notification)(void);

/*
 * Wdg_IWDT.h shall include Wdg_IWDT_Cfg.h.
 */
#include "Wdg_IWDT_Cfg.h"
 ...
 *  			(<tt>BSW00414</tt>)
 */
extern const Wdg_IWDT_ConfigType	Wdg_IWDT_Config[];

/** @brief	IWDT WDG Driver Initialization
 ...
 *
 *  <b>WDG001</b>:	The <tt>Wdg_IWDT_Init()</tt> function shall initialize
 *  			the WdgIWDT module and the watchdog hardware, i.e. it
 ...
 *  		configuration set to be used with the <tt>Wdg_IWDT_Init()</tt>
 *  		function from a limited number of statically configured sets
 *  		(see also <tt>BSW00314</tt>).
 *
 *  <b>WDG100</b>:	The <tt>Wdg_IWDT_Init()</tt> function shall initialize
 *  			all global variables of the Wdg_IWDT module and set the
 *  			default watchdog mode and initial timeout period.
 *  			(<tt>BSW12057</tt>, <tt>BSW12125</tt>,
 *  			<tt>BSW12461</tt>, <tt>BSW12105</tt>)
 *
 *  <b>WDG101</b>:	The <tt>Wdg_IWDT_Init()</tt> function shall initialize
 ...
 *  			disables the watchdog, the <tt>Wdg_IWDT_Init()</tt>
 ...
 *
 *  <b>WDG173</b>:	If switching the Wdg_IWDT module and the watchdog
 ...
 *  			Wdg_IWDT module: The <tt>Wdg_IWDT_Init()</tt>
 ...
 *  			function <tt>Wdg_IWDT_Init()</tt> shall not execute
 ...
 *  			Wdg_IWDT module: The <tt>Wdg_IWDT_Init()</tt>
 *  			function shall set the Wdg_IWDT module's internal state
 ...
 *
 *  <b>WDG160</b>:	The function <tt>Wdg_IWDT_SetMode()</tt> shall switch
 ...
 *  			watchdog, different timeout periods) the Wdg_IWDT
 ...
 *
 *  <b>WDG051</b>:	The configuration set provided to the Wdg_IWDT module's
 ...
 *
 *  <b>WDG145</b>:	The <tt>Wdg_IWDT_SetMode()</tt> function shall reset
 ...
 *
 *  <b>WDG103</b>:	The <tt>Wdg_IWDT_SetMode()</tt> function shall return
 *  			<tt>E_OK</tt> if the mode switch has been executed
 *  			completely and successfully, i.e. all parameters of the
 *  			Wdg_IWDT module and the watchdog hardware have been set
 *  			to the new values.
 *
 *  <b>WDG016</b>:	If switching the Wdg_IWDT module and the watchdog
 *  			hardware into the requested mode is not possible, e.g.
 *  			because of inconsistent mode settings or because some
 *  			timing constraints have not been met, the
 *  			<tt>Wdg_IWDT_SetMode()</tt> function shall return the
 ...
 *  			<tt>Wdg_IWDT_SetMode()</tt> function shall check
 ...
 *  			Wdg_IWDT module: The <tt>Wdg_IWDT_SetMode()</tt>
 ...
 *  			Wdg_IWDT module: The <tt>Wdg_IWDT_SetMode()</tt>
 *  			function shall check that the Wdg_IWDT module's state
 *  			is <tt>WDG_IDLE</tt> (meaning the Wdg_IWDT module and
 ...
 *  			Wdg_IWDT module: The <tt>Wdg_IWDT_SetMode()</tt>
 *  			function shall set the Wdg_IWDT module's state to
 *  			<tt>WDG_BUSY</tt> during its execution (indicating, that
 *  			the module is busy) and shall reset the Wdg_IWDT
 ...
 *
 *  <b>WDG136</b>:	The function <tt>Wdg_IWDT_SetTriggerCondition()</tt>
 ...
 *  			module: The function
 *  			<tt>Wdg_IWDT_SetTriggerCondition()</tt> shall check
...
#if	( WDG_IWDT_VERSION_INFO_API == STD_ON )
 ...
 *
 *  <b>WDG067</b>:	The <tt>Wdg_IWDT_GetVersionInfo()</tt> function shall
 ...
 *
 *  <b>WDG068</b>:	The <tt>Wdg_IWDT_GetVersionInfo()</tt> function shall
 ...
 *  			<tt>Wdg_IWDT_GetVersionInfo()</tt> function is
 *  			available, the module Wdg_IWDT should realize this
 *  			function as a macro, defined in the module's header
 *  			file.
 *
 *  <b>WDG174</b>:	If DET is enabled for the Wdg_IWDT Driver module, the
 *  			function <tt>Wdg_IWDT_GetVersionInfo()</tt> shall
...
#define	Wdg_IWDT_GetVersionInfo(_vi)	STD_GET_VERSION_INFO(_vi,WDG_IWDT) \
	else \
	{\
		Det_ReportError(\
			WDG_MODULE_ID,\
...
#else
#define	Wdg_IWDT_GetVersionInfo(_vi)	STD_GET_VERSION_INFO(_vi,WDG_IWDT)
#endif	/* WDG_IWDT_DEV_ERROR_DETECT */
#endif	/* WDG_IWDT_VERSION_INFO_API */
