 ...
 *  definitions for Renesas RX200 (r5f5210x) and CCRX compiler.
 *
 ...
 * Copyright (C) 2003 (2004-2011)
 * Renesas Electronics Corporation., Renesas Solutions Corporation.
 * and Renesas Electronics Europe Limited. All rights reserved.
 * 
 * Tool Version Numbers:
 * Toolchain:		RX 	Version: V.1.02.00.000
 * Toolchain Path:	C:Renesas\Hew\Tools\Renesas\RX\1_2_0
 * C Compiler:		ccrx.exe	V.1.02.00.000 [Evaluation]
 * Assembler:		asrx.exe	V.1.02.00.000 [Evaluation]
 * Linker/Locator:	optln.exe	V.1.02.00.000 [Evaluation]
 * Librarian:		lbgrx.Exe	V.1.02.00.000 [Evaluation]
 */
