 ...
 *  macros defined in Compiler.h for Renesas RX210R5F5210x and
 *  CCRX compiler.
 *
...
#define	WDG_SYSCLK_CODE
#define	WDG_SYSCLK_CONST
#define	WDG_SYSCLK_APPL_DATA
#define	WDG_SYSCLK_APPL_CONST
#define	WDG_SYSCLK_APPL_CODE
#define	WDG_SYSCLK_CALLOUT_CODE
#define	WDG_SYSCLK_VAR_NOINIT
#define	WDG_SYSCLK_VAR_POWER_ON_INIT
#define	WDG_SYSCLK_VAR_FAST
#define	WDG_SYSCLK_VAR
