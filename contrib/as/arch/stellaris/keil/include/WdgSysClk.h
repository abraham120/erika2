...
/** @file	WdgSysClk.h
 *  @brief	System Clock AUTOSAR WDG (Watchdog) Driver Header File.
 *
 ...
 *  R4.0 Rev 2
 */
#define	WDG_SYSCLK_MODULE_ID	102

#define	WDG_SYSCLK_SW_MAJOR_VERSION	1 /**< Software Version Major Number  */
#define	WDG_SYSCLK_SW_MINOR_VERSION	0 /**< Software Version Minor Number  */
#define	WDG_SYSCLK_SW_PATCH_VERSION	0 /**< Software Version Patch Number  */

#define	WDG_SYSCLK_AR_MAJOR_VERSION	4 /**< AUTOSAR Version Major Number   */
#define	WDG_SYSCLK_AR_MINOR_VERSION	0 /**< AUTOSAR Version Minor Number   */
#define	WDG_SYSCLK_AR_PATCH_VERSION	2 /**< AUTOSAR Version Patch Number   */
 ...
 *  configured.
 *
 *  The notifications callback <tt>Wdg_SysClk_Notification()</tt> shall be
 ...
 */
typedef void (*Wdg_SysClk_Notification)(
  void
);

/*
 * WdgSysClk.h shall include Wdg_SysClkCfg.h.
 */
#include "Wdg_SysClkCfg.h"
 ...
 *  			(<tt>BSW00414</tt>)
 */
extern const Wdg_SysClk_ConfigType	Wdg_SysClk_Config[];

/** @brief	SysClk WDG Driver Initialization
 ...
 *
 *  <b>WDG001</b>:	The <tt>Wdg_SysClk_Init()</tt> function shall initialize
 *  			the WdgSysClk module and the watchdog hardware, i.e. it
 ...
 *  		configuration set to be used with the <tt>Wdg_SysClk_Init()</tt>
 *  		function from a limited number of statically configured sets
 *  		(see also <tt>BSW00314</tt>).
 *
 *  <b>WDG100</b>:	The <tt>Wdg_SysClk_Init()</tt> function shall initialize
 *  			all global variables of the WdgSysClk module and set the
 *  			default watchdog mode and initial timeout period.
 *  			(<tt>BSW12057</tt>, <tt>BSW12125</tt>,
 *  			<tt>BSW12461</tt>, <tt>BSW12105</tt>)
 *
 *  <b>WDG101</b>:	The <tt>Wdg_SysClk_Init()</tt> function shall initialize
 ...
 *  			disables the watchdog, the <tt>Wdg_SysClk_Init()</tt>
 ...
 *
 *  <b>WDG173</b>:	If switching the WdgSysClk module and the watchdog
 ...
 *  			WdgSysClk module: The <tt>Wdg_SysClk_Init()</tt>
 ...
 *  			function <tt>Wdg__SysClk_Init()</tt> shall not execute
 ...
 *  			WdgSysClk module: The <tt>Wdg_SysClk_Init()</tt>
 *  			function shall set the WdgSysClk module's internal state
 ...
 *
 *  <b>WDG160</b>:	The function <tt>Wdg_SysClk_SetMode()</tt> shall switch
 ...
 *  			watchdog, different timeout periods) the WdgSysClk
 ...
 *
 *  <b>WDG051</b>:	The configuration set provided to the WdgSysClk module's
 ...
 *
 *  <b>WDG145</b>:	The <tt>Wdg_SysClk_SetMode()</tt> function shall reset
 ...
 *
 *  <b>WDG103</b>:	The <tt>Wdg_SysClk_SetMode()</tt> function shall return
 *  			<tt>E_OK</tt> if the mode switch has been executed
 *  			completely and successfully, i.e. all parameters of the
 *  			WdgSysClk module and the watchdog hardware have been set
 *  			to the new values.
 *
 *  <b>WDG016</b>:	If switching the WdgSysClk module and the watchdog
 *  			hardware into the requested mode is not possible, e.g.
 *  			because of inconsistent mode settings or because some
 *  			timing constraints have not been met, the
 *  			<tt>Wdg_SysClk_SetMode()</tt> function shall return the
 ...
 *  			<tt>Wdg_SysClk_SetMode()</tt> function shall check
 ...
 *  			WdgSysClk module: The <tt>Wdg_SysClk_SetMode()</tt>
 ...
 *  			WdgSysClk module: The <tt>Wdg_SysClk_SetMode()</tt>
 *  			function shall check that the WdgSysClk module's state
 *  			is <tt>WDG_IDLE</tt> (meaning the WdgSysClk module and
 ...
 *  			WdgSysClk module: The <tt>Wdg_SysClk_SetMode()</tt>
 *  			function shall set the WdgSysClk module's state to
 *  			<tt>WDG_BUSY</tt> during its execution (indicating, that
 *  			the module is busy) and shall reset the WdgSysClk
 ...
 *
 *  <b>WDG136</b>:	The function <tt>Wdg_SysClk_SetTriggerCondition()</tt>
 ...
 *  			module: The function
 *  			<tt>Wdg_SysClk_SetTriggerCondition()</tt> shall check
...
#if	( WDG_SYSCLK_VERSION_INFO_API == STD_ON )
 ...
 *
 *  <b>WDG067</b>:	The <tt>Wdg_SysClk_GetVersionInfo()</tt> function shall
 ...
 *
 *  <b>WDG068</b>:	The <tt>Wdg_SysClk_GetVersionInfo()</tt> function shall
 ...
 *  			<tt>Wdg_SysClk_GetVersionInfo()</tt> function is
 *  			available, the module WdgSysClk should realize this
 *  			function as a macro, defined in the module's header
 *  			file.
 *
 *  <b>WDG174</b>:	If DET is enabled for the WdgSysClk Driver module, the
 *  			function <tt>Wdg_SysClk_GetVersionInfo()</tt> shall
 *  			raise <tt>WDG_E_PARAM_POINTER</tt>, if the argument is a
 *  			<tt>NULL</tt> pointer and return without any action.
 */
#if ( WDG_SYSCLK_DEV_ERROR_DETECT == STD_ON )
#define	Wdg_SysClk_GetVersionInfo(_vi)	STD_GET_VERSION_INFO(_vi,WDG_SYSCLK) \
	else \
	{\
		Det_ReportError(\
			WDG_MODULE_ID,\
...
#else
#define	Wdg_SysClk_GetVersionInfo(_vi)	STD_GET_VERSION_INFO(_vi,WDG_SYSCLK)
#endif	/* WDG_SYSCLK_DEV_ERROR_DETECT */
#endif	/* WDG_SYSCLK_VERSION_INFO_API */
