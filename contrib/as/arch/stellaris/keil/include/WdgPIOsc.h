...
/** @file	WdgPIOsc.h
 *  @brief	Precision Internal Oscillator AUTOSAR WDG (Watchdog) Driver
 *  		Header File.
 *
 ...
 *  R4.0 Rev 2
 */
#define	WDG_PIOSC_MODULE_ID	102

#define	WDG_PIOSC_SW_MAJOR_VERSION	1 /**< Software Version Major Number  */
#define	WDG_PIOSC_SW_MINOR_VERSION	0 /**< Software Version Minor Number  */
#define	WDG_PIOSC_SW_PATCH_VERSION	0 /**< Software Version Patch Number  */

#define	WDG_PIOSC_AR_MAJOR_VERSION	4 /**< AUTOSAR Version Major Number   */
#define	WDG_PIOSC_AR_MINOR_VERSION	0 /**< AUTOSAR Version Minor Number   */
#define	WDG_PIOSC_AR_PATCH_VERSION	2 /**< AUTOSAR Version Patch Number   */
 ...
 *
 *  The notification prototype <tt>Wdg_PIOsc_Notification()</tt> is for
 ...
 *  configured.
 *
 *  The notifications callback <tt>Wdg_PIOsc_Notification_<mode>()</tt> shall be
 ...
 */
typedef void (*Wdg_PIOsc_Notification)(
  void
);

/*
 * WdgPIOsc.h shall include Wdg_PIOscCfg.h.
 */
#include "Wdg_PIOscCfg.h"
 ...
 *  			(<tt>BSW00414</tt>)
 */
extern const Wdg_PIOsc_ConfigType	Wdg_PIOsc_Config[];

/** @brief	PIOsc WDG Driver Initialization
 ...
 *
 *  <b>WDG001</b>:	The <tt>Wdg_PIOsc_Init()</tt> function shall initialize
 *  			the WdgPIOsc module and the watchdog hardware, i.e. it
 ...
 *  		configuration set to be used with the <tt>Wdg_PIOsc_Init()</tt>
 *  		function from a limited number of statically configured sets
 *  		(see also <tt>BSW00314</tt>).
 *
 *  <b>WDG100</b>:	The <tt>Wdg_PIOsc_Init()</tt> function shall initialize
 *  			all global variables of the WdgPIOsc module and set the
 *  			default watchdog mode and initial timeout period.
 *  			(<tt>BSW12057</tt>, <tt>BSW12125</tt>,
 *  			<tt>BSW12461</tt>, <tt>BSW12105</tt>)
 *
 *  <b>WDG101</b>:	The <tt>Wdg_PIOsc_Init()</tt> function shall initialize
 ...
 *  			disables the watchdog, the <tt>Wdg_PIOsc_Init()</tt>
 ...
 *
 *  <b>WDG173</b>:	If switching the WdgPIOsc module and the watchdog
 ...
 *  			<tt>Wdg_PIOsc_Init()</tt> function shall raise the
 *  			production error <tt>WDG_E_MODE_FAILED</tt>.
 *
 *  <b>WDG089</b>:	When development error detection is enabled for the
 *  			WdgPIOsc module: The function <tt>Wdg_PIOsc_Init()</tt>
 *  			shall check that the parameter <tt>ConfigPtr</tt> is not
 *  			<tt>NULL</tt> (except for the Pre-Compiled variant). If
 *  			this error is detected, the function
 *  			<tt>Wdg_PIOsc_Init()</tt> shall not execute the
 *  			initialization but raise the development error
 *  			<tt>WDG_E_PARAM_POINTER</tt>. (<tt>BSW00338</tt>,
 *  			<tt>BSW00323</tt>, <tt>BSW12448</tt>)
 *
 *  <b>WDG090</b>:	When development error detection is enabled for the
 *  			WdgPIOsc module: The <tt>Wdg_PIOsc_Init()</tt> function
 *  			shall check that the (hardware specific) contents of the
 *  			given configuration set is within the allowed
 *  			boundaries. If this error is detected, the function
 *  			<tt>Wdg_PIOsc_Init()</tt> shall not execute the
 *  			initialization but raise the development error
 ...
 *  			WdgPIOsc module: The <tt>Wdg_PIOsc_Init()</tt> function
 *  			shall set the WdgPIOsc module's internal state from
 *  			<tt>WDG_UNINIT</tt> (the default state indicating a
 ...
 *
 *  <b>WDG160</b>:	The function <tt>Wdg_PIOsc_SetMode()</tt> shall switch
 ...
 *  			watchdog, different timeout periods) the WdgPIOsc module
 *  			and the watchdog hardware are switched to one of the
 *  			following three different modes:
 *  			- <tt>WDGIF_OFF_MODE</tt>
 *  			- <tt>WDGIF_SLOW_MODE</tt>
 *  			- <tt>WDGIF_FAST_MODE</tt>
 *  			(<tt>BSW12015</tt>, <tt>BSW12018</tt>)
 *
 *  <b>WDG051</b>:	The configuration set provided to the WdgPIOsc module's
 ...
 *
 *  <b>WDG145</b>:	The <tt>Wdg_PIOsc_SetMode()</tt> function shall reset
 ...
 *
 *  <b>WDG103</b>:	The <tt>Wdg_PIOsc_SetMode()</tt> function shall return
 *  			<tt>E_OK</tt> if the mode switch has been executed
 *  			completely and successfully, i.e. all parameters of the
 *  			WdgPIOsc module and the watchdog hardware have been set
 *  			to the new values.
 *
 *  <b>WDG016</b>:	If switching the WdgPIOsc module and the watchdog
 *  			hardware into the requested mode is not possible, e.g.
 *  			because of inconsistent mode settings or because some
 *  			timing constraints have not been met, the
 *  			<tt>Wdg_PIOsc_SetMode()</tt> function shall return the
 ...
 *  			<tt>Wdg_PIOsc_SetMode()</tt> function shall check
 ...
 *  			WdgPIOsc module: The <tt>Wdg_PIOsc_SetMode()</tt>
 ...
 *  			WdgPIOsc module: The <tt>Wdg_PIOsc_SetMode()</tt>
 *  			function shall check that the WdgPIOsc module's state is
 *  			<tt>WDG_IDLE</tt> (meaning the WdgPIOsc module and the
 *  			watchdog hardware are initialized and the watchdog is
 *  			currently not being triggered or switched). If this is
 *  			not the case, the function shall not execute the mode
 ...
 *  			WdgPIOsc module: The <tt>Wdg_PIOsc_SetMode()</tt>
 *  			function shall set the WdgPIOsc module's state to
 *  			<tt>WDG_BUSY</tt> during its execution (indicating, that
 *  			the module is busy) and shall reset the WdgPIOsc
 ...
 *
 *  <b>WDG136</b>:	The function <tt>Wdg_PIOsc_SetTriggerCondition()</tt>
 ...
 *  			module: The function
 *  			<tt>Wdg_PIOsc_SetTriggerCondition()</tt> shall check
...
#if	( WDG_PIOSC_VERSION_INFO_API == STD_ON )
 ...
 *
 *  <b>WDG067</b>:	The <tt>Wdg_PIOsc_GetVersionInfo()</tt> function shall
 ...
 *
 *  <b>WDG068</b>:	The <tt>Wdg_PIOsc_GetVersionInfo()</tt> function shall
 ...
 *  			<tt>Wdg_PIOsc_GetVersionInfo()</tt> function is
 *  			available, the module WdgPIOsc should realize this
 *  			function as a macro, defined in the module's header
 *  			file.
 *
 *  <b>WDG174</b>:	If DET is enabled for the WdgPIOsc Driver module, the
 *  			function <tt>Wdg_PIOsc_GetVersionInfo()</tt> shall raise
 *  			<tt>WDG_E_PARAM_POINTER</tt>, if the argument is a
 *  			<tt>NULL</tt> pointer and return without any action.
 */
#if ( WDG_PIOSC_DEV_ERROR_DETECT == STD_ON )
#define	Wdg_PIOsc_GetVersionInfo(_vi)	STD_GET_VERSION_INFO(_vi,WDG_PIOSC) \
	else \
	{\
		Det_ReportError(\
			WDG_MODULE_ID,\
...
#else
#define	Wdg_PIOsc_GetVersionInfo(_vi)	STD_GET_VERSION_INFO(_vi,WDG_PIOSC)
#endif	/* WDG_PIOSC_DEV_ERROR_DETECT */
#endif	/* WDG_PIOSC_VERSION_INFO_API */
