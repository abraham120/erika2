 ...
 *  definitions for Freescale Leopard (MPC5643L) and Codewarrior compiler.
 *
 ...
 */
#define _CODEWARRIOR_C_LEOPARD_

/*
 * COMPILER030: “Compiler.h” shall provide information of the supported
 * compiler vendor and the applicable compiler version.
 *
 * Codewarrior (mwccepp)
 * Freescale C/C++ Compiler for Embedded PowerPC.
 * Copyright (c)1998-2005 Freescale Semiconductor, Inc.
 * Version 4.3 build 221
 * 
 * Tool Version Numbers:
 * Toolchain: Metrowerks Command-Line Tools
 * Toolchain Path: CodeWarrior_MCU_10.2/MCU/PA_Tools/Command_Line_Tools/
 * C Compiler:      mwccepp   Version 4.3 build 221 [Evaluation]
 * Assembler:       mwasmeppc Version 4.3 build 221 [Evaluation]
 * Linker/Locator:  mwldeppc  Version 4.3 build 221 [Evaluation]
 */
