...
/** @defgroup STM32F4_DISCOVERY_LOW_LEVEL_Exported_Types
  * @{
  */
#if defined (__USE_STM32F4_DISCOVERY_LEDS__) || defined (__USE_STM32F4_DISCOVERY_ALL_)
typedef enum 
{
  LED4 = 0,
  LED3 = 1,
...
#if defined (__USE_STM32F4_DISCOVERY_BUTTONS__) || defined (__USE_STM32F4_DISCOVERY_ALL_)
typedef enum 
{  
  BUTTON_USER = 0,
} Button_TypeDef;
...
#if defined (__USE_STM32F4_DISCOVERY_COM__) || defined (__USE_STM32F4_DISCOVERY_ALL_)
typedef enum 
{
  COM1 = 0,
  COM2 = 1,
...
#if defined (__USE_STM32F4_DISCOVERY_SD__) || defined (__USE_STM32F4_DISCOVERY_ALL_)
