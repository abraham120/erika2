...
EE_SRCS += hardware/arduino/avr/cores/arduino/hooks.c
EE_SRCS += hardware/arduino/avr/cores/arduino/wiring.c
EE_SRCS += hardware/arduino/avr/cores/arduino/wiring_digital.c
EE_SRCS += hardware/arduino/avr/cores/arduino/wiring_analog.c
EE_SRCS += hardware/arduino/avr/cores/arduino/wiring_pulse.c
EE_SRCS += hardware/arduino/avr/cores/arduino/wiring_shift.c
EE_SRCS += hardware/arduino/avr/cores/arduino/WInterrupts.c
...
EE_SRCS += hardware/arduino/avr/cores/arduino/CDC.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/HardwareSerial.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/HID.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/IPAddress.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/new.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/Print.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/Stream.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/Tone.cpp
EE_SRCS += hardware/arduino/avr/cores/arduino/USBCore.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/Bridge/src \
		$(INCLUDE_PATH)
EE_SRCS += libraries/Bridge/src/Bridge.cpp
EE_SRCS += libraries/Bridge/src/Console.cpp
EE_SRCS += libraries/Bridge/src/FileIO.cpp
EE_SRCS += libraries/Bridge/src/HttpClient.cpp
EE_SRCS += libraries/Bridge/src/MailBox.cpp
EE_SRCS += libraries/Bridge/src/Process.cpp
ifeq ($(call iseeopt, __ARDUINO_SDK_CC__), yes)
...
EE_SRCS += libraries/Bridge/src/YunServer.cpp
endif	# __ARDUINO_SDK_ORG__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/EEPROM \
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/EEPROM/EEPROM.cpp
endif	# __ARDUINO_SDK_ORG__
...
EE_SRCS += libraries/Esplora/src/Esplora.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/Ethernet/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/Ethernet/src/Dhcp.cpp
EE_SRCS += libraries/Ethernet/src/Dns.cpp
EE_SRCS += libraries/Ethernet/src/Ethernet.cpp
EE_SRCS += libraries/Ethernet/src/EthernetClient.cpp
EE_SRCS += libraries/Ethernet/src/EthernetServer.cpp
EE_SRCS += libraries/Ethernet/src/EthernetUdp.cpp
EE_SRCS += libraries/Ethernet/src/utility/socket.cpp
EE_SRCS += libraries/Ethernet/src/utility/w5100.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/Ethernet2/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/Ethernet2/src/Dhcp.cpp
EE_SRCS += libraries/Ethernet2/src/Dns.cpp
EE_SRCS += libraries/Ethernet2/src/Ethernet2.cpp
EE_SRCS += libraries/Ethernet2/src/EthernetClient.cpp
EE_SRCS += libraries/Ethernet2/src/EthernetServer.cpp
EE_SRCS += libraries/Ethernet2/src/EthernetUdp2.cpp
EE_SRCS += libraries/Ethernet2/src/Twitter.cpp
EE_SRCS += libraries/Ethernet2/src/utility/socket.cpp
EE_SRCS += libraries/Ethernet2/src/utility/w5500.cpp
...
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileAccessProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileCellManagement.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileClientProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileClientService.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileDataNetworkProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileMockupProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileNetworkProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileNetworkRegistry.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileServerProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileServerService.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileSMSProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3MobileVoiceProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1AccessProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1BandManagement.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1BaseProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1CellManagement.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1ClientProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1DataNetworkProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1DirectModemProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1ModemCore.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1ModemVerification.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1MultiClientProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1MultiServerProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1PinManagement.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1ScanNetworks.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1ServerProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1SMSProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV1VoiceProvider.cpp
EE_SRCS += hardware/arduino/avr/libraries/GSM/src/GSM3ShieldV2.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/HID/src \
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/HID/src/HID.cpp
endif	# __ARDUINO_SDK_CC__
...
EE_SRCS += libraries/Keyboard/src/Keyboard.cpp
endif	# __ARDUINO_SDK_CC__
...
EE_SRCS += libraries/LiquidCrystal/src/LiquidCrystal.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/LuckyShield/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/LuckyShield/src/lib/Adafruit_GFX.cpp
EE_SRCS += libraries/LuckyShield/src/lib/Adafruit_SSD1306.cpp
EE_SRCS += libraries/LuckyShield/src/lib/BME280.cpp
EE_SRCS += libraries/LuckyShield/src/lib/CAT9555.cpp
...
EE_SRCS += libraries/Keyboard/src/Mouse.cpp
endif	# __ARDUINO_SDK_CC__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/NAxesMotion/		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/NAxesMotion/NAxesMotion.cpp
EE_SRCS += libraries/NAxesMotion/utility/BNO055.c
endif	# __ARDUINO_SDK_ORG__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/Robot_Control/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/Robot_Control/src/Arduino_LCD.cpp
EE_SRCS += libraries/Robot_Control/src/ArduinoRobot.cpp
EE_SRCS += libraries/Robot_Control/src/communication.cpp
EE_SRCS += libraries/Robot_Control/src/Compass.cpp
EE_SRCS += libraries/Robot_Control/src/EasyTransfer2.cpp
EE_SRCS += libraries/Robot_Control/src/EEPROM_I2C.cpp
EE_SRCS += libraries/Robot_Control/src/Fat16.cpp
EE_SRCS += libraries/Robot_Control/src/glcdfont.c
EE_SRCS += libraries/Robot_Control/src/helper.cpp
EE_SRCS += libraries/Robot_Control/src/information.cpp
EE_SRCS += libraries/Robot_Control/src/keyboard.cpp
EE_SRCS += libraries/Robot_Control/src/lcd.cpp
EE_SRCS += libraries/Robot_Control/src/Melody.cpp
EE_SRCS += libraries/Robot_Control/src/Motors.cpp
EE_SRCS += libraries/Robot_Control/src/Multiplexer.cpp
EE_SRCS += libraries/Robot_Control/src/RobotSdCard.cpp
EE_SRCS += libraries/Robot_Control/src/SdCard.cpp
EE_SRCS += libraries/Robot_Control/src/Sensors.cpp
EE_SRCS += libraries/Robot_Control/src/Squawk.cpp
EE_SRCS += libraries/Robot_Control/src/SquawkSD.cpp
EE_SRCS += libraries/Robot_Control/src/utility/Adafruit_GFX.cpp
EE_SRCS += libraries/Robot_Control/src/utility/RobotTextManager.cpp
EE_SRCS += libraries/Robot_Control/src/utility/VirtualKeyboard.cpp
...
EE_SRCS += libraries/Robot_Motor/src/ArduinoRobotMotorBoard.cpp
EE_SRCS += libraries/Robot_Motor/src/EasyTransfer2.cpp
EE_SRCS += libraries/Robot_Motor/src/lineFellow.cpp
EE_SRCS += libraries/Robot_Motor/src/Multiplexer.cpp
...
EE_SRCS += libraries/RobotIRemote/src/IRemote.cpp
EE_SRCS += libraries/RobotIRemote/src/IRemoteTools.cpp
...
EE_SRCS += libraries/RTC/src/RTCInt.cpp
endif	# __ARDUINO_SDK_ORG__
...
EE_SRCS += libraries/Scheduler/src/Scheduler.cpp
endif	# __ARDUINO_SDK_ORG__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/SD/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/SD/src/File.cpp
EE_SRCS += libraries/SD/src/SD.cpp
EE_SRCS += libraries/SD/src/utility/Sd2Card.cpp
EE_SRCS += libraries/SD/src/utility/SdFile.cpp
EE_SRCS += libraries/SD/src/utility/SdVolume.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/Servo/src \
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/Servo/src/avr/Servo.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/SoftwareSerial/src	\
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/SoftwareSerial/src/SoftwareSerial.cpp
endif	# __ARDUINO_SDK_CC__
ifeq ($(call iseeopt, __ARDUINO_SDK_ORG__), yes)
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/SoftwareSerial	\
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/SoftwareSerial/SoftwareSerial.cpp
endif	# __ARDUINO_SDK_ORG__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/SPI/src	\
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/SPI/src/SPI.cpp
endif	# __ARDUINO_SDK_CC__
ifeq ($(call iseeopt, __ARDUINO_SDK_ORG__), yes)
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/SPI	\
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/SPI/SPI.cpp
endif	# __ARDUINO_SDK_ORG__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/SpacebrewYun/src	\
		$(INCLUDE_PATH)
EE_SRCS += libraries/SpacebrewYun/src/SpacebrewYun.cpp
...
EE_SRCS += libraries/Stepper/src/Stepper.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/Temboo/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/Temboo/src/Temboo.cpp
ifeq ($(call iseeopt, __ARDUINO_SDK_CC__), yes)
EE_SRCS += libraries/Temboo/src/TembooCoAPEdgeDevice.cpp
EE_SRCS += libraries/Temboo/src/TembooMQTTEdgeDevice.cpp
endif	# __ARDUINO_SDK_CC__
EE_SRCS += libraries/Temboo/src/utility/BaseFormatter.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoInput.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoInputFormatter.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoInputSet.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoOutput.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoOutputFormatter.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoOutputSet.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoPreset.cpp
EE_SRCS += libraries/Temboo/src/utility/ChoreoPresetFormatter.cpp
ifeq ($(call iseeopt, __ARDUINO_SDK_CC__), yes)
EE_SRCS += libraries/Temboo/src/utility/CoapMessageLayer.cpp
EE_SRCS += libraries/Temboo/src/utility/CoapMsg.cpp
EE_SRCS += libraries/Temboo/src/utility/CoapRRLayer.cpp
endif	# __ARDUINO_SDK_CC__
EE_SRCS += libraries/Temboo/src/utility/DataFormatter.cpp
ifeq ($(call iseeopt, __ARDUINO_SDK_CC__), yes)
EE_SRCS += libraries/Temboo/src/utility/MQTTConnectClient.c
EE_SRCS += libraries/Temboo/src/utility/MQTTConnectServer.c
EE_SRCS += libraries/Temboo/src/utility/MQTTDeserializePublish.c
EE_SRCS += libraries/Temboo/src/utility/MQTTFormat.c
EE_SRCS += libraries/Temboo/src/utility/MQTTPacket.c
EE_SRCS += libraries/Temboo/src/utility/MQTTSerializePublish.c
EE_SRCS += libraries/Temboo/src/utility/MQTTSubscribeClient.c
EE_SRCS += libraries/Temboo/src/utility/MQTTSubscribeServer.c
EE_SRCS += libraries/Temboo/src/utility/MQTTUnsubscribeClient.c
EE_SRCS += libraries/Temboo/src/utility/MQTTUnsubscribeServer.c
EE_SRCS += libraries/Temboo/src/utility/TembooCoAPSession.cpp
endif	# __ARDUINO_SDK_CC__
EE_SRCS += libraries/Temboo/src/utility/TembooGlobal.c
ifeq ($(call iseeopt, __ARDUINO_SDK_CC__), yes)
EE_SRCS += libraries/Temboo/src/utility/TembooMQTTSession.cpp
endif	# __ARDUINO_SDK_CC__
EE_SRCS += libraries/Temboo/src/utility/TembooSession.cpp
EE_SRCS += libraries/Temboo/src/utility/tmbhmac.cpp
EE_SRCS += libraries/Temboo/src/utility/tmbmd5.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/TFT/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/TFT/src/TFT.cpp
EE_SRCS += libraries/TFT/src/utility/Adafruit_GFX.cpp
EE_SRCS += libraries/TFT/src/utility/ST7735.cpp
EE_SRCS += libraries/TFT/src/utility/glcdfont.c
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/USBHost/src	\
		$(INCLUDE_PATH)
EE_SRCS += libraries/USBHost/src/adk.cpp
EE_SRCS += libraries/USBHost/src/hid2.cpp
EE_SRCS += libraries/USBHost/src/KeyboardController.cpp
EE_SRCS += libraries/USBHost/src/MouseController.cpp
EE_SRCS += libraries/USBHost/src/parsetools.cpp
EE_SRCS += libraries/USBHost/src/Usb.cpp
endif	# __ARDUINO_SDK_ORG__
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/libraries/WiFi/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += libraries/WiFi/src/WiFi.cpp
EE_SRCS += libraries/WiFi/src/WiFiClient.cpp
EE_SRCS += libraries/WiFi/src/WiFiServer.cpp
EE_SRCS += libraries/WiFi/src/WiFiUdp.cpp
...
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/Wire/src		\
		...
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/Wire/src/Wire.cpp
EE_SRCS += hardware/arduino/avr/libraries/Wire/src/utility/twi.c
endif	# __ARDUINO_SDK_CC__
ifeq ($(call iseeopt, __ARDUINO_SDK_ORG__), yes)
INCLUDE_PATH :=	$(ARDUINO_SDK_ROOT)/hardware/arduino/avr/libraries/Wire		\
		...
		$(INCLUDE_PATH)
EE_SRCS += hardware/arduino/avr/libraries/Wire/Wire.cpp
EE_SRCS += hardware/arduino/avr/libraries/Wire/utility/twi.c
endif	# __ARDUINO_SDK_ORG__
...
EE_SRCS += hardware/arduino/cores/arduino/HID.cpp
EE_SRCS += hardware/arduino/cores/arduino/IPAddress.cpp
EE_SRCS += hardware/arduino/cores/arduino/new.cpp
...
EE_SRCS += libraries/Wire/utility/twi.c
endif	# __ARDUINO_SDK_LIB_WIRE__
