...
/* Console debug (serial interface) */
#define MY_DEBUG_SERIAL_TX  EE_UART_PORT_2B
#define MY_DEBUG_SERIAL_RX  EE_UART_PORT_2A
/* Console (serial interface) */
#define MY_FIRST_SERIAL  EE_UART_PORT_1B
#define MY_FIRST_CONSOLE 0
#define MY_DEBUG_CONSOLE_TX 1
#define MY_DEBUG_CONSOLE_RX 2
#define MAXCHARS         128
