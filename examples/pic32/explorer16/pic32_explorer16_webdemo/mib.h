/*
 * This file was automatically generated on Mon Oct 25 18:30:22 2010
 * by mib2bib utility.
...
#define USM_INDEX_ID (11)			// 43.6.1.4.1.17095.4.1.1.1: READONLY BYTE.
#define USER_SECURITY_NAME (12)			// 43.6.1.4.1.17095.4.1.1.2: READWRITE ASCII_STRING.
#define USM_AUTH_PROT (13)			// 43.6.1.4.1.17095.4.1.1.3: READWRITE BYTE.
#define USM_AUTH_KEY (14)			// 43.6.1.4.1.17095.4.1.1.4: READWRITE ASCII_STRING.
#define USM_PRIV_PROT (15)			// 43.6.1.4.1.17095.4.1.1.5: READWRITE BYTE.
#define USM_PRIV_KEY (16)			// 43.6.1.4.1.17095.4.1.1.6: READWRITE ASCII_STRING.
#define SNMP_TARGET_INDEX_ID (17)			// 43.6.1.4.1.17095.5.1.1.1: READONLY BYTE.
#define SNMP_TARGET_MP_MODEL (18)			// 43.6.1.4.1.17095.5.1.1.2: READWRITE BYTE.
#define SNMP_TARGET_SECURITY_MODEL (19)			// 43.6.1.4.1.17095.5.1.1.3: READWRITE BYTE.
#define SNMP_TARGET_SECURITY_NAME (20)			// 43.6.1.4.1.17095.5.1.1.4: READWRITE ASCII_STRING.
#define SNMP_TARGET_SECURITY_LEVEL (21)			// 43.6.1.4.1.17095.5.1.1.5: READWRITE BYTE.
