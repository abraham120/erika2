...
// Prototipo AscoltaStack
void stackAscolta(void);
...
// To enable SNTP debug
#if defined (SNTP_DEBUG)
BYTE TimeBuffer[9];
#elif defined(SNTP_DEBUG_TIME_ACQUIRED)
BYTE TimeBuffer[9];
rtccTime tm1; // time structure
rtccDate dt1; // date structure
#endif

#if defined (STACK_USE_SNTP_CLIENT)
#define TODAY 1297346365	//10 Feb 2011
#define TEN_MINUTES 360
DWORD last_snpt_time;
BYTE sntp_is_acquired;
#endif


DWORD startTime;	// To perform
