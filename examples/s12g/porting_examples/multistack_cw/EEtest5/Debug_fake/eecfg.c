 ...
 **************************************************************************/
    ...
    int EE_s12_stack_1[STACK_1_SIZE];	// Task 0 (Producer)
    int EE_s12_stack_2[STACK_2_SIZE];	// Task 1 (Consumer)
    ...
    struct EE_TOS EE_s12_system_tos[3] = {
        {0},	// Task   (dummy)
        {(EE_ADDR)(&EE_s12_stack_1[STACK_1_SIZE -3])},	// Task 0 (Producer)
        {(EE_ADDR)(&EE_s12_stack_2[STACK_2_SIZE -3])} 	// Task 1 (Consumer)
    };
