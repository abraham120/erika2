...
#define STACKS_SIZE 256U
extern __far void _lc_ub_ustack_tc0[];
extern __far void _lc_ue_ustack_tc0[];
...
void main( void )
{
    ...
    EE_assert(10, _lc_ub_ustack_tc0 < sp_system && sp_system <= _lc_ue_ustack_tc0, 9);
