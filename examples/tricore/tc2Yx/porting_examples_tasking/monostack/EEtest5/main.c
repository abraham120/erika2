...
ISR2 (STM0_isr2) {
    ...
    ++counter_isr1;
    ActivateTask(Task1);
    EE_assert(3, counter_task1 == 0 && counter_task2 == 0 && counter_isr2 == 1, 2);
}
...
ISR2 (STM1_isr2) {
    ...
    ++counter_isr2;
    ActivateTask(Task2);
    EE_assert(2, counter_task1 == 0 && counter_task2 == 0 && counter_isr1 == 0, 1);
}
...
int main(void)
{
    ...
    EE_tc27x_stm_set_sr0(100U, EE_ISR2_ID_STM0_isr2);
