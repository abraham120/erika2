...
TASK(TaskSend1)
{
    ...
    for (i=0; i<7; i++) {
        ...
        /* Change a value just to have something to check with the debugger */
        dummy_data_master++;
    ...
    /* Test if buffer[0] has rejected data */
    test_num++;
...
TASK(TaskSend3)
{
    ...
    /* Call to generated function */
    result = IocSendGroup_0(dummy_data_master, dummy_data_master+1,
        dummy_data_master+2);
