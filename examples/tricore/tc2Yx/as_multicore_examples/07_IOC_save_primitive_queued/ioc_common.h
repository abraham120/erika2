...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocSend_0(uint16 data)
{
...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocReceive_0(uint16 * data)
{
    Std_ReturnType  result;
    EE_FREG         flags = EE_hal_suspendIRQ();
...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocSendGroup_0(uint16 data1,
...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocReceiveGroup_0(uint16 * data1,
    uint16 * data2, uint16 * data3)
{
    Std_ReturnType  result;
    EE_FREG         flags = EE_hal_suspendIRQ();
