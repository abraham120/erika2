...
/* Primitive type */
uint16 dummy_data_slave, dummy_data_slave1, dummy_data_slave2;
...
TASK(TaskReceive1)
{
    ...
    EE_assert(3, (dummy_data_slave==7), 2);

    result = IocReceive_0(&dummy_data_slave);
    EE_assert(4, (result==IOC_E_OK), 3);
    EE_assert(5, (dummy_data_slave==8), 4);

    result = IocReceive_0(&dummy_data_slave);
    EE_assert(6, (result==IOC_E_OK), 5);
    EE_assert(7, (dummy_data_slave==9), 6);
...
TASK(TaskReceive2)
{
    ...
    EE_assert(10, (result==IOC_E_LOST_DATA && dummy_data_slave==10), 9);

    result = IocReceive_0(&dummy_data_slave);   /* Extract second element */
    EE_assert(11, (result==IOC_E_OK && dummy_data_slave==11), 10);

    result = IocReceive_0(&dummy_data_slave);   /* Extract 3-th */
    EE_assert(12, (result==IOC_E_OK && dummy_data_slave==12), 11);

    result = IocReceive_0(&dummy_data_slave);   /* Extract 4-th */
    EE_assert(13, (result==IOC_E_OK && dummy_data_slave==13), 12);

    result = IocReceive_0(&dummy_data_slave);   /* Extract 5-th */
    EE_assert(14, (result==IOC_E_OK && dummy_data_slave==14), 13);
