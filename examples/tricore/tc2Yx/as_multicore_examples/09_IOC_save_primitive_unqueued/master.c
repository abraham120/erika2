...
/* Primitive type */
uint16 dummy_data_master = VALUE;
uint16 dummy_data_master1 = VALUE+1;
uint16 dummy_data_master2 = VALUE+2;
...
TASK(TaskSend2)
{
    ...
    EE_assert(5, (result==IOC_E_OK &&
        ((uint16*)(EE_ioc_enqueued_buffer[0].memory))[0] == VALUE), 4);
    EE_assert(6, (result==IOC_E_OK &&
        ((uint16*)(EE_ioc_enqueued_buffer[0].memory))[1] == VALUE+1), 5);
    EE_assert(7, (result==IOC_E_OK &&
        ((uint16*)(EE_ioc_enqueued_buffer[0].memory))[2] == VALUE+2), 6);
