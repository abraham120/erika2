...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocWrite_0(TASKParams3 * data)
{
...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocWriteGroup_0(TASKParams3 data1,
...
__INLINE__ Std_ReturnType __ALWAYS_INLINE__ IocReadGroup_0(TASKParams3 * data1,
    TASKParams3 * data2, TASKParams3 * data3)
{
    EE_FREG         flags = EE_hal_suspendIRQ();
