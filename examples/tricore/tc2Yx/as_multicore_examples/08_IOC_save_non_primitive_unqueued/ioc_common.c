 ...
 */
/* EE_ioc_data dimension equal to 3 has to be generated (is the maximum number
of input parameters used by a auto-generated IocReadGroup_0 */
TASKParams3 EE_SHARED_UDATA EE_ioc_data[3];

/* 3*sizeof(EE_ioc_data) because 3 is the number of input parameters
of IocWriteGroup. Hence it has to be generated */

EE_IOC_Buffer EE_SHARED_IDATA EE_ioc_enqueued_buffer[NUM_OF_BUFFERS] = {
    {0U, 0U, 0U, 3*sizeof(EE_ioc_data[0]), (EE_UINT8*)&EE_ioc_data,
