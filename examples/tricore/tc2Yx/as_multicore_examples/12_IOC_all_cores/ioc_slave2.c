...
TASKParams3 dummy_data_slave2_callback;

/* defined by the user for receiving core/OS-Application */
void YYY_IocReceiveCB_1(void);

/* Check data sent by master core */
void YYY_IocReceiveCB_1(void)
{
    /* 1 is the last test performed by slave1.c module */
    EE_UINT32 i = 1;
     ...
     */
    result = IocReceive_1(&dummy_data_slave2_callback);
