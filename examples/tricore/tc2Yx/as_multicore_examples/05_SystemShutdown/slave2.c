...
TASK(TaskSlave2)
{
  ...
  /* Check Spinlock Release */
#ifdef EE_SHUTDOWN_ALL_CORES_FROM_CORE2
  /* Wait to give core master the opportunity to Activate SlaveTask1 */
  {
  ...
  ShutdownAllCores( E_OS_ID );
#else  /* EE_SHUTDOWN_ALL_CORES_FROM_CORE2 */
  /* Choice the error coherent with ShutdownAllCores to keep code easy in
     ShutdownHook */
