...
/////////////////////////////////////////////////////////////////////////////
    ...
    int EE_msp430_stack_1[STACK_1_SIZE];	/* Task 0 (Producer) */
    int EE_msp430_stack_2[STACK_2_SIZE];	/* Task 1 (Consumer) */
    ...
    struct EE_TOS EE_msp430_system_tos[3] = {
        {0},	/* Task   (dummy) */
        {(EE_ADDR)(&EE_msp430_stack_1[STACK_1_SIZE-MSP430_INIT_TOS_OFFSET])},	/* Task 0 (Producer) */
        {(EE_ADDR)(&EE_msp430_stack_2[STACK_2_SIZE-MSP430_INIT_TOS_OFFSET])} 	/* Task 1 (Consumer) */
    };
    ...
    struct EE_TOS EE_msp430_IRQ_tos = {
        (EE_ADDR)(&EE_msp430_stack_3[STACK_3_SIZE-MSP430_INIT_TOS_OFFSET])
    };
