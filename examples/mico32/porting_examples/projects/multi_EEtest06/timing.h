...
/*
 * Mico32-specific and configuration-specific part
 */
#include <MicoTimer.h>
#include <system_conf.h>

__INLINE__ timer_t get_current_time(void)
{
    MicoTimer_t *timerc = (MicoTimer_t *)FREE_TIMER_BASE_ADDRESS;
    return timerc->Snapshot;
}

__INLINE__ timer_t time_diff(timer_t past, timer_t future)
{
    /* The Mico32 timer counts down */
    return past - future;
}
