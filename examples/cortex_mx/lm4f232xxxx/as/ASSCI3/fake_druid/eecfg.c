 ...
 **************************************************************************/
    ...
    DeclareTask(TaskTxErr);
    DeclareTask(TaskRxErr);

    const EE_FADDR EE_hal_thread_body[EE_MAX_TASK] = {
        (EE_FADDR)FuncTaskTxOk,		/* thread TaskTxOk */
        (EE_FADDR)FuncTaskRxOk,		/* thread TaskRxOk */
        (EE_FADDR)FuncTaskTxErr,		/* thread TaskTxErr */
        (EE_FADDR)FuncTaskRxErr 		/* thread TaskRxErr */
