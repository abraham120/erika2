 ...
 **************************************************************************/
    ...
    DeclareTask(TaskXferEnd);
    DeclareTask(TaskXferError);

    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &FuncTaskXferEnd,		/* thread TaskXferEnd */
        &FuncTaskXferError 		/* thread TaskXferError */

    };

    /* ready priority */
    const EE_TYPEPRIO EE_th_ready_prio[EE_MAX_TASK] = {
        0x2U,		/* thread TaskXferEnd */
        0x1U 		/* thread TaskXferError */
    };
