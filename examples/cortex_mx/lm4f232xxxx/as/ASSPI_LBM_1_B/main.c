...
enum EE_ASSERTIONS {
  ...
  EE_ASSERT_SPI_INT_ASYNC_TX,		/* 13 */
  EE_ASSERT_SPI_INT_JOB_END,		/* 14 */
  EE_ASSERT_SPI_INT_JOB_OK,		/* 15 */
  EE_ASSERT_SPI_INT_SEQ_END,		/* 16 */
  EE_ASSERT_SPI_INT_SEQ_OK,		/* 17 */
  EE_ASSERT_SPI_INT_READ_IB_0,		/* 18 */
  EE_ASSERT_SPI_INT_READ_IB_1,		/* 19 */
  EE_ASSERT_SPI_INT_READ_IB_2,		/* 20 */
  EE_ASSERT_SPI_INT_READ_IB_3,		/* 21 */
  EE_ASSERT_SPI_INT_READ_VALIDATE_0,	/* 22 */
  EE_ASSERT_SPI_INT_READ_VALIDATE_1,	/* 23 */
  EE_ASSERT_SPI_INT_READ_VALIDATE_2,	/* 24 */
  EE_ASSERT_SPI_INT_READ_VALIDATE_3,	/* 25 */
  EE_ASSERT_SPI_POLLING_MODE,		/* 26 */
  EE_ASSERT_SPI_POLL_WRITE_IB_0,	/* 27 */
  EE_ASSERT_SPI_POLL_WRITE_IB_1,	/* 28 */
  EE_ASSERT_SPI_POLL_WRITE_IB_2,	/* 29 */
  EE_ASSERT_SPI_POLL_WRITE_IB_3,	/* 30 */
  EE_ASSERT_SPI_POLL_ASYNC_TX,		/* 31 */
  EE_ASSERT_SPI_POLL_JOB_END,		/* 32 */
  EE_ASSERT_SPI_POLL_JOB_OK,		/* 33 */
  EE_ASSERT_SPI_POLL_SEQ_END,		/* 34 */
  EE_ASSERT_SPI_POLL_SEQ_OK,		/* 35 */
  EE_ASSERT_SPI_POLL_READ_IB_0,		/* 36 */
  EE_ASSERT_SPI_POLL_READ_IB_1,		/* 37 */
  EE_ASSERT_SPI_POLL_READ_IB_2,		/* 38 */
  EE_ASSERT_SPI_POLL_READ_IB_3,		/* 39 */
  EE_ASSERT_SPI_POLL_READ_VALIDATE_0,	/* 40 */
  EE_ASSERT_SPI_POLL_READ_VALIDATE_1,	/* 41 */
  EE_ASSERT_SPI_POLL_READ_VALIDATE_2,	/* 42 */
  EE_ASSERT_SPI_POLL_READ_VALIDATE_3,	/* 43 */
  EE_ASSERT_SPI_EB_INT_MODE,		/* 44 */
  EE_ASSERT_SPI_EB_INT_SETUP_0,		/* 45 */
  EE_ASSERT_SPI_EB_INT_SETUP_1,		/* 46 */
  EE_ASSERT_SPI_EB_INT_SETUP_2,		/* 47 */
  EE_ASSERT_SPI_EB_INT_SETUP_3,		/* 48 */
  EE_ASSERT_SPI_EB_INT_ASYNC_TX,	/* 49 */
  EE_ASSERT_SPI_EB_INT_JOB_END,		/* 50 */
  EE_ASSERT_SPI_EB_INT_JOB_OK,		/* 51 */
  EE_ASSERT_SPI_EB_INT_SEQ_END,		/* 52 */
  EE_ASSERT_SPI_EB_INT_SEQ_OK,		/* 53 */
  EE_ASSERT_SPI_EB_INT_VALIDATE_0,	/* 54 */
  EE_ASSERT_SPI_EB_INT_VALIDATE_1,	/* 55 */
  EE_ASSERT_SPI_EB_INT_VALIDATE_2,	/* 56 */
  EE_ASSERT_SPI_EB_INT_VALIDATE_3,	/* 57 */
  EE_ASSERT_SPI_EB_POLL_MODE,		/* 58 */
  EE_ASSERT_SPI_EB_POLL_SETUP_0,	/* 59 */
  EE_ASSERT_SPI_EB_POLL_SETUP_1,	/* 60 */
  EE_ASSERT_SPI_EB_POLL_SETUP_2,	/* 61 */
  EE_ASSERT_SPI_EB_POLL_SETUP_3,	/* 62 */
  EE_ASSERT_SPI_EB_POLL_ASYNC_TX,	/* 63 */
  EE_ASSERT_SPI_EB_POLL_JOB_END,	/* 64 */
  EE_ASSERT_SPI_EB_POLL_JOB_OK,		/* 65 */
  EE_ASSERT_SPI_EB_POLL_SEQ_END,	/* 66 */
  EE_ASSERT_SPI_EB_POLL_SEQ_OK,		/* 67 */
  EE_ASSERT_SPI_EB_POLL_VALIDATE_0,	/* 68 */
  EE_ASSERT_SPI_EB_POLL_VALIDATE_1,	/* 69 */
  EE_ASSERT_SPI_EB_POLL_VALIDATE_2,	/* 70 */
  EE_ASSERT_SPI_EB_POLL_VALIDATE_3,	/* 71 */
  EE_ASSERT_SPI_SYNC_WRITE_IB_0,	/* 72 */
  EE_ASSERT_SPI_SYNC_WRITE_IB_1,	/* 73 */
  EE_ASSERT_SPI_SYNC_WRITE_IB_2,	/* 74 */
  EE_ASSERT_SPI_SYNC_WRITE_IB_3,	/* 75 */
  EE_ASSERT_SPI_SYNC_TX,		/* 76 */
  EE_ASSERT_SPI_SYNC_JOB_OK,		/* 77 */
  EE_ASSERT_SPI_SYNC_SEQ_OK,		/* 78 */
  EE_ASSERT_SPI_SYNC_READ_IB_0,		/* 79 */
  EE_ASSERT_SPI_SYNC_READ_IB_1,		/* 80 */
  EE_ASSERT_SPI_SYNC_READ_IB_2,		/* 81 */
  EE_ASSERT_SPI_SYNC_READ_IB_3,		/* 82 */
  EE_ASSERT_SPI_SYNC_VALIDATE_0,	/* 83 */
  EE_ASSERT_SPI_SYNC_VALIDATE_1,	/* 84 */
  EE_ASSERT_SPI_SYNC_VALIDATE_2,	/* 85 */
  EE_ASSERT_SPI_SYNC_VALIDATE_3,	/* 86 */
  EE_ASSERT_SPI_EB_SYNC_SETUP_0,	/* 87 */
  EE_ASSERT_SPI_EB_SYNC_SETUP_1,	/* 88 */
  EE_ASSERT_SPI_EB_SYNC_SETUP_2,	/* 89 */
  EE_ASSERT_SPI_EB_SYNC_SETUP_3,	/* 90 */
  EE_ASSERT_SPI_EB_SYNC_TX,		/* 91 */
  EE_ASSERT_SPI_EB_SYNC_JOB_OK,		/* 92 */
  EE_ASSERT_SPI_EB_SYNC_SEQ_OK,		/* 93 */
  EE_ASSERT_SPI_EB_SYNC_VALIDATE_0,	/* 94 */
  EE_ASSERT_SPI_EB_SYNC_VALIDATE_1,	/* 95 */
  EE_ASSERT_SPI_EB_SYNC_VALIDATE_2,	/* 96 */
  EE_ASSERT_SPI_EB_SYNC_VALIDATE_3,	/* 97 */
  EE_ASSERT_SPI_DEINIT,			/* 98 */
  EE_ASSERT_DIM
};
