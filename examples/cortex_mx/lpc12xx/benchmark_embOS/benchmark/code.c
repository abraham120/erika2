...
TASK(BM_task)
{
	...
	for (;;) {  
		...
		/*All newly created task are suspended by 1 suspdendcnt.
		it means that a task is activated when a resume routine is called.*/
		OS_SetInitialSuspendCnt(1);
		activate_task(Task1);
