...
#define STACK_Producer_ID 1U
#define STACK_Producer_SIZE 512
int EE_stack_Producer[STACK_Producer_SIZE];

#define STACK_Consumer_ID 2U
#define STACK_Consumer_SIZE 512
int EE_stack_Consumer[STACK_Consumer_SIZE];
...
struct EE_TOS EE_std_system_tos[3] = {
        {0}, /* shared */
        {(EE_ADDR)(&EE_stack_Producer[STACK_Producer_SIZE - 1])},
        {(EE_ADDR)(&EE_stack_Consumer[STACK_Consumer_SIZE - 1])},
};
 ...
 **************************************************************************/
    ...
    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &FuncProducer,		/* thread Producer */
        &FuncConsumer 		/* thread Consumer */
