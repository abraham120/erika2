test4
 ...
 Another minimal EE demo that demonstrates how to create two TASKs with different priorities.
 This demo can be used to test the preemption mechanism. In this case Task2 can't preempt Task1.
