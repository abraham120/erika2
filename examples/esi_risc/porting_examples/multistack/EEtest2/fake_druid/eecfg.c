...
//  
/////////////////////////////////////////////////////////////////////////////
    #define STACK_1_SIZE 4096
    #define STACK_2_SIZE 4096

    int EE_stack_1[STACK_1_SIZE];	// Task 0 (Task1)
    int EE_stack_2[STACK_2_SIZE];	// Task 1 (Task2)
    ...
    struct EE_TOS EE_std_system_tos[3] = {
        {0},	// Task   (dummy)
        {(EE_ADDR)(&EE_stack_1[STACK_1_SIZE -1])},	// Task 0 (Task1)
        {(EE_ADDR)(&EE_stack_2[STACK_2_SIZE -1])} 	// Task 1 (Task2)
    };
