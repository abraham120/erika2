...
/* This is a low priority task that is activated by the low priority ISR
 * It should be scheduled AFTER Task2 has finished
 */
TASK(Task1)
{
 ...
 * It should be scheduled AFTER the low priority ISR has finished
 */
TASK(Task2)
{
	iprintf("INFO :%s: START: sp=0x%x\n", __FUNCTION__, get_sp());
...
int main(void)
{
	...
	iprintf("INFO : multistack EEtest3 - nested ISRs\n");
