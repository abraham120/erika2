 ...
 **************************************************************************/
    ...
    static EE_STACK_T EE_STACK_ATTRIB_NAME(TrustedApp) EE_stack_1[EE_STACK_WLEN(STACK_1_SIZE)];	/* Task 0 (MainTask), Task 1 (TrustedTask1), Task 2 (ErrorTask), shared stack TrustedApp */
    static EE_STACK_T EE_STACK_ATTRIB_NAME(App1) EE_stack_2[EE_STACK_WLEN(STACK_2_SIZE)];	/* Task 3 (App1Init), Task 4 (App1Task), Task 5 (App1Ack), shared stack App1 */
    static EE_STACK_T EE_STACK_ATTRIB_NAME(App1) EE_stack_3[EE_STACK_WLEN(STACK_3_SIZE)];	/* Task 6 (App1Bkg) */
    static EE_STACK_T EE_STACK_ATTRIB_NAME(App2) EE_stack_4[EE_STACK_WLEN(STACK_4_SIZE)];	/* Task 7 (App2Init), Task 9 (App2Ack), Task 10 (App2HiPriTask), shared stack App2 */
    static EE_STACK_T EE_STACK_ATTRIB_NAME(App2) EE_stack_5[EE_STACK_WLEN(STACK_5_SIZE)];	/* Task 8 (App2Task) */
    ...
    struct EE_TOS EE_e200z7_system_tos[6] = {
        {0},	/* Task  (dummy) */
        {(EE_ADDR)(&EE_stack_1[EE_STACK_INITP(STACK_1_SIZE)])},	/* Task 0 (MainTask), Task 1 (TrustedTask1), Task 2 (ErrorTask), shared stack TrustedApp */
        {(EE_ADDR)(&EE_stack_2[EE_STACK_INITP(STACK_2_SIZE)])},	/* Task 3 (App1Init), Task 4 (App1Task), Task 5 (App1Ack), shared stack App1 */
        {(EE_ADDR)(&EE_stack_3[EE_STACK_INITP(STACK_3_SIZE)])},	/* Task 6 (App1Bkg) */
        {(EE_ADDR)(&EE_stack_4[EE_STACK_INITP(STACK_4_SIZE)])},	/* Task 7 (App2Init), Task 9 (App2Ack), Task 10 (App2HiPriTask), shared stack App2 */
        {(EE_ADDR)(&EE_stack_5[EE_STACK_INITP(STACK_5_SIZE)])} 	/* Task 8 (App2Task) */
    };
...
const EE_FADDR EE_syscall_table[EE_SYSCALL_NR] = {
    ...
    (EE_FADDR)EE_oo_EnableAllInterrupts,
    (EE_FADDR)EE_oo_DisableAllInterrupts,
    (EE_FADDR)EE_oo_ResumeAllInterrupts,
    (EE_FADDR)EE_oo_SuspendAllInterrupts,
    (EE_FADDR)EE_oo_ResumeOSInterrupts,
    (EE_FADDR)EE_oo_SuspendOSInterrupts,
    (EE_FADDR)EE_oo_GetActiveApplicationMode,
    (EE_FADDR)EE_oo_StartOS,
    (EE_FADDR)EE_oo_ShutdownOS,
    (EE_FADDR)EE_as_TerminateISR2,
    (EE_FADDR)TRUSTED_MyTaskTrustedService,
    (EE_FADDR)TRUSTED_MyIsrTrustedService,
    (EE_FADDR)TRUSTED_MyQuickTrustedService,
};
 ...
 **************************************************************************/
    ...
    const EE_FADDR EE_hal_thread_body[EE_MAX_TASK] = {
        ...
        (EE_FADDR)EE_oo_thread_stub,		 /* thread ErrorTask */
        ...
        (EE_FADDR)EE_oo_thread_stub 		 /* thread App2HiPriTask */
    ...
    EE_TYPEPRIO EE_th_rnact[EE_MAX_TASK] = {
        ...
        1U,		 /* thread App2Task */
        1U,		 /* thread App2Ack */
        1U		 /* thread App2HiPriTask */
    };

    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 4U, 0U, 5U, 1U, 2U, 4U, 0U, 1U, 3U, 4U, 6U};
