 ...
 **************************************************************************/
    ...
    EE_STACK_T EE_STACK_ATTRIB_NAME(TrustedApp) EE_stack_1[EE_STACK_WLEN(STACK_1_SIZE)];	/* Task 0 (MainTask), Task 1 (TrustedTask1), Task 2 (ErrorTask), shared stack TrustedApp */
    EE_STACK_T EE_STACK_ATTRIB_NAME(App1) EE_stack_2[EE_STACK_WLEN(STACK_2_SIZE)];	/* Task 3 (App1Init), Task 4 (App1Task), Task 5 (App1Ack), shared stack App1 */
    EE_STACK_T EE_STACK_ATTRIB_NAME(App1) EE_stack_3[EE_STACK_WLEN(STACK_3_SIZE)];	/* Task 6 (App1Bkg) */
    EE_STACK_T EE_STACK_ATTRIB_NAME(App2) EE_stack_4[EE_STACK_WLEN(STACK_4_SIZE)];	/* Task 7 (App2Init), Task 9 (App2Ack), shared stack App2 */
    EE_STACK_T EE_STACK_ATTRIB_NAME(App2) EE_stack_5[EE_STACK_WLEN(STACK_5_SIZE)];	/* Task 8 (App2Task) */
    EE_STACK_T EE_STACK_ATTRIB_NAME(TrustedApp) EE_stack_6[EE_STACK_WLEN(STACK_6_SIZE)];	/* ISR stack TrustedApp */
    EE_STACK_T EE_STACK_ATTRIB_NAME(App1) EE_stack_7[EE_STACK_WLEN(STACK_7_SIZE)];	/* ISR stack App1 */
    EE_STACK_T EE_STACK_ATTRIB_NAME(App2) EE_stack_8[EE_STACK_WLEN(STACK_8_SIZE)];	/* ISR stack App2 */
    ...
    struct EE_TOS EE_e200z7_system_tos[6] = {
        ...
        {(EE_ADDR)(&EE_stack_4[EE_STACK_INITP(STACK_4_SIZE)])},	/* Task 7 (App2Init), Task 9 (App2Ack), shared stack App2 */
 ...
 **************************************************************************/
    ...
    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 4U, 0U, 5U, 1U, 2U, 4U, 0U, 1U, 3U, 4U};

    /* The pairs that are enqueued into the priority queues (10 is the total number of task activations) */
    EE_TYPEPAIR EE_rq_pairs_next[] =
        { 1, 2, 3, 4, 5, 6, 7, 8, 9, -1};

    /* no need to be initialized */
    EE_TID EE_rq_pairs_tid[10];
