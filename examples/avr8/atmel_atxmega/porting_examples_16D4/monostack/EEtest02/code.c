...
__INLINE__ void __ALWAYS_INLINE__ EE_timer_init()
{
...
#endif
	TCC0.PER = 0x0fff; /* Period: 0x0fff */
}

__INLINE__ void __ALWAYS_INLINE__ EE_timer_start()
{
	TCC0.CTRLA = TC_CLKSEL_DIV1_gc; /* Run at maximum speed. */
}

__INLINE__ void __ALWAYS_INLINE__ EE_timer_stop()
{
