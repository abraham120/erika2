...
{ 
  ...
  GLCD_DisplayString(0, 0, "Hardware: TI TMS570");
  GLCD_DisplayString(1, 0, "Software: Erika RTOS");
  GLCD_SetTextColor(Red);
  GLCD_DisplayString(9, 0, "by Chris Kreuzberger");
