Console demo
 ...
 Console demo: A minimal EE demo for the MONOSTACK case with the SofTec DEMO9S12XSFAME demo board.
 The demo is equal to the Task demo but uses the following peripherals:
 LEDs;
 Buttons;;
 ADC module; 
 PIT timer;
