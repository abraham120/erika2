...
#define STACK_2_SIZE 128 // size = 512 bytes 
    ...
    struct EE_TOS EE_rx200_system_tos[3] = {
        {0},	/* Task   (dummy) */
        {(EE_ADDR)(&EE_rx200_stack_1[STACK_1_SIZE - RX200_INIT_TOS_OFFSET])},	/* Task 0 (Producer) */
        {(EE_ADDR)(&EE_rx200_stack_2[STACK_2_SIZE - RX200_INIT_TOS_OFFSET])} 	/* Task 1 (Consumer) */
    };
