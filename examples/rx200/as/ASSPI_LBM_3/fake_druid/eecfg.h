...
#define __AS_CFG_SPI_ASYNCHRONOUS__
#define __AS_CFG_SPI_SYNCHRONOUS__
#define __AS_CFG_SPI_INTERRUPTIBLE_SEQUENCES__
#define __AS_CFG_SPI_LBM_JOB_1_END_NOTIFICATION__
#define __AS_CFG_SPI_LBM_SEQ_0_END_NOTIFICATION__
#define __AS_CFG_SPI_LBM_SEQ_1_END_NOTIFICATION__
#define __ADD_LIBS__
