...
enum EE_ASSERTIONS {
	...
	EE_ASSERT_SPI_SYNC_WRITE_IB_4,		/* 144 */
	EE_ASSERT_SPI_SYNC_WRITE_IB_5,		/* 145 */
	EE_ASSERT_SPI_SYNC_WRITE_IB_6,		/* 146 */
	EE_ASSERT_SPI_SYNC_WRITE_IB_7,		/* 147 */
	EE_ASSERT_SPI_SYNC_WRITE_IB_8,		/* 148 */
	EE_ASSERT_SPI_SYNC_WRITE_IB_9,		/* 149 */
	EE_ASSERT_SPI_SYNC_WRITE_IB_10,		/* 150 */
	EE_ASSERT_SPI_SYNC_TX,				/* 151 */
	EE_ASSERT_SPI_SYNC_JOB_1_OK,		/* 152 */
	EE_ASSERT_SPI_SYNC_JOB_2_OK,		/* 153 */
	EE_ASSERT_SPI_SYNC_SEQ_OK,			/* 154 */
	EE_ASSERT_SPI_SYNC_READ_IB_0,		/* 155 */
	EE_ASSERT_SPI_SYNC_READ_IB_1,		/* 156 */
	EE_ASSERT_SPI_SYNC_READ_IB_2,		/* 157 */
	EE_ASSERT_SPI_SYNC_READ_IB_3,		/* 158 */
	EE_ASSERT_SPI_SYNC_READ_IB_4,		/* 159 */
	EE_ASSERT_SPI_SYNC_READ_IB_5,		/* 160 */
	EE_ASSERT_SPI_SYNC_READ_IB_6,		/* 161 */
	EE_ASSERT_SPI_SYNC_READ_IB_7,		/* 162 */
	EE_ASSERT_SPI_SYNC_READ_IB_8,		/* 163*/
	EE_ASSERT_SPI_SYNC_READ_IB_9,		/* 164 */
	EE_ASSERT_SPI_SYNC_READ_IB_10,		/* 165 */
	EE_ASSERT_SPI_SYNC_VALIDATE_0,		/* 166 */
	EE_ASSERT_SPI_SYNC_VALIDATE_1,		/* 167 */
	EE_ASSERT_SPI_SYNC_VALIDATE_2,		/* 168 */
	EE_ASSERT_SPI_SYNC_VALIDATE_3,		/* 169 */
	EE_ASSERT_SPI_SYNC_VALIDATE_4,		/* 170 */
	EE_ASSERT_SPI_SYNC_VALIDATE_5,		/* 171 */
	EE_ASSERT_SPI_SYNC_VALIDATE_6,		/* 172 */
	EE_ASSERT_SPI_SYNC_VALIDATE_7,		/* 173 */
	EE_ASSERT_SPI_SYNC_VALIDATE_8,		/* 174 */
	EE_ASSERT_SPI_SYNC_VALIDATE_9,		/* 175 */
	EE_ASSERT_SPI_SYNC_VALIDATE_10,		/* 176 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_0,		/* 177 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_1,		/* 178 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_2,		/* 179 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_3,		/* 180 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_4,		/* 181 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_5,		/* 182 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_6,		/* 183 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_7,		/* 184 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_8,		/* 185 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_9,		/* 186 */
	EE_ASSERT_SPI_EB_SYNC_SETUP_10,		/* 187 */
	EE_ASSERT_SPI_EB_SYNC_TX,			/* 188 */
	EE_ASSERT_SPI_EB_SYNC_JOB_1_OK,		/* 189 */
	EE_ASSERT_SPI_EB_SYNC_JOB_2_OK,		/* 190 */
	EE_ASSERT_SPI_EB_SYNC_SEQ_OK,		/* 191 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_0,	/* 192 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_1,	/* 193 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_2,	/* 194 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_3,	/* 195 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_4,	/* 196 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_5,	/* 197 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_6,	/* 198 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_7,	/* 199 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_8,	/* 200 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_9,	/* 201 */
	EE_ASSERT_SPI_EB_SYNC_VALIDATE_10,	/* 202 */
	EE_ASSERT_SPI_DEINIT,				/* 203*/
	EE_ASSERT_DIM
};
