 ...
 * CVS: $Id: code.c,v 1.2 2008/07/17 18:59:45 nino Exp $
 */
...
void T1_program(void)
{
	...
	PR1   = 0xc350;		/* Load the Period register wit the value 50000	ticks = 25 ms*/
...
int main(void)
{
	...
	T1_program();
  	...
  	/* Time init (for the EDF scheduler) */
  	EE_time_init();
	...
	* ticks, and after that periodically every 20 ticks = 20*25ms = 500ms*/
