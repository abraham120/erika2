...
// Set configuration fuses (but only once)
		...
		/* Daniele: commented out since clock init is done in code.c
		// Explorer 16 board
...
// Define your own board hardware profile here
	...
	// --- Profile for Flex Motion Board ---
	#define LED0_TRIS           (TRISDbits.TRISD0)  // Ref D0
	#define LED0_IO             (PORTDbits.RD0)
	#define LED1_TRIS           (TRISDbits.TRISD2)  // Ref D2
	#define LED1_IO             (PORTDbits.RD2)
	#define LED2_TRIS           (TRISDbits.TRISD0)  // Ref D0
	#define LED2_IO             (PORTDbits.RD0)
	#define LED3_TRIS           (TRISDbits.TRISD2)  // Ref D2
	#define LED3_IO             (PORTDbits.RD2)
	#define LED4_TRIS           (TRISDbits.TRISD0)  // Ref D0
    #define LED4_IO             (PORTDbits.RD0)
	#define LED5_TRIS           (TRISDbits.TRISD2)  // Ref D2
	#define LED5_IO             (PORTDbits.RD2)
	#define LED6_TRIS           (TRISDbits.TRISD0)  // Ref D0
	#define LED6_IO             (PORTDbits.RD0)
	#define LED7_TRIS           (TRISDbits.TRISD2)  // Ref D2
	#define LED7_IO             (PORTDbits.RD2)
	#define LED_PUT(a)

	#define BUTTON0_TRIS        (TRISDbits.TRISD9)  // Ref S4
	#define BUTTON0_IO          (PORTDbits.RD9)
	#define BUTTON1_TRIS        (TRISDbits.TRISD11) // Ref S5   // Note: This is multiplexed with LED7
	#define BUTTON1_IO          (PORTDbits.RD11)
	#define BUTTON2_TRIS        (TRISDbits.TRISD9)  // Ref S6
	#define BUTTON2_IO          (PORTDbits.RD9)
	#define BUTTON3_TRIS        (TRISDbits.TRISD11) // Ref S3
	...
	// ENC28J60 I/O pins
	#define ENC_RST_TRIS        (TRISEbits.TRISE4)  // Not connected by default
	#define ENC_RST_IO          (PORTEbits.RE4)
	...
	// End Flex profile
#endif // __USE_MULTIBUSBOARD__

#ifdef __USE_CAMERA_ETH_BOARD_V01__
	    ...
	    // ENC28J60 I/O pins
	    #define ENC_RST_TRIS        (TRISBbits.TRISB8)  // Not connected by default
...
#endif // __USE_CAMERA_ETH_BOARD_V01__
