...
//GF #define EXPLORER16
	#define FLEX_DEMOBOARD //GF
...
// Transceiver Configuration
	#define PHY_CS LATGbits.LATG9
	#define PHY_CS_TRIS TRISGbits.TRISG9
    #define PHY_RESETn LATGbits.LATG0
    #define PHY_RESETn_TRIS TRISGbits.TRISG0
    #define PHY_WAKE LATGbits.LATG12
    #define PHY_WAKE_TRIS TRISGbits.TRISG12
...
/*    #define PUSH_BUTTON_1 PORTDbits.RD4
    ...
    #define PUSH_BUTTON_1_TRIS TRISDbits.TRISD4
